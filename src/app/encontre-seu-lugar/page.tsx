    ...
    return (
        <React.Fragment>
            ...
            <header className="bg-gradient-to-r from-red-800 via-red-700 to-red-800 text-white py-16 px-4 shadow-2xl relative overflow-hidden">
                ...
                <div className="container mx-auto max-w-7xl relative z-10">
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-xl text-red-100 max-w-3xl mx-auto mb-3">
                            Grupos Jovens, Movimentos, Comunidades e Devoções no Distrito Federal
                        </p>
                        <p className="text-base text-red-50 italic">
            ...
            <main className="container mx-auto max-w-7xl px-4 py-10">
                <div className="bg-white/70 backdrop-blur-sm rounded-2xl shadow-xl p-6 md:p-10 border border-red-100">
                    <ComunidadesGallery regioes={regioesAdministrativas} />
                </div>

                <p className="mt-8 text-center text-red-700/60 text-sm">
