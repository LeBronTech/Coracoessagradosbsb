...
export const regioesAdministrativas: RegiaoAdministrativa[] = [
        ...
        devocoes: [
            {
                ...
                nome: 'Shalom Asa Sul',
                tipo: 'comunidade',
                imageUrl: 'https://iili.io/B51WMLF.jpg',
                descricao: 'Centro de Evangelização Shalom na Asa Sul. Santíssimo Sacramento exposto 24h por dia para adoração, grupos de oração para jovens, adultos e casais, além de aconselhamento e serviços de livraria e lanchonete.',
                bairro: 'Asa Sul',
                horarios: 'Funcionamento: Seg a Sáb 14h às 22h. Missas: Seg e Sex 18h; Sáb e Dom 17h. Adoração: 24h.',
                site: 'https://brasilia.comshalom.org/asasul/',
                instagram: 'shalomasasul',
            },
            {
                id: 'js_brasilia',
                nome: 'Jovens Sarados BSB',
                tipo: 'grupo_jovem',
            ...
            {
                id: 'missao_dynamus',
                nome: 'Dynamus — Missão Católica Dynamus',
                tipo: 'comunidade',
                imageUrl: 'https://iili.io/Btb9Zl4.jpg',
                descricao: '𝗗𝗲𝘀𝗱𝗲 𝟮𝟬𝟮𝟯 ⚡ Missão Católica em Brasília. Foco em adoração e evangelização. 1º sábado do mês: Adoração ao Santíssimo.',
                bairro: 'Brasília',
                instagram: 'missaodynamus',
            },
            {
                id: 'gam_sjt_as',
                nome: 'GAM — Grupo de Animação Missionária',
                tipo: 'movimento',
                imageUrl: 'https://iili.io/BtDDb1V.jpg',
                descricao: '🐜 Grupo de Animação Missionária da Paróquia São Judas Tadeu. Encontros: Terças-feiras às 19h30.',
                paroquia: 'Paróquia São Judas Tadeu',
                bairro: 'Asa Sul',
                horarios: 'Terças-feiras às 19h30',
                instagram: 'instagampsjt',
            },
    ...
    { id: 'sudoeste', nome: 'Sudoeste', setorArquidiocese: 1, setorRCC: 1, vicariato: 'Centro', devocoes: [{ id: 'sao_pio', nome: 'Paróquia São Pio de Pietrelcina', tipo: 'paroquia', imageUrl: 'https://iili.io/fjEOxIV.jpg', descricao: 'Setor I Sudoeste.', bairro: 'Sudoeste' }] },
    {
        ...
        devocoes: [
            {
                id: 'juventude_pnsd_cruzeiro',
                nome: 'Juventude P.N.S.D.',
                tipo: 'grupo_jovem',
                imageUrl: 'https://iili.io/BtbJyMu.jpg',
                descricao: 'Juventude da Paróquia Nossa Senhora das Dores. Engloba diversos grupos e atividades voltadas para a evangelização dos jovens no Cruzeiro.',
                paroquia: 'Paróquia Nossa Senhora das Dores',
                bairro: 'Cruzeiro Velho',
                instagram: 'juventudepnsd',
            },
            { id: 'ns_dores_cruzeiro', nome: 'Paróquia Nossa Senhora das Dores', tipo: 'paroquia', imageUrl: 'https://iili.io/fjEOxIV.jpg', descricao: 'Setor I Cruzeiro Velho.', bairro: 'Cruzeiro Velho' }
        ]
    },
        ...
        devocoes: [
            {
                ...
                tipo: 'comunidade',
                imageUrl: 'https://iili.io/B51yis2.jpg',
                descricao: 'Casa de Missão e Loja Canção Nova em Brasília. Programação Semanal:\n🙏 Missa Clamando por Milagres: Santuário Dom Bosco (Quintas, 19h30)\n⛪ Missa na Casa de Missão (Quartas, 12h10)\n🔥 Grupo de Oração (Terças, 19h30)\n💛 Adoração: Quintas na Loja\n🛍️ Bazar: Quartas (9h-12h/13h-16h)',
                bairro: 'SIA / SAA',
                endereco: 'Saa Q 3 - SIA, Brasília DF',
                enderecoMaps: 'https://maps.google.com/?cid=8991923232181399083',
                contato: '61 9892 1482',
                instagram: 'cancaonovabrasilia',
            }
        ]
    },
    {
        ...
        devocoes: [
            {
                id: 'rcc_df_escritorio',
                nome: 'RCC DF — Renovação Carismática Católica',
                tipo: 'rcc',
                imageUrl: 'https://iili.io/B5Mh5Tx.jpg',
                descricao: 'A Paz 🕊️ esteja convosco! Escritório da Renovação Carismática Católica do Distrito Federal. Informações sobre grupos de oração, eventos, redes sociais e inscrições.',
                bairro: 'Asa Sul',
                endereco: 'SGAS 601 Conjunto B parte Sala 1, Brasília DF',
                site: 'https://rccdf.org.br/site/',
                instagram: 'rccbrasilia',
            },
            {
                id: 'vocacional_bsb',
                nome: 'Pastoral Vocacional BSB',
                tipo: 'movimento',
                imageUrl: 'https://iili.io/BtDDZLx.jpg',
                descricao: 'Perfil oficial da Pastoral Vocacional da Arquidiocese de Brasília. Promoção e discernimento vocacional para jovens.',
                bairro: 'Asa Sul',
                instagram: 'vocacionaldf',
            },
            {
                id: 'evohs_merces',
                nome: 'Evohs — Grupo Jovem',
                tipo: 'grupo_jovem',
                imageUrl: 'https://iili.io/Btbd96b.jpg',
                descricao: '“Ele nos vivifica ontem, hoje e sempre”. Grupo de jovens da Paróquia Sagrado Coração de Jesus e Nossa Senhora das Mercês.',
                paroquia: 'Pª Sagrado Coração de Jesus e N.s das Mercês',
                bairro: 'Asa Sul',
                instagram: 'evohs.sagradomerces',
            },
    ...
    { id: 'vila_planalto', nome: 'Vila Planalto', setorArquidiocese: 2, setorRCC: 2, vicariato: 'Centro', devocoes: [{ id: 'ns_rosario_pompeia', nome: 'Paróquia Nossa Senhora do Rosário de Pompéia', tipo: 'paroquia', imageUrl: 'https://iili.io/fjEOxIV.jpg', descricao: 'Setor II Vila Planalto.', bairro: 'Vila Planalto' }] },
    {
        ...
        devocoes: [
            {
                id: 'rc_bsb',
                nome: 'RC — Regnum Christi Brasília',
                tipo: 'movimento',
                imageUrl: 'https://iili.io/BtDPRuR.jpg',
                descricao: 'Buscamos dar glória a Deus e fazer presente o Reino de Cristo no coração dos homens e na sociedade. Membros do Regnum Christi buscam santificar-se no cumprimento dos deveres de seu próprio estado de vida.',
                bairro: 'Lago Sul',
                instagram: 'regnumchristi.bsb',
            },
            {
                id: 'cor_bsb',
                nome: 'COR — Cor Missionária Brasília',
                tipo: 'movimento',
                imageUrl: 'https://iili.io/BtDvZib.jpg',
                descricao: 'Colorir o mundo com as cores do Amor 🩵. Apostolado do Regnum Christi focado na missão e no serviço aos mais necessitados.',
                bairro: 'Lago Sul',
                instagram: 'corbrasilia',
            },
            {
                id: 'ecyd_fem_bsb',
                nome: 'ECyD Feminino — Brasília',
                tipo: 'grupo_jovem',
                imageUrl: 'https://iili.io/BtDrKTN.jpg',
                descricao: '✝️ Encontros, Convicções e Decisões. ❤️ Não fazemos apostolado, SOMOS APÓSTOLOS. 🌟 #ECyDLifeStyle. Organização para adolescentes que buscam viver a amizade com Cristo.',
                bairro: 'Lago Sul',
                instagram: 'ecydbsb',
            },
            {
                id: 'ecyd_masc_bsb',
                nome: 'ECyD Masculino — Brasília',
                tipo: 'grupo_jovem',
                imageUrl: 'https://iili.io/BtDr3pp.jpg',
                descricao: '🛡️ Cristo Rei Nosso! ⚜️ Encontros • Convicções • Decisões. Adolescentes em missão por um mundo melhor, vivendo a caridade e a amizade cristã.',
                bairro: 'Lago Sul',
                instagram: 'ecyd.bsb',
            },
            {
                id: 'jfm_bsb',
                nome: 'J&FM — Juventude & Família Missionária',
                tipo: 'movimento',
                imageUrl: 'https://iili.io/BtDP5jp.jpg',
                descricao: '♡ Levamos o amor de Cristo aos mais necessitados. ✞ Apostolado da Federação Regnum Christi. ♡ “Pregar e Viver do Evangelho”.',
                bairro: 'Lago Sul',
                instagram: 'juventudefamiliamissionariabsb',
            },
        ...
        devocoes: [
            {
                ...
                nome: 'Eis-me aqui',
                tipo: 'grupo_jovem',
                imageUrl: 'https://iili.io/BtDLkFt.jpg',
                descricao: '“Eis-me aqui Senhor!” Somos uma geração que ousa dizer SIM! Pautados na HUMILDADE, PRONTIDÃO e CONFIANÇA.',
                paroquia: 'Paróquia Sagrada Família',
                bairro: 'Park Way',
                instagram: 'eismeaqui.psfpw',
            },
    ...
    },
    {
        ...
        devocoes: [
            {
                id: 'grupo_jovem_pspa',
                nome: 'J.O.V.E.M. — Grupo J.O.V.E.M.',
                tipo: 'grupo_jovem',
                imageUrl: 'https://iili.io/Btb9tUl.jpg',
                descricao: '“Meu espelho há de ser Maria.” 💙 Jovens em oração vivendo o exemplo de Maria. Um grupo focado na espiritualidade mariana e na fraternidade jovem.',
                paroquia: 'Paróquia São Paulo Apóstolo',
                bairro: 'Guará I',
                instagram: 'jovempspa',
            },
            {
                id: 'jupes_guara',
                nome: 'JUPES — Jovens Unidos Pelo Espírito Santo',
                tipo: 'grupo_jovem',
                imageUrl: 'https://iili.io/BtDiLzl.jpg',
                descricao: '💙 Jovens Unidos Pelo Espírito Santo. 🕊️ “Recebereis o Espírito Santo e sereis as minhas testemunhas” (Atos 1:8). Grupo de jovens focado na vivência do Batismo no Espírito Santo.',
                paroquia: 'Paróquia São Paulo Apóstolo',
                bairro: 'Guará I',
                instagram: 'jupes.grupo',
            },
            { id: 'sao_paulo_apostolo_g1', nome: 'Paróquia São Paulo Apóstolo', tipo: 'paroquia', imageUrl: 'https://iili.io/fjEOxIV.jpg', descricao: 'Setor IV Guará I.', bairro: 'Guará I' }
        ]
    },
    {
        id: 'guara_ii',
    ...
    },
    {
        ...
        devocoes: [
            ...
            { id: 'rcc_paranoa', nome: 'Grupo de Oração Espírito Santo', tipo: 'rcc', imageUrl: 'https://iili.io/B5Mh5Tx.jpg', descricao: 'Grupo de Oração da RCC no Paranoá.', paroquia: 'Paróquia Santa Maria dos Pobres', bairro: 'Paranoá', horarios: 'Sextas-feiras, 19h30' },
        ],
    },
    {
        id: 'sao_sebastiao_xi',
    ...
    // ── VICARIATO NORTE ─────────────────────────────────────────
    {
        ...
        devocoes: [
            ...
            {
                id: 'fac_basilica_an',
                nome: 'FAC — Formação de Adolescentes Cristãos',
                tipo: 'grupo_jovem',
                imageUrl: 'https://iili.io/BtDDDqQ.jpg',
                descricao: '⛺ Acampamento FAC da Basílica Santuário São Francisco de Assis. ✨ Onde histórias começam e vidas são transformadas. Juventude da Basílica.',
                paroquia: 'Basílica Santuário São Francisco de Assis',
                bairro: 'Asa Norte',
                instagram: 'facbasilica',
            },
            { id: 'rcc_verbo_divino_an', nome: 'Grupo de Oração Verbo Divino', tipo: 'rcc', imageUrl: 'https://iili.io/B5Mh5Tx.jpg', descricao: 'Grupo de Oração às Segundas-Feiras, 20h00.', paroquia: 'Paróquia Verbo Divino', endereco: 'SGAN 609', bairro: 'Asa Norte', horarios: 'Segunda-Feira às 20h00' },
        ],
    },
    {
        id: 'lago_norte',
    ...
    { id: 'grande_colorado', nome: 'Grande Colorado', setorArquidiocese: 8, setorRCC: 8, vicariato: 'Norte', devocoes: [{ id: 'ns_gracas_colorado', nome: 'Paróquia Nossa Senhora das Graças', tipo: 'paroquia', imageUrl: 'https://iili.io/fjEOxIV.jpg', descricao: 'Paróquia do Setor VIII Grande Colorado.', bairro: 'Grande Colorado' }] },
    {
        ...
        devocoes: [
            ...
            {
                id: 'juac_sj',
                nome: 'JUAC - Jovens Unidos no Amor de Cristo',
                tipo: 'grupo_jovem',
                imageUrl: 'https://iili.io/BtDhSyu.jpg',
                descricao: '❤️🔥| Ser jovem é ser santo. - São Domingos. Grupo de jovens da Capela São José.',
                paroquia: 'Paróquia Santa Rita de Cássia',
                bairro: 'Planaltina-DF',
                instagram: 'capelasaojoseplanaltinadf',
            },
        ],
    },
    ...
    // ── VICARIATO SUL ───────────────────────────────────────────
    {
        ...
        devocoes: [
            ...
            },
            {
                ...
                tipo: 'movimento',
                imageUrl: 'https://iili.io/Btb9bJ2.jpg',
                descricao: '🏕️ Acampamento Maanaim. Um encontro profundo com o amor de Deus através de retiros e acampamentos para a juventude.',
                paroquia: 'Paróquia Nossa Senhora de Lourdes',
                bairro: 'Taguatinga',
                instagram: 'maanaimpnsl',
            },
            {
                id: 'shalom_taguatinga',
                nome: 'Shalom Taguatinga',
                tipo: 'comunidade',
                imageUrl: 'https://iili.io/B51WMLF.jpg',
                descricao: 'Centro de Evangelização Shalom em Taguatinga. Grupos de oração (Jovem, Adulto, Casais), missas regulares, adoração ao Santíssimo, aconselhamento espiritual e serviços como bazar, livraria e lanchonete.',
                bairro: 'Taguatinga Centro',
                horarios: 'Funcionamento: Seg a Sáb 14h às 22h. Missas: Dom 10h, Seg 18h30. Missa Jovem no 2º Sáb às 17h.',
                contato: '61 8488 8904',
                site: 'https://brasilia.comshalom.org/taguatinga/',
                instagram: 'shalomtaguatinga',
            },
            {
                id: 'ejoc_taguatinga',
                nome: 'EJOC — Encontro de Jovens com Cristo',
                tipo: 'movimento',
                imageUrl: 'https://static.wixstatic.com/media/61c22d_df35cdd3d75d4c6997d307c5f0142d23~mv2.jpg/v1/fill/w_80,h_80,al_c,q_80,usm_0.66_1.00_0.01,enc_avif,quality_auto/logo_edited.jpg',
                descricao: 'O movimento Encontro de Jovens com Cristo é um grupo de jovens Católico Apostólico Romano vinculado à Arquidiocese de Brasília. Com sede na paróquia Santuário Nossa Senhora do Perpétuo Socorro, em Taguatinga - DF, o EJOC evangeliza e proporciona um crescimento nos âmbitos humano, social e teológico dos integrantes. E claro, nosso lema é: "A juventude é uma semente... que Deus na terra semeou!"',
                paroquia: 'Santuário Nossa Senhora do Perpétuo Socorro',
                bairro: 'Taguatinga - DF',
                instagram: 'instaejoc',
            },
            // Setor V
            ...
            { id: 'rcc_deus_amor_tag', nome: 'Grupo de Oração Deus é Amor', tipo: 'rcc', imageUrl: 'https://iili.io/B5Mh5Tx.jpg', descricao: 'Quinta-Feira às 08h00.', paroquia: 'Santuário Nossa Senhora do Perpétuo Socorro', endereco: 'C7', bairro: 'Taguatinga', horarios: 'Quinta-Feira às 08h00' },
        ],
    },
    {
        id: 'ceilandia',
    ...
    },
    {
        ...
        devocoes: [
            ...
            {
                id: 'santifica_vp',
                nome: 'Santifica — Grupo Jovem',
                tipo: 'grupo_jovem',
                imageUrl: 'https://iili.io/BtDZOYX.jpg',
                descricao: 'Grupo de jovens da Paróquia São Francisco de Assis em Vicente Pires. Um espaço de oração, fraternidade e vivência cristã para a juventude.',
                paroquia: 'Paróquia São Francisco de Assis',
                bairro: 'Vicente Pires',
                instagram: 'santifica.psfa',
            },
    ...
    },
    {
        ...
        devocoes: [
            {
                id: 'obra_de_maria_bsb',
                nome: 'Obra de Maria — Brasília',
                tipo: 'comunidade',
                imageUrl: 'https://iili.io/BtDZj4I.jpg',
                descricao: '“Servimos ao Senhor com alegria!” Comunidade Católica Obra de Maria. Missas: Dom 10h, Sex 19h30 (Adoração). Grupo de Oração: Qua 19h30.',
                bairro: 'Arniqueiras',
                contato: '(61) 92002-5741',
                instagram: 'obrademariamissaobrasilia',
            },
            { id: 'maria_aux_arniqueiras', nome: 'Paróquia Maria Auxiliadora', tipo: 'paroquia', imageUrl: 'https://iili.io/fjEOxIV.jpg', descricao: 'Setor XII Arniqueiras.', bairro: 'Arniqueiras' }
        ]
    },
    ...
    // ── VICARIATO LESTE ─────────────────────────────────────────
    {
        ...
        devocoes: [
            {
                id: 'ejc_fatima_gama',
                nome: 'EJC — N.S. de Fátima',
                tipo: 'movimento',
                imageUrl: 'https://iili.io/BtDLNMN.jpg',
                descricao: '🌹 O Importante é a Rosa. “Não há nada que nos faça amar tanto uma pessoa quanto orar por ela.” Encontro de Jovens com Cristo.',
                paroquia: 'Paróquia Nossa Senhora de Fátima',
                bairro: 'Gama',
                instagram: 'ejcfatimagama',
            },
    ...
    { id: 'engenho_das_lajes', nome: 'Engenho das Lajes', setorArquidiocese: 7, setorRCC: 7, vicariato: 'Leste', devocoes: [{ id: 'sao_sebastiao_lajes', nome: 'Paróquia São Sebastião', tipo: 'paroquia', imageUrl: 'https://iili.io/fjEOxIV.jpg', descricao: 'Setor VII Eng. Lajes.', bairro: 'Engenho das Lajes' }] },
    {
        ...
        devocoes: [
            {
                id: 'ichthus_samambaia',
                nome: 'Ichthus — Grupo Jovem Ichthus',
                tipo: 'grupo_jovem',
                imageUrl: 'https://iili.io/BtbJpne.jpg',
                descricao: '🐟 Grupo Jovem Ichthus. Encontros: Todos os sábados, das 15h30 às 17h30. Voltado para jovens entre 14 e 24 anos.',
                paroquia: 'Paróquia Nossa Senhora de Fátima',
                bairro: 'Samambaia',
                horarios: 'Sábados, 15h30 às 17h30',
                instagram: 'ichthusnarede',
            },
    ...
    },
    {
        ...
        devocoes: [
            {
                id: 'ccvn_bsb',
                nome: 'CCVN — Comunidade Católica Vida Nova',
                tipo: 'comunidade',
                imageUrl: 'https://iili.io/BtDk88B.jpg',
                descricao: '🙏🏽 Carisma: A Cura do Homem Total. A CCVN busca a restauração da dignidade humana através da evangelização e do cuidado espiritual. 🤎 Fundação: 14 de julho de 1996 (Dia de São Camilo de Lellis). 💒 Fundador: Dom Giovanni Carlos.',
    ...
    { id: 'riacho_fundo_ii_leste', nome: 'Riacho Fundo II', setorArquidiocese: 13, setorRCC: 13, vicariato: 'Leste', devocoes: [{ id: 'ns_medalha_rf2', nome: 'Paróquia Nossa Senhora da Medalha Milagrosa', tipo: 'paroquia', imageUrl: 'https://iili.io/fjEOxIV.jpg', descricao: 'Setor XIII Riacho Fundo II.', bairro: 'Riacho Fundo II' }] },
    {
        ...
        devocoes: [
            ...
            },
            {
                ...
                tipo: 'movimento',
                imageUrl: 'https://iili.io/BtDLOPI.jpg',
                descricao: '🌹 O importante é a rosa! Encontro de Jovens com Cristo da Paróquia Santa Mãe de Deus.',
                paroquia: 'Paróquia Santa Mãe de Deus',
                bairro: 'Santa Maria',
                instagram: 'ejcsantamarianorte',
            },
            {
                id: 'shalom_santa_maria',
                nome: 'Shalom Santa Maria',
                tipo: 'comunidade',
                imageUrl: 'https://iili.io/B51WMLF.jpg',
                descricao: 'Centro de Evangelização da Comunidade Católica Shalom em Santa Maria. Grupos de oração e evangelização na região.',
                bairro: 'Santa Maria',
                instagram: 'shalomsantamariabsb',
            },
            {
                id: 'go_sj_sm',
                nome: 'Grupo de Oração São José',
                tipo: 'rcc',
                imageUrl: 'https://iili.io/BtDZN2t.jpg',
                descricao: '❤️🔥 Aqui tem jovem, aqui tem santo! Grupo de Oração da RCC na Paróquia São José. Encontros: Quartas-feiras às 19h30.',
                paroquia: 'Paróquia São José',
                bairro: 'Santa Maria / DF',
                horarios: 'Quartas-feiras às 19h30',
                instagram: 'grupodeoracao.sj',
            },
