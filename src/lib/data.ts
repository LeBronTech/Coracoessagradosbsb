...
const saintsOfTheDayFevereiroExtra: SaintOfTheDayData[] = [
  ...
  { day: 27, month: 'Fevereiro', saints: [{ name: 'São Gabriel das Dores', imageUrl: '/images/sao_gabriel_dores.png', story: '<h4>São Gabriel das Dores - Jovem Passionista</h4><p>Francisco Possenti nasceu em Assis, Itália, em 1838, filho de um governador pontifício. Desde jovem, era alegre, sociável e amado por todos. Apesar de duas promessas de entrar para a vida religiosa, adiava a decisão. Mas Deus o chamava com insistência. Numa procissão, ao ver a imagem de N.S., ouviu claramente no coração: "Francisco, o mundo não é para ti." Desta vez, respondeu com generosidade total.</p><p class="mt-4">Ao entrar na Congregação da Paixão (Passionistas), tomou o nome de Gabriel das Dores. Mergulhou com todo o coração na contemplação da Paixão de Jesus, encontrando nela não tristeza, mas uma alegria profunda e sobrenatural. Era conhecido por sua humildade, pureza e alegria contagiante — provou que a vida de penitência e oração não é triste, mas fonte de uma felicidade que o mundo não pode dar.</p><p class="mt-4">Tinha devoção filial e ardente a N.S. das Dores, vendo em Maria a Mãe que compartilhou plenamente a Paixão do Filho. Adoeceu de tuberculose e enfrentou a doença com serenidade admirável, oferecendo seus sofrimentos unidos aos de Cristo. Morreu com um sorriso nos lábios, contemplando a imagem de N.S. das Dores, em 27 de fevereiro de 1862, com apenas 24 anos.</p><p class="mt-4">Foi beatificado em 1908 e canonizado em 1920 pelo Papa Bento XV. É padroeiro e intercessor especial da juventude. Seu corpo, encontrado incorrupto, repousa em Isola del Gran Sasso, na Itália.</p><p class="mt-4"><b>Oração:</b> Ó São Gabriel das Dores, jovem que encontrastes na Paixão de Cristo a fonte de toda alegria, intercede por nós, especialmente pelos jovens. Que o teu exemplo nos inspire a viver com alegria e generosidade a nossa fé. Amém.</p><p class="mt-2 italic">São Gabriel das Dores, rogai por nós.</p>' }] },
