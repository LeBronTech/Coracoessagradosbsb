...
export const novenaData: Record<string, Novena> = {
  ...
  teresinha: {
    ...
    initialPrayer: `<div class="initial-prayer-text"><div class="prayer-block"><div class="p-3 bg-rose-50/80 dark:bg-rose-950/30 border border-rose-200 dark:border-rose-900/40 rounded-xl text-center mb-3"><p class="text-xs font-semibold uppercase tracking-wider text-rose-700 dark:text-rose-300">A Novena das Rosas</p><p class="text-sm font-serif italic text-rose-900 dark:text-rose-200 mt-1">“Do céu eu farei cair sobre a Terra uma chuva de Rosas”</p></div></div></div>`,
    finalPrayer: `<div class="final-prayer-text"><div class="p-4 bg-rose-50/60 dark:bg-rose-950/20 border border-rose-200/60 dark:border-rose-900/30 rounded-xl text-center mt-4"><p class="text-sm font-serif italic text-rose-800 dark:text-rose-200">“Do céu eu farei cair sobre a Terra uma chuva de Rosas”</p><p class="text-xs font-medium text-stone-500 mt-1">— Santa Terezinha do Menino Jesus e da Sagrada Face</p></div></div>`,
    days: [
      {
