...
const saintsOfTheDayFevereiroExtra: SaintOfTheDayData[] = [
  { day: 6, month: 'Fevereiro', saints: [{ name: 'São Paulo Miki e Companheiros', imageUrl: '/images/sao_paulo_miki.png', story: '<h4>Mártires do Japão</h4><p>São Paulo Miki, jesuíta japonês, e 25 companheiros foram crucificados em Nagasaki em 1597. Primeiros mártires do Japão.</p><p class="mt-4"><b>Oração:</b> São Paulo Miki e companheiros, rogai por nós.</p>', isMartyr: true }] },
  { day: 7, month: 'Fevereiro', saints: [{ name: 'Beato Pio IX', imageUrl: '/images/beato_pio_ix.png', story: '<h4>Papa</h4><p>Papa Pio IX teve o mais longo pontificado da história (1846-1878). Proclamou o dogma da Imaculada Conceição e convocou o Concílio Vaticano I.</p><p class="mt-4"><b>Oração:</b> Beato Pio IX, rogai por nós.</p>' }] },
  ...
  { day: 9, month: 'Fevereiro', saints: [{ name: 'Santa Apolônia', imageUrl: '/images/santa_apolonia.png', story: '<h4>Mártir de Alexandria</h4><p>Santa Apolônia sofreu martírio em Alexandria durante perseguição aos cristãos. Teve todos os dentes arrancados, mas manteve-se firme na fé. Padroeira dos dentistas.</p><p class="mt-4"><b>Oração:</b> Santa Apolônia, rogai por nós.</p>', isMartyr: true }] },
  { day: 10, month: 'Fevereiro', saints: [{ name: 'Santa Escolástica', imageUrl: '/images/santa_escolastica.png', story: '<h4>Irmã de São Bento</h4><p>Irmã gêmea de São Bento, fundou mosteiro feminino e viveu segundo a Regra Beneditina. Seu poder de oração era tão grande que uma tempestade impediu São Bento de partir.</p><p class="mt-4"><b>Oração:</b> Santa Escolástica, rogai por nós.</p>' }] },
  ...
  { day: 12, month: 'Fevereiro', saints: [{ name: 'Santa Eulália', imageUrl: '/images/santa_eulalia.jpg', story: '<h4>Mártir de Barcelona</h4><p>Santa Eulália, jovem mártir de Barcelona no século IV. Sofreu torturas cruéis por confessar a fé cristã durante a perseguição de Diocleciano.</p><p class="mt-4"><b>Oração:</b> Santa Eulália, rogai por nós.</p>', isMartyr: true }] },
  { day: 13, month: 'Fevereiro', saints: [{ name: 'Santa Catarina Ricci', imageUrl: '/images/santa_catarina_ricci.jpg', story: '<h4>Mística Dominicana</h4><p>Religiosa dominicana italiana do século XVI, conhecida por seus êxtases místicos e estigmas. Viveu em profunda união com a Paixão de Cristo.</p><p class="mt-4"><b>Oração:</b> Santa Catarina Ricci, rogai por nós.</p>' }] },
  { day: 14, month: 'Fevereiro', saints: [{ name: 'Santos Cirilo e Metódio', imageUrl: '/images/sao_cirilo_metodio.jpg', story: '<h4>Apóstolos dos Eslavos</h4><p>Irmãos que evangelizaram povos eslavos e criaram o alfabeto cirílico. Co-padroeiros da Europa junto com São Bento.</p><p class="mt-4"><b>Oração:</b> Santos Cirilo e Metódio, rogai por nós.</p>' }] },
  { day: 15, month: 'Fevereiro', saints: [{ name: 'Santos Faustino e Jovita', imageUrl: '/images/santos_faustino_jovita.jpg', story: '<h4>Irmãos Mártires</h4><p>Santos Faustino e Jovita, irmãos nobres de Bréscia, Itália, martirizados no século II por pregarem o Evangelho.</p><p class="mt-4"><b>Oração:</b> Santos Faustino e Jovita, rogai por nós.</p>', isMartyr: true }] },
  { day: 16, month: 'Fevereiro', saints: [{ name: 'Santa Juliana', imageUrl: '/images/santa_juliana.jpg', story: '<h4>Virgem e Mártir</h4><p>Santa Juliana de Nicomédia, virgem e mártir do século IV. Preferiu o martírio a casar-se com um pagão.</p><p class="mt-4"><b>Oração:</b> Santa Juliana, rogai por nós.</p>', isMartyr: true }] },
  ...
  { day: 18, month: 'Fevereiro', saints: [{ name: 'B. João de Fiesole (Fra Angélico)', imageUrl: '/images/fra_angelico.jpg', story: '<h4>Sacerdote Dominicano e Pintor</h4><p>Beato João de Fiesole, conhecido como Fra Angélico, foi um frade dominicano italiano do século XV e um dos maiores pintores do Renascimento. Suas obras, repletas de beleza e espiritualidade, eram verdadeiras orações pintadas. Dizia que "quem pinta Cristo deve viver com Cristo". É o patrono dos artistas.</p><p class="mt-4"><b>Oração:</b> Beato Fra Angélico, rogai por nós.</p>' }] },
