  ...
  sao_luis_montfort: {
    ...
    days: [
      ...
      },
      {
        ...
        content: `<div class="day-specific-content"><h5 class="font-bold text-lg">Meditação:</h5><blockquote class="brand-border pl-4 italic my-4"><p>"Quando chegará, meu irmão, esse feliz tempo, esse século de Maria, em que muitas almas escolhidas e obtidas do Altíssimo por Maria, perdendo-se a si mesmas no abismo de seu interior, se transformem em cópias vivas da Santíssima Virgem para amar e glorificar a Jesus Cristo?! Esse tempo só chegará quando os corações conhecerem e viverem a devoção que eu ensino: 'Para que venha o Reino de Jesus, venha o Reino de Maria!!!' (T.V.D 217)"</p></blockquote><p>Peçamos à São Luís, nesse segundo dia de novena, a graça de um amor filial e verdadeiro à Nossa Senhora. <em>"Se queres ser um grande santo, seja um grande devoto da Santíssima Virgem Maria"</em>. (São Luís Maria)</p><div class="mt-6 text-center font-semibold text-primary"><p>Pai Nosso, 3 Ave-Marias, Glória.</p></div><div class="mt-8 p-6 bg-stone-100/50 rounded-xl border border-stone-200"><h4 class="section-title text-center">Oração Final</h4><p>Ó meu Amado Jesus, olho nesse momento para Vós, e peço-Vos por intercessão de São Luís Maria Grignion de Montfort que foi digno ser exaltado como <strong>AMANTE DA SANTÍSSIMA VIRGEM MARIA</strong> a graça que necessito (peça aqui a graça). Desde já vos agradeço Senhor, pela vossa bondade em escutar a minha oração.</p><p class="mt-4 text-center font-bold">São Luís Maria Grignion de Montfort, rogai por nós!</p><p class="text-center text-sm opacity-70">Glória ao Pai e ao Filho e ao Espírito Santo. Como era no princípio, agora e sempre. Amém.</p></div></div>`
      },
      {
        day: "Dia 3",
...
const saintsOfTheDayFevereiroExtra: SaintOfTheDayData[] = [
  ...
  { day: 27, month: 'Fevereiro', saints: [{ name: 'São Gabriel das Dores', imageUrl: '/images/sao_gabriel_dores.png', story: '<h4>São Gabriel das Dores - Jovem Passionista</h4><p>Francisco Possenti nasceu em Assis, Itália, em 1838, filho de um governador pontifício. Desde jovem, era alegre, sociável e amado por todos. Apesar de duas promessas de entrar para a vida religiosa, adiava a decisão. Mas Deus o chamava com insistência. Numa procissão, ao ver a imagem de Nossa Senhora, ouviu claramente no coração: "Francisco, o mundo não é para ti." Desta vez, respondeu com generosidade total.</p><p class="mt-4">Ao entrar na Congregação da Paixão (Passionistas), tomou o nome de Gabriel das Dores. Mergulhou com todo o coração na contemplação da Paixão de Jesus, encontrando nela não tristeza, mas uma alegria profunda e sobrenatural. Era conhecido por sua humildade, pureza e alegria contagiante — provou que a vida de penitência e oração não é triste, mas fonte de uma felicidade que o mundo não pode dar.</p><p class="mt-4">Tinha devoção filial e ardente a Nossa Senhora das Dores, vendo em Maria a Mãe que compartilhou plenamente a Paixão do Filho. Adoeceu de tuberculose e enfrentou a doença com serenidade admirável, oferecendo seus sofrimentos unidos aos de Cristo. Morreu com um sorriso nos lábios, contemplando a imagem de Nossa Senhora das Dores, em 27 de fevereiro de 1862, com apenas 24 anos.</p><p class="mt-4">Foi beatificado em 1908 e canonizado em 1920 pelo Papa Bento XV. É padroeiro e intercessor especial da juventude. Seu corpo, encontrado incorrupto, repousa em Isola del Gran Sasso, na Itália.</p><p class="mt-4"><b>Oração:</b> Ó São Gabriel das Dores, jovem que encontrastes na Paixão de Cristo a fonte de toda alegria, intercede por nós, especialmente pelos jovens. Que o teu exemplo nos inspire a viver com alegria e generosidade a nossa fé. Amém.</p><p class="mt-2 italic">São Gabriel das Dores, rogai por nós.</p>' }] },
