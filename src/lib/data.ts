import { SaintOfTheDayData } from './types-saints';
import { santosMarcoSetembro } from './santos-completo-fev-set';
import { saintsOfTheDayMarcoComplete } from './saints-fev-mar';
...
// SaintOfTheDayData is imported from lib/types-saints.ts
...
export const novenaData: Record<string, Novena> = {
    ...
    days: [
      {
        day: "Primeiro dia",
        title: "Primeiro dia",
        content: `<div class="day-specific-content"><p>Dou graças à Santíssima Trindade, Santíssimo São José, pelos muitos privilégios, méritos e virtudes com que vos enriqueceu e, principalmente, pelo grande e singularíssimo mérito a poucos concedido de ter sido santificado no ventre de vossa mãe e confirmado em graça. Que alegria para vosso coração ver-vos livre do pecado, que é a única coisa que desagrada a Deus Filho, que vos chamava de pai! Que graças destes à Trindade Beatífica por esse tão assinalado privilégio! Eu vos felicito, com todo o meu coração, pela inocência incomparável que tivestes desde antes de nascer e pela graça a amizade particular com que o mesmo Deus vos distinguiu.</p><p class="mt-4">Por esse privilégio e pela grande alegria que Ele vos causou, suplico-vos, ó meu querido pai, que me alcanceis de Deus um grande ódio ao pecado, grande amor às virtudes e à minha salvação eterna. E como creio que a graça que desejo conseguir nesta novena será benéfica à minha salvação, tenho inteira confiança de que a alcançareis por vossa poderosíssima intercessão; todavia, se minha oração não for bem dirigida, endireitai-a e rogai ao boníssimo Deus por mim. Amém.</p></div>`
      },
      {
        day: "Segundo dia",
        title: "Segundo dia",
        content: `<div class="day-specific-content"><p>Que felicidade a vossa, meu glorioso protetor, serdes escolhido milagrosamente para esposo da Imaculada Maria!</p><p>Alegro-me convosco pela satisfação imensa que experimentastes, naquele dia feliz, quando associastes vossa sorte à da Mãe de Jesus Cristo. Que admiração vos teriam os santos anjos, por serdes o sustentáculo da Mãe do Verbo encarnado e, por esse mesmo motivo, também protetor do Filho de Deus!</p><p>Uno meus louvores aos que, nesse dia, vos dariam os anjos do céu e, de todo o meu coração, vos felicito por vos ter sido dada de presente a Rainha dos Anjos, e pelo zelo que se dedicou a vosso serviço. Que transbordante felicidade! Que maravilha terdes por companheira aquela que trouxe o Filho de Deus em Seu seio sagrado!</p><p>Que felicidade terdes, para vosso consolo nas penas, a Consoladora dos aflitos, para conselheira nas dificuldades a sapientíssima Mãe de Jesus Cristo e para modelo nas virtudes, aquela que é o espelho sem mancha, a Majestade Divina e a imagem da bondade de Deus! Por esse favor e felicidade tão grandes, peço-vos, poderosíssimo José, a amizade e a graça de Deus, a proteção e o amparo constantes de Maria Santíssima. Amém.</p></div>`
      },
      {
        day: "Terceiro dia",
        title: "Terceiro dia",
        content: `<div class="day-specific-content"><p>Que pena tão amarga devíeis ter sentido em vosso coração, José gloriosíssimo, quando, em vossa humildade, julgastes dever separar-vos de vossa esposa Maria! Separar-vos de Maria, que tanto amáveis e que correspondia a vosso amor com amor puro e sincero.</p><p>Confraternizo-me convosco por aqueles momentos de sofrimento e por essa amarga provação que o Senhor vos permitiu! Por caridade, ficastes ao lado da Mãe do Unigênito Filho de Deus. Maria vos pertenceu e amou sempre no amor de Deus. Em Seu infinito poder, Deus fez nela maravilhas de Seu Divino Amor. Fostes a maior testemunha das grandiosidades operadas em Maria. Ela é o jardim de Deus e o paraíso onde o Filho tem seu recreio, e vós José, fostes o anjo da guarda desse jardim, o depositário desse eterno tesouro.</p><p>São José, aceitai sinceras felicitações pela parte ativa que Deus vos concedeu o mistério da Encarnação, e pela sujeição de Jesus e de Sua Santíssima Mãe às vossas ordens.</p><p>Por essa grande alegria e também pelos méritos da tristeza que a precedeu, suplico-vos, meu pai querido, que me alcanceis de Deus o conhecimento de Jesus Cristo e a graça de conservar uma fé tão viva em todos os seus mistérios, que esteja pronto a antes morrer que duvidar deles; alcançai-me, outrossim, a graça que, nesta novena, pretendo conseguir, se for para maior glória de Deus e bem de minha alma. Amém.</p></div>`
      },
      {
        day: "Quarto dia",
        title: "Quarto dia",
        content: `<div class="day-specific-content"><p>Esposo castíssimo da Mãe do Unigênito Filho de Deus, uno-me a vós na tristeza que experimentastes em Belém, quando lá chegando, depois de penosa viagem, vistes vossa venerada esposa Maria e o Salvador do mundo, que ela levava em suas entranhas, desconhecidos e repelidos de todas as casas e pousadas.</p><p>Ó meu querido José, como conhecestes então que o mundo não é amigo de Cristo, e que é impossível servir juntamente dois senhores tão inimigos e contrários! Dai-me a Jesus, que tanta alegria vos causou em Seu nascimento.</p><p>As vozes dos anjos dizendo "paz na terra aos homens de boa vontade" são principalmente dirigidas a vós. Aceitai meus louvores pelo muito amor que Jesus vos manifestou, escolhendo-vos para Seu pai nutrício e para seu poderoso defensor e amparo.</p><p>Permiti-me, gloriosíssimo e poderosíssimo santo, chegar aonde vós estais, perto de Jesus, contemplar Sua santidade divina e esplendor. Pedi a Jesus que Ele me dê as graças recebidas pelos pastores e reis que foram adorá-Lo no presépio; pedi-Lhe também as graças que desejo conseguir nesta novena, se forem para maior glória de Deus e salvação de minha alma. Amém.</p></div>`
      },
      {
        day: "Quinto dia",
        title: "Quinto dia",
        content: `<div class="day-specific-content"><p>Que grande dor sofrestes, nosso querido São José, quando vistes derramar-se o preciosíssimo Sangue de Cristo na circuncisão! Por que teria, esse infante divino, de sofrer assim, poucos dias depois de ter nascido? Ah! Sendo Jesus a perfeição em pessoa, certamente que foi pelos nossos pecados esse padecer.</p><p>São José, dai-me a conhecer o preço do Sangue de Jesus para que nunca deixe perder a menor gota; e que esse sangue, caindo abundantemente sobre minha alma, lave-me e purifique inteiramente. Permiti São José, que, para eu conseguir graça tão importante, aproxime-me mais de vós para ouvir atento e obedecer aos ensinamentos do Divino Mestre e receber as bênçãos e graças que dele emanam e que, por bondade divina, passam por vossas sagradas mãos.</p><p>Vossas mãos sagradas amparam Jesus, o Salvador do mundo, que tira os pecados dos homens! São José, que alegria a vossa, quando destes ao Salvador o nome de Jesus, sabendo que esse nome, a própria felicidade, é a chave que nos abre a porta do céu!</p><p>Adorador de Cristo, consiga que ele seja para mim Jesus, isto é, meu salvador nesta vida e na eterna.</p><p>Pelo nome adorável, Jesus, peço-vos também as graças que desejo alcançar nesta novena, se forem para maior glória de Deus e para o bem de minha alma. Amém.</p></div>`
      },
      {
        day: "Sexto dia",
        title: "Sexto dia",
        content: `<div class="day-specific-content"><p>Ó meu boníssimo São José, protetor e amparo dos desvalidos, por aquela alegria que experimentou o vosso coração, ouvindo os louvores que os doutores da lei fazem ao Cristo Menino, peço-vos que não vos esqueçais de mim, fazei que Jesus, meu Salvador, seja sempre para mim ocasião de ressurreição. Confraternizo-me convosco, pacienciosíssimo José, pela ferida que em vosso coração fizeram as palavras do Santo Simeão, com que anunciara a Maria que uma espada de dor havia de atravessar Seu delicado e amorosíssimo coração.</p><p>Em tão tremenda ocasião para Maria, vós nem poderíeis remediar essas dores, nem ao menos ser testemunha de tão terrível padecer, para consolar vossa esposa com vossa presença humana na Paixão de Cristo!</p><p>Eu, sim, posso e devo, com minha vida e bons costumes, consolar a Maria, porque culpado por meus pecados, na morte de Jesus e nas dores de Maria, quero e devo evitar e reparar esses pecados.</p><p>Ajudai, José poderosíssimo, minha pobreza espiritual e poucas forças, alcançando-me de Nosso Senhor a graça de nunca ser, por minha culpa, causa das penas de Jesus e das dores de Maria. Alcançai-me também a graça que desejo conseguir rezando esta novena, se for para maior glória de Deus e salvação de minha alma. Amém.</p></div>`
      },
      {
        day: "Sétimo dia",
        title: "Sétimo dia",
        content: `<div class="day-specific-content"><p>São José, permiti que, em espírito, eu vos acompanhe na viagem ao Egito para admirar vossos sacrifícios e imitar vossas virtudes. Tudo fizestes para defender Jesus de tantos perigos, sobretudo da morte.</p><p>Que dor tão grande foi para vosso coração amante ver sofrer Jesus e Maria! Quanta sede devem ter sofrido no deserto os três peregrinos santíssimos!</p><p>Peço-vos humildemente que tireis de mim a sede dos prazeres mundanos e dai-me a fome e a sede de todas as virtudes, principalmente a humildade, a paciência, a mortificação que a minha alma deseja ardentemente possuir. Entristeçam-me as coisas que vos entristecem, amável São José, e saiba eu alegrar-me com as que vos causam alegria.</p><p>Experimente minha alma, conservando-se na graça de Deus, a mesma alegria que experimentou vosso delicado coração, quando, afinal, depois dos transtornos de uma perigosa viagem por ermos desertos, vistes Jesus a salvo e Maria vossa amantíssima esposa segura no novo lar. Assim como vos alegrastes com a queda dos ídolos do Egito, alegra-se meu coração com a queda dos ídolos das afeições desregradas e das paixões desordenadas, de modo que, em tudo e por tudo, agrade a Jesus, à Santíssima Mãe e a vós, meu amável José, que tanto gozais na glória de Deus. Alcançai-me também a graça que desejo conseguir nesta novena, se for para maior glória de Deus. Amém.</p></div>`
      },
      {
        day: "Oitavo dia",
        title: "Oitavo dia",
        content: `<div class="day-specific-content"><p>Confraternizo-me convosco, terníssimo José, por causa das privações a que vistes sujeita vossa amada família, na terra de peregrinação, e pelo mesmo desterro tão meritório, sobretudo para a Mãe do Filho de Deus.</p><p>Uno minhas lágrimas às que derramastes, em vosso coração, pela dureza do exílio e por tudo que faltou a vós, a Maria e a Jesus, no Egito. Vossa família, que é a família de Deus, tão paciente, e eu me queixo de qualquer pequena e insignificante mortificação, ainda que necessária!</p><p>Ó meu querido José, pela alegria imensa que inundou vosso coração quando Jesus, pela primeira vez, deu-vos o doce nome de pai, e pela sujeição com que, pela primeira vez, vos prestou a homenagem de sua obediência, suplico-vos que me ensineis a obedecer aos meus superiores e a sofrer, com paciência e resignação, as provas que a Divina Providência se dignar enviar-me, para purificar-me de meus pecados ou para aumentar meus méritos.</p><p>Alcançai-me também, pela alegria com que voltastes do exílio para morar em Nazaré, a graça com que tanta humildade vos peço nesta novena, se não for em prejuízo de minha salvação. Amém.</p></div>`
      },
      {
        day: "Nono dia",
        title: "Nono dia",
        content: `<div class="day-specific-content"><p>Ó José, chamado por Jesus com o nome de pai, que dor e tormento indizível seria para vosso coração amorosíssimo ter perdido Jesus, com o qual estavam todas as afeições de vossa vida! Que grande aflição sentistes por não ter encontrado o Menino Jesus entre parentes e conhecidos e por ninguém ter dado notícias d'Ele.</p><p>Onde estaria Jesus? Como poderíeis viver se Ele era a vossa alegria de viver? Vós perdestes a Jesus, sem culpa vossa, mas eu perdi-O muitas vezes por culpa própria, por causa de minha malícia e de meus pecados.</p><p>Fazei-me conhecer a Jesus e procurá-Lo com perseverança, ensina-me a obedecê-Lo, ensina-me a adorá-Lo custe o que custar. Consiga-me a graça de que, de hoje em diante, nunca mais eu o perca pelo pecado e que se por infelicidade eu venha a perdê-Lo, nunca tenha sossego até que o encontre novamente pela divina graça.</p><p>Peço-vos esta graça, pela alegria inefável que experimentastes achando a Jesus no templo, ensinando, como Mestre Divino, aos doutores da lei e causando-lhes encanto e admiração com Suas perguntas e respostas.</p><p>Intercedei para que eu esteja sempre em união com Jesus e Sua santa Igreja. Consegui que Jesus esteja sempre em meu coração, com Sua divina caridade, e que, no futuro, eu possa gozar de Sua visão e amizade no céu para sempre.</p><p>Alcançai-me também as graças que vos tenho pedido, todos os dias, durante a novena. Tenho confiança de que, tudo que vos pedi, irei receber do amor de Deus, por vosso intermédio. De agora em diante, com a graça divina, serei divulgador do poder que o Misericordioso Deus vos concede. Amém.</p></div>`
      }
    ],
    versions: [
      {
        id: 'cancao_nova',
        name: 'Canção Nova',
        initialPrayer: `<div class="prayer-block"><h4 class="section-title">Oração para todos os dias</h4><p>Amado São José, vós que fostes instrumento da Providência Divina na Família de Nazaré, na Igreja e para com vossos irmãos, fixai nossos olhos nas coisas que não passam e dai-nos a graça de ordenar nossas vidas para os tesouros do céu. Amém!</p><p class="mt-3 text-center italic">Em seguida, reza-se um Pai-nosso, uma Ave Maria, um Glória.</p></div>`,
        finalPrayer: `<div class="final-prayer-text"><h4 class="section-title">Oração Final</h4><p>Glorioso São José, que fostes modelo de vivência da pobreza, da sobriedade, de instrumento da Divina Providência; vós que não detivestes para vós mesmo nenhum bem material ou espiritual, destinando-os sempre às necessidades de Jesus, de Maria e dos vossos irmãos; vós que, por graça divina, vistes restaurada em vós a vocação original do homem à caridade, trabalho, partilha e comunhão; vós que, inspirado pelo Espírito Santo, acolhestes a nova economia do Reino do vosso Filho Jesus, intercedei para que acolhamos o mesmo convite que vos fez o Pai de ser instrumentos de Sua Paz, de Sua Providência, de Sua Caridade, de Sua Pobreza para o homem de hoje. Amém.</p></div>`,
        days: [
          { day: 'Dia 1', title: '1º Dia – São José, instrumento da Providência na Família de Nazaré', content: `<div class="day-specific-content"><p>São José, servo da Caridade, que acolhestes com fé e coragem confiante a missão de ser instrumento da Divina Providência para com Jesus e Maria, aumentai em nós a fé, a coragem e a confiança em Deus para, também nós, sermos instrumentos da Providência, como é da vontade de Deus desde a criação do mundo.</p></div>` },
          { day: 'Dia 2', title: '2º Dia – São José, instrumento da Providência na Igreja', content: `<div class="day-specific-content"><p>São José, servo fiel e prudente, que sois Patrono da Igreja Católica no mundo inteiro, protegendo e sendo instrumento da Divina Providência para Jesus, seu Divino Fundador e para Maria, seu Modelo mais perfeito, dai-nos a graça de, também nós, apesar do nosso pecado e indignidade, termos o privilégio de ser instrumentos da Providência de Deus na Igreja do vosso Filho Jesus.</p></div>` },
          { day: 'Dia 3', title: '3º Dia – São José, Patrono de toda a Obra Shalom', content: `<div class="day-specific-content"><p>São José, humílimo servo do Senhor, que sois instrumento da Providência Divina para a Obra Shalom, sede nossa inspiração e modelo para que, esquecidos de nós mesmos, sirvamos a Deus e sejamos mediadores de Sua Providência para a evangelização através da Obra que nos foi confiada.</p></div>` },
          { day: 'Dia 4', title: '4º Dia – São José, auxílio na implantação da Paz no mundo', content: `<div class="day-specific-content"><p>São José, servo dulcíssimo, que educaste com exemplo, doçura e firmeza o Filho de Deus a vós confiado, ensinando-lhe o valor do trabalho como meio de partilha e vendo-o crescer em graça e sabedoria para a implantação de Sua Paz no mundo, auxilia-nos com os meios necessários para a educação dos nossos filhos e a formação dos que evangelizamos para que sejam, também eles, alegres testemunhas do Ressuscitado que passou pela cruz.</p></div>` },
          { day: 'Dia 5', title: '5º Dia – São José, construtor dos espaços sagrados', content: `<div class="day-specific-content"><p>São José, servo e trabalhador diligente, que construístes para Jesus e Maria o lar em que reinaram com perfeição a caridade e a alegria, ajudai-nos a construir em nossos lares e na Obra espaços sagrados dignos da presença viva do vosso amado Jesus.</p></div>` },
          { day: 'Dia 6', title: '6º Dia – São José, mantenedor do culto divino', content: `<div class="day-specific-content"><p>São José, servo piedoso, que tivestes para com Jesus e Maria permanente postura de oração, veneração, proteção e cuidado, servindo juntamente com Maria Àquele que adoráveis, fazei de nós instrumentos da Divina Providência para que nunca se extinga ou se empobreça em beleza, brilho, dignidade e piedade o culto divino em meio a nós.</p></div>` },
          { day: 'Dia 7', title: '7º Dia – São José, modelo de abandono nas mãos de Deus', content: `<div class="day-specific-content"><p>São José, servo confiante, que não temestes tomar sob vossa proteção e sustento a Maria e Jesus e, abandonado às mãos do Deus das Providências os servistes durante toda vossa vida sem reter para vós nada do fruto do vosso trabalho, ensinai-nos a acolher a graça do completo abandono nas mãos do Pai que cuida de nós muito melhor do que nós mesmos.</p></div>` },
          { day: 'Dia 8', title: '8º Dia – São José, educador na vivência da sobriedade', content: `<div class="day-specific-content"><p>São José, servo sóbrio e justo, que nunca considerastes como vosso o que vos poderia ser supérfluo, mas, longe disso, soubestes partilhar além do supérfluo, aquilo que Jesus, Maria e vossos irmãos necessitavam, ensinai-nos que o supérfluo não nos pertence, assim como, por direito de caridade, deixa de nos pertencer aquilo de que nosso irmão precisa.</p></div>` },
          { day: 'Dia 9', title: '9º Dia – São José, ícone do espírito de pobreza', content: `<div class="day-specific-content"><p>São José, servo pobre do Senhor, que entendestes ser a partilha original a mesma partilha da Trindade para conosco, e que, em Jesus Cristo, vos deixastes moldar pelo espírito de partilha e comunhão que antecederam o pecado original, concedei-nos, pelo poder do vosso Filho, a graça de honrar nosso Batismo com a conversão à partilha e comunhão das origens, agora elevada a caridade pelos méritos de Cristo.</p></div>` }
        ]
      },
      {
        id: 'shalom',
        name: 'Comunidade Shalom',
        initialPrayer: `<div class="prayer-block"><h4 class="section-title">Oração preparatória para todos os dias</h4><p>Deus e Senhor meu, Uno e Trino, Pai, Filho e Espírito Santo, creio que estou em Vossa soberana presença agora, quando pretendo consagrar a São José esta novena. Adoro-Vos com todo o meu coração, porque sois infinitamente bom e digno de ser amado sobre todas as coisas. Adoro-Vos com toda a intensidade de que sou capaz e arrependo-me dos muitos pecados que fiz contra Vossa Divina Majestade.</p><p class="mt-4">Quero, nesta novena, aprender as virtudes que, com tanta perfeição, praticou o glorioso Patriarca São José e alcançar, por sua intercessão, as graças de que tanto preciso. Senhor, quem sou eu para me atrever a comparecer diante de Vossa presença?</p><p class="mt-4">Conheço a deficiência de meus méritos e a multidão de meus pecados, pelos quais não mereço ser ouvido em minhas orações, mas o que não mereço merece-o o pai nutrício de Jesus; o que não posso, ele pode. Venho, portanto, com toda a confiança, implorar a divina clemência, não fiado em minha fraqueza, mas no poder e valimento de São José. Amém.</p></div>`,
        finalPrayer: `<div class="final-prayer-text"><h4 class="section-title">Oração final para todos os dias</h4><p>Lembrai-vos, ó puríssimo Esposo da Virgem Maria, ó meu doce Protetor São José, que jamais se ouviu dizer que alguém tivesse invocado vossa proteção, implorando vosso socorro e não fosse por vós consolado. Com grande confiança, venho a vossa presença recomendar-me fervorosamente a vós. Não desprezeis as minhas súplicas, ó pai adotivo do Redentor, mas dignai-vos acolhê-la piedosamente. Assim seja.</p><p class="mt-4"><b>ANT.</b> José, filho de Davi, não temas receber Maria, vossa Esposa Santíssima, em vossa companhia, porque o que ela leva em suas puríssimas entranhas é obra do Espírito Santo.</p><p class="mt-2">V. Rogai por nós, José santíssimo.<br/>R. Para que sejamos dignos das promessas de Cristo.</p><p class="mt-4 font-semibold">Oremos: Ó Jesus, que por uma inefável providência, dignastes-Vos escolher o bem-aventurado esposo de Vossa Mãe Santíssima; concedei-nos que aquele mesmo que veneramos como protetor, mereçamos tê-lo no céu por nosso intercessor. Vós que viveis e reinais por todos os séculos dos séculos. Amém.</p><p class="mt-4 italic">Para melhor alcançar as graças pedidas, rezaremos sete Pais-Nossos, sete Ave-Marias e sete Glórias ao Pai em honra das alegrias e dores do glorioso patriarca.</p></div>`,
        days: [
          { day: 'Dia 1', title: '1º Dia – Grande instrumento da Providência', content: `<div class="day-specific-content"><p>Dou graças à Santíssima Trindade, Santíssimo São José, pelos muitos privilégios, méritos e virtudes com que vos enriqueceu e, principalmente, pelo grande e singularíssimo mérito a poucos concedido de ter sido santificado no ventre de vossa mãe e confirmado em graça.</p><p class="mt-4">Por esse privilégio e pela grande alegria que Ele vos causou, suplico-vos, ó meu querido pai, que me alcanceis de Deus um grande ódio ao pecado, grande amor às virtudes e à minha salvação eterna. E como creio que a graça que desejo conseguir nesta novena será benéfica à minha salvação, tenho inteira confiança de que a alcançareis por vossa poderosíssima intercessão; todavia, se minha oração não for bem dirigida, endireitai-a e rogai ao boníssimo Deus por mim. Amém.</p></div>` },
          { day: 'Dia 2', title: '2º Dia – Esposo da Imaculada Maria', content: `<div class="day-specific-content"><p>Que felicidade a vossa, meu glorioso protetor, serdes escolhido milagrosamente para esposo da Imaculada Maria! Alegro-me convosco pela satisfação imensa que experimentastes, naquele dia feliz, quando associastes vossa sorte à da Mãe de Jesus Cristo.</p><p class="mt-4">Por esse favor e felicidade tão grandes, peço-vos, poderosíssimo José, a amizade e a graça de Deus, a proteção e o amparo constantes de Maria Santíssima. Amém.</p></div>` },
          { day: 'Dia 3', title: '3º Dia – Guardião do mistério da Encarnação', content: `<div class="day-specific-content"><p>Que pena tão amarga devíeis ter sentido em vosso coração, José gloriosíssimo, quando, em vossa humildade, julgastes dever separar-vos de vossa esposa Maria! Fostes a maior testemunha das grandiosidades operadas em Maria — o jardim de Deus e o paraíso onde o Filho tem seu recreio.</p><p class="mt-4">São José, aceitai sinceras felicitações pela parte ativa que Deus vos concedeu o mistério da Encarnação. Por essa grande alegria, suplico-vos que me alcanceis a graça de conservar uma fé tão viva que esteja pronto a antes morrer que duvidar dos mistérios de Cristo. Amém.</p></div>` },
          { day: 'Dia 4', title: '4º Dia – Pai nutrício de Jesus em Belém', content: `<div class="day-specific-content"><p>Esposo castíssimo da Mãe do Unigênito Filho de Deus, uno-me a vós na tristeza que experimentastes em Belém, quando lá chegando, depois de penosa viagem, vistes vossa venerada esposa Maria e o Salvador do mundo desconhecidos e repelidos de todas as casas e pousadas.</p><p class="mt-4">Permiti-me, gloriosíssimo e poderosíssimo santo, chegar aonde vós estais, perto de Jesus, contemplar Sua santidade divina e esplendor. Pedi a Jesus que me dê as graças que desejo conseguir nesta novena, se forem para maior glória de Deus e salvação de minha alma. Amém.</p></div>` },
          { day: 'Dia 5', title: '5º Dia – Testemunha da Circuncisão de Jesus', content: `<div class="day-specific-content"><p>Que grande dor sofrestes, nosso querido São José, quando vistes derramar-se o preciosíssimo Sangue de Cristo na circuncisão! São José, dai-me a conhecer o preço do Sangue de Jesus para que nunca deixe perder a menor gota; e que esse sangue, caindo abundantemente sobre minha alma, lave-me e purifique inteiramente.</p><p class="mt-4">São José, que alegria a vossa, quando destes ao Salvador o nome de Jesus — a chave que nos abre a porta do céu! Pelo nome adorável Jesus, peço-vos as graças que desejo alcançar nesta novena. Amém.</p></div>` },
          { day: 'Dia 6', title: '6º Dia – Justo que escuta Simeão no Templo', content: `<div class="day-specific-content"><p>Ó meu boníssimo São José, protetor e amparo dos desvalidos, por aquela alegria que experimentou o vosso coração, ouvindo os louvores que os doutores da lei fazem ao Cristo Menino, peço-vos que não vos esqueçais de mim.</p><p class="mt-4">Ajudai, José poderosíssimo, minha pobreza espiritual e poucas forças, alcançando-me de Nosso Senhor a graça de nunca ser, por minha culpa, causa das penas de Jesus e das dores de Maria. Alcançai-me também a graça que desejo conseguir rezando esta novena. Amém.</p></div>` },
          { day: 'Dia 7', title: '7º Dia – Protetor na fuga para o Egito', content: `<div class="day-specific-content"><p>São José, permiti que, em espírito, eu vos acompanhe na viagem ao Egito para admirar vossos sacrifícios e imitar vossas virtudes. Tudo fizestes para defender Jesus de tantos perigos, sobretudo da morte.</p><p class="mt-4">Peço-vos humildemente que tireis de mim a sede dos prazeres mundanos e dai-me a fome e a sede de todas as virtudes. Alcançai-me também a graça que desejo conseguir nesta novena, se for para maior glória de Deus. Amém.</p></div>` },
          { day: 'Dia 8', title: '8º Dia – Peregrino e exilado no Egito', content: `<div class="day-specific-content"><p>Confraternizo-me convosco, terníssimo José, por causa das privações a que vistes sujeita vossa amada família, na terra de peregrinação, e pelo mesmo desterro tão meritório.</p><p class="mt-4">Ó meu querido José, pela alegria imensa que inundou vosso coração quando Jesus, pela primeira vez, deu-vos o doce nome de pai, suplico-vos que me ensineis a obedecer aos meus superiores e a sofrer, com paciência e resignação, as provas que a Divina Providência enviar-me. Amém.</p></div>` },
          { day: 'Dia 9', title: '9º Dia – Quem encontrou Jesus no Templo', content: `<div class="day-specific-content"><p>Ó José, chamado por Jesus com o nome de pai, que dor e tormento indizível seria para vosso coração amorosíssimo ter perdido Jesus! Vós perdestes a Jesus, sem culpa vossa, mas eu perdi-O muitas vezes por culpa própria, por causa de minha malícia e de meus pecados.</p><p class="mt-4">Fazei-me conhecer a Jesus e procurá-Lo com perseverança. Consegui que Jesus esteja sempre em meu coração, com Sua divina caridade, e que no futuro eu possa gozar de Sua visão e amizade no céu para sempre. Alcançai-me também as graças que vos tenho pedido durante a novena. Amém.</p></div>` }
        ]
      }
    ]
  },
  ...
  ns_saude: {
    ...
    novenaTitle: 'Novena a N.S. da Saúde',
  ...
  teresinha: {
    saintName: 'Santa Terezinha',
    novenaTitle: 'Novena Milagrosa de Santa Terezinha do Menino Jesus',
    description: 'A Novena das Rosas — “Do céu eu farei cair sobre a Terra uma chuva de Rosas”.',
    image: 'https://i.postimg.cc/G2y7k85b/image.png',
    initialPrayer: `<div class="initial-prayer-text w-full flex justify-center"><div class="novena-rosas-container w-full text-center py-2 my-2"><span class="novena-rosas-title font-novena-rosas text-4xl sm:text-5xl md:text-6xl text-rose-200 font-normal tracking-wide whitespace-nowrap drop-shadow-[0_2px_8px_rgba(0,0,0,0.6)] inline-block">Novena das Rosas</span></div></div>`,
    finalPrayer: `<div class="final-prayer-text"><div class="p-4 bg-rose-50/60 dark:bg-rose-950/20 border border-rose-200/60 dark:border-rose-900/30 rounded-xl text-center mt-4"><p class="text-sm sm:text-base font-serif italic text-rose-800 dark:text-rose-200 font-medium">“Do céu eu farei cair sobre a Terra uma chuva de Rosas”</p><p class="text-xs sm:text-sm font-semibold text-rose-900 dark:text-rose-200 mt-2">Santa Terezinha do Menino Jesus e da Sagrada Face, rogai por nós <span class="font-normal italic">(por mim ou nome da pessoa por quem está intercedendo)</span>.</p></div></div>`,
    days: [
      {
        day: '1º Dia – Pelo Clero',
        title: 'Santa Terezinha doutora e amante da Igreja',
        content: `<div class="day-specific-content"><div class="p-3.5 bg-rose-50/80 dark:bg-rose-950/30 border border-rose-200 dark:border-rose-800/40 rounded-xl text-sm mb-4"><p class="font-medium text-stone-800 dark:text-stone-200">Neste dia rezemos pelos que exercem o ministério sacerdotal, pela santificação do Clero e pelas intenções do coração do Santo Padre.</p></div><div class="prayer-block my-4"><h4 class="font-bold text-sm text-primary mb-2">Oração</h4><p class="text-sm leading-relaxed">Santíssima Trindade: Pai, Filho e Espírito Santo: eu vos agradeço por todas as graças com que enriqueceste a vida de vossa serva, Santa Terezinha do Menino Jesus e da Sagrada Face, nestes 24 anos que passou na terra. E pelos méritos de tão querida santinha, concedei-me a graça que ardentemente vos peço … <span class="italic text-primary font-medium">(faça aqui o pedido)</span>, se for conforme a Vossa Santíssima Vontade e para a salvação de minha alma (ou da pessoa por quem está rezando).</p><p class="text-sm leading-relaxed mt-2">Ajudai minha fé e minha esperança, Santa Terezinha, cumprindo mais uma vez vossa promessa de que ficareis no Céu a fazer o bem na terra, permitindo que eu ganhe um rosa em sinal de que alcançarei a graça pedida.</p></div><div class="p-3.5 bg-stone-100 dark:bg-stone-800/60 rounded-xl my-4 text-xs"><p class="font-semibold text-stone-700 dark:text-stone-300 mb-1">Em seguida rezar 24 vezes, por cada ano de Santa Terezinha na terra:</p><p class="italic text-primary font-medium">“Glória ao Pai, ao Filho e ao Espírito Santo como era no princípio, agora e sempre. Amém.”</p><p class="font-semibold mt-1">Santa Terezinha do Menino Jesus e da Sagrada Face, rogai por mim <span class="font-normal italic">(ou o nome da pessoa por quem está intercedendo)</span>.</p></div><div class="p-3 bg-primary/10 border border-primary/20 rounded-xl my-3 text-center text-xs font-semibold text-primary">Para finalizar rezar: 1 Ave-Maria e 1 Pai-Nosso.</div></div>`
      },
      {
        day: '2º Dia – Pelos Missionários',
        title: 'Santa Terezinha padroeira das missões',
        content: `<div class="day-specific-content"><div class="p-3.5 bg-rose-50/80 dark:bg-rose-950/30 border border-rose-200 dark:border-rose-800/40 rounded-xl text-sm mb-4"><p class="font-medium text-stone-800 dark:text-stone-200">Neste dia rezemos pelos missionários espalhados no mundo inteiro e suas necessidades espirituais e materiais.</p></div><div class="prayer-block my-4"><h4 class="font-bold text-sm text-primary mb-2">Oração</h4><p class="text-sm leading-relaxed">Santíssima Trindade: Pai, Filho e Espírito Santo: eu vos agradeço por todas as graças com que enriqueceste a vida de vossa serva, Santa Terezinha do Menino Jesus e da Sagrada Face, nestes 24 anos que passou na terra. E pelos méritos de tão querida santinha, concedei-me a graça que ardentemente vos peço … <span class="italic text-primary font-medium">(faça aqui o pedido)</span>, se for conforme a Vossa Santíssima Vontade e para a salvação de minha alma (ou da pessoa por quem está rezando).</p><p class="text-sm leading-relaxed mt-2">Ajudai minha fé e minha esperança, Santa Terezinha, cumprindo mais uma vez vossa promessa de que ficareis no Céu a fazer o bem na terra, permitindo que eu ganhe um rosa em sinal de que alcançarei a graça pedida.</p></div><div class="p-3.5 bg-stone-100 dark:bg-stone-800/60 rounded-xl my-4 text-xs"><p class="font-semibold text-stone-700 dark:text-stone-300 mb-1">Em seguida rezar 24 vezes, por cada ano de Santa Terezinha na terra:</p><p class="italic text-primary font-medium">“Glória ao Pai, ao Filho e ao Espírito Santo como era no princípio, agora e sempre. Amém.”</p><p class="font-semibold mt-1">Santa Terezinha do Menino Jesus e da Sagrada Face, rogai por mim <span class="font-normal italic">(ou o nome da pessoa por quem está intercedendo)</span>.</p></div><div class="p-3 bg-primary/10 border border-primary/20 rounded-xl my-3 text-center text-xs font-semibold text-primary">Para finalizar rezar: 1 Ave-Maria e 1 Pai-Nosso.</div></div>`
      },
      {
        day: '3º Dia – Pelos Cristãos perseguidos e martirizados',
        title: 'Santa Terezinha que teve uma vida de sacrifícios pelas almas',
        content: `<div class="day-specific-content"><div class="p-3.5 bg-rose-50/80 dark:bg-rose-950/30 border border-rose-200 dark:border-rose-800/40 rounded-xl text-sm mb-4"><p class="font-medium text-stone-800 dark:text-stone-200">Neste dia rezemos pelos Cristãos que são perseguidos e martirizados por sua fidelidade e amor a Cristo.</p></div><div class="prayer-block my-4"><h4 class="font-bold text-sm text-primary mb-2">Oração</h4><p class="text-sm leading-relaxed">Santíssima Trindade: Pai, Filho e Espírito Santo: eu vos agradeço por todas as graças com que enriqueceste a vida de vossa serva, Santa Terezinha do Menino Jesus e da Sagrada Face, nestes 24 anos que passou na terra. E pelos méritos de tão querida santinha, concedei-me a graça que ardentemente vos peço … <span class="italic text-primary font-medium">(faça aqui o pedido)</span>, se for conforme a Vossa Santíssima Vontade e para a salvação de minha alma (ou da pessoa por quem está rezando).</p><p class="text-sm leading-relaxed mt-2">Ajudai minha fé e minha esperança, Santa Terezinha, cumprindo mais uma vez vossa promessa de que ficareis no Céu a fazer o bem na terra, permitindo que eu ganhe um rosa em sinal de que alcançarei a graça pedida.</p></div><div class="p-3.5 bg-stone-100 dark:bg-stone-800/60 rounded-xl my-4 text-xs"><p class="font-semibold text-stone-700 dark:text-stone-300 mb-1">Em seguida rezar 24 vezes, por cada ano de Santa Terezinha na terra:</p><p class="italic text-primary font-medium">“Glória ao Pai, ao Filho e ao Espírito Santo como era no princípio, agora e sempre. Amém.”</p><p class="font-semibold mt-1">Santa Terezinha do Menino Jesus e da Sagrada Face, rogai por mim <span class="font-normal italic">(ou o nome da pessoa por quem está intercedendo)</span>.</p></div><div class="p-3 bg-primary/10 border border-primary/20 rounded-xl my-3 text-center text-xs font-semibold text-primary">Para finalizar rezar: 1 Ave-Maria e 1 Pai-Nosso.</div></div>`
      },
      {
        day: '4º Dia – Pelas Famílias',
        title: 'Santa Terezinha que viveu em uma família santa',
        content: `<div class="day-specific-content"><div class="p-3.5 bg-rose-50/80 dark:bg-rose-950/30 border border-rose-200 dark:border-rose-800/40 rounded-xl text-sm mb-4"><p class="font-medium text-stone-800 dark:text-stone-200">Neste dia rezemos pela união e santificação das famílias.</p></div><div class="prayer-block my-4"><h4 class="font-bold text-sm text-primary mb-2">Oração</h4><p class="text-sm leading-relaxed">Santíssima Trindade: Pai, Filho e Espírito Santo: eu vos agradeço por todas as graças com que enriqueceste a vida de vossa serva, Santa Terezinha do Menino Jesus e da Sagrada Face, nestes 24 anos que passou na terra. E pelos méritos de tão querida santinha, concedei-me a graça que ardentemente vos peço … <span class="italic text-primary font-medium">(faça aqui o pedido)</span>, se for conforme a Vossa Santíssima Vontade e para a salvação de minha alma (ou da pessoa por quem está rezando).</p><p class="text-sm leading-relaxed mt-2">Ajudai minha fé e minha esperança, Santa Terezinha, cumprindo mais uma vez vossa promessa de que ficareis no Céu a fazer o bem na terra, permitindo que eu ganhe um rosa em sinal de que alcançarei a graça pedida.</p></div><div class="p-3.5 bg-stone-100 dark:bg-stone-800/60 rounded-xl my-4 text-xs"><p class="font-semibold text-stone-700 dark:text-stone-300 mb-1">Em seguida rezar 24 vezes, por cada ano de Santa Terezinha na terra:</p><p class="italic text-primary font-medium">“Glória ao Pai, ao Filho e ao Espírito Santo como era no princípio, agora e sempre. Amém.”</p><p class="font-semibold mt-1">Santa Terezinha do Menino Jesus e da Sagrada Face, rogai por mim <span class="font-normal italic">(ou o nome da pessoa por quem está intercedendo)</span>.</p></div><div class="p-3 bg-primary/10 border border-primary/20 rounded-xl my-3 text-center text-xs font-semibold text-primary">Para finalizar rezar: 1 Ave-Maria e 1 Pai-Nosso.</div></div>`
      },
      {
        day: '5º Dia – Pelos Jovens',
        title: 'Santa Terezinha padroeira dos jovens',
        content: `<div class="day-specific-content"><div class="p-3.5 bg-rose-50/80 dark:bg-rose-950/30 border border-rose-200 dark:border-rose-800/40 rounded-xl text-sm mb-4"><p class="font-medium text-stone-800 dark:text-stone-200">Neste dia rezemos pelos jovens do Projeto Juventude para Jesus e pela juventude do mundo inteiro.</p></div><div class="prayer-block my-4"><h4 class="font-bold text-sm text-primary mb-2">Oração</h4><p class="text-sm leading-relaxed">Santíssima Trindade: Pai, Filho e Espírito Santo: eu vos agradeço por todas as graças com que enriqueceste a vida de vossa serva, Santa Terezinha do Menino Jesus e da Sagrada Face, nestes 24 anos que passou na terra. E pelos méritos de tão querida santinha, concedei-me a graça que ardentemente vos peço … <span class="italic text-primary font-medium">(faça aqui o pedido)</span>, se for conforme a Vossa Santíssima Vontade e para a salvação de minha alma (ou da pessoa por quem está rezando).</p><p class="text-sm leading-relaxed mt-2">Ajudai minha fé e minha esperança, Santa Terezinha, cumprindo mais uma vez vossa promessa de que ficareis no Céu a fazer o bem na terra, permitindo que eu ganhe um rosa em sinal de que alcançarei a graça pedida.</p></div><div class="p-3.5 bg-stone-100 dark:bg-stone-800/60 rounded-xl my-4 text-xs"><p class="font-semibold text-stone-700 dark:text-stone-300 mb-1">Em seguida rezar 24 vezes, por cada ano de Santa Terezinha na terra:</p><p class="italic text-primary font-medium">“Glória ao Pai, ao Filho e ao Espírito Santo como era no princípio, agora e sempre. Amém.”</p><p class="font-semibold mt-1">Santa Terezinha do Menino Jesus e da Sagrada Face, rogai por mim <span class="font-normal italic">(ou o nome da pessoa por quem está intercedendo)</span>.</p></div><div class="p-3 bg-primary/10 border border-primary/20 rounded-xl my-3 text-center text-xs font-semibold text-primary">Para finalizar rezar: 1 Ave-Maria e 1 Pai-Nosso.</div></div>`
      },
      {
        day: '6º Dia – Pelos que sofrem de depressão',
        title: 'Santa Terezinha que foi curada pelo sorriso de Maria',
        content: `<div class="day-specific-content"><div class="p-3.5 bg-rose-50/80 dark:bg-rose-950/30 border border-rose-200 dark:border-rose-800/40 rounded-xl text-sm mb-4"><p class="font-medium text-stone-800 dark:text-stone-200">Neste dia rezemos pelos que sofrem de depressão, pelos que vivem oprimidos e sem sentido de vida.</p></div><div class="prayer-block my-4"><h4 class="font-bold text-sm text-primary mb-2">Oração</h4><p class="text-sm leading-relaxed">Santíssima Trindade: Pai, Filho e Espírito Santo: eu vos agradeço por todas as graças com que enriqueceste a vida de vossa serva, Santa Terezinha do Menino Jesus e da Sagrada Face, nestes 24 anos que passou na terra. E pelos méritos de tão querida santinha, concedei-me a graça que ardentemente vos peço … <span class="italic text-primary font-medium">(faça aqui o pedido)</span>, se for conforme a Vossa Santíssima Vontade e para a salvação de minha alma (ou da pessoa por quem está rezando).</p><p class="text-sm leading-relaxed mt-2">Ajudai minha fé e minha esperança, Santa Terezinha, cumprindo mais uma vez vossa promessa de que ficareis no Céu a fazer o bem na terra, permitindo que eu ganhe um rosa em sinal de que alcançarei a graça pedida.</p></div><div class="p-3.5 bg-stone-100 dark:bg-stone-800/60 rounded-xl my-4 text-xs"><p class="font-semibold text-stone-700 dark:text-stone-300 mb-1">Em seguida rezar 24 vezes, por cada ano de Santa Terezinha na terra:</p><p class="italic text-primary font-medium">“Glória ao Pai, ao Filho e ao Espírito Santo como era no princípio, agora e sempre. Amém.”</p><p class="font-semibold mt-1">Santa Terezinha do Menino Jesus e da Sagrada Face, rogai por mim <span class="font-normal italic">(ou o nome da pessoa por quem está intercedendo)</span>.</p></div><div class="p-3 bg-primary/10 border border-primary/20 rounded-xl my-3 text-center text-xs font-semibold text-primary">Para finalizar rezar: 1 Ave-Maria e 1 Pai-Nosso.</div></div>`
      },
      {
        day: '7º Dia – Para que todos amem a Cristo',
        title: 'Santa Terezinha apaixonada por Jesus',
        content: `<div class="day-specific-content"><div class="p-3.5 bg-rose-50/80 dark:bg-rose-950/30 border border-rose-200 dark:border-rose-800/40 rounded-xl text-sm mb-4"><p class="font-medium text-stone-800 dark:text-stone-200">Neste dia rezemos para que todos tenham um coração inflamado de amor a Cristo.</p></div><div class="prayer-block my-4"><h4 class="font-bold text-sm text-primary mb-2">Oração</h4><p class="text-sm leading-relaxed">Santíssima Trindade: Pai, Filho e Espírito Santo: eu vos agradeço por todas as graças com que enriqueceste a vida de vossa serva, Santa Terezinha do Menino Jesus e da Sagrada Face, nestes 24 anos que passou na terra. E pelos méritos de tão querida santinha, concedei-me a graça que ardentemente vos peço … <span class="italic text-primary font-medium">(faça aqui o pedido)</span>, se for conforme a Vossa Santíssima Vontade e para a salvação de minha alma (ou da pessoa por quem está rezando).</p><p class="text-sm leading-relaxed mt-2">Ajudai minha fé e minha esperança, Santa Terezinha, cumprindo mais uma vez vossa promessa de que ficareis no Céu a fazer o bem na terra, permitindo que eu ganhe um rosa em sinal de que alcançarei a graça pedida.</p></div><div class="p-3.5 bg-stone-100 dark:bg-stone-800/60 rounded-xl my-4 text-xs"><p class="font-semibold text-stone-700 dark:text-stone-300 mb-1">Em seguida rezar 24 vezes, por cada ano de Santa Terezinha na terra:</p><p class="italic text-primary font-medium">“Glória ao Pai, ao Filho e ao Espírito Santo como era no princípio, agora e sempre. Amém.”</p><p class="font-semibold mt-1">Santa Terezinha do Menino Jesus e da Sagrada Face, rogai por mim <span class="font-normal italic">(ou o nome da pessoa por quem está intercedendo)</span>.</p></div><div class="p-3 bg-primary/10 border border-primary/20 rounded-xl my-3 text-center text-xs font-semibold text-primary">Para finalizar rezar: 1 Ave-Maria e 1 Pai-Nosso.</div></div>`
      },
      {
        day: '8º Dia – Pelos prisioneiros',
        title: 'Santa Terezinha próxima dos prisioneiros',
        content: `<div class="day-specific-content"><div class="p-3.5 bg-rose-50/80 dark:bg-rose-950/30 border border-rose-200 dark:border-rose-800/40 rounded-xl text-sm mb-4"><p class="font-medium text-stone-800 dark:text-stone-200">Neste dia rezemos por todos os encarcerados e pelos que se encontram presos em si mesmo, pelo pecado.</p></div><div class="prayer-block my-4"><h4 class="font-bold text-sm text-primary mb-2">Oração</h4><p class="text-sm leading-relaxed">Santíssima Trindade: Pai, Filho e Espírito Santo: eu vos agradeço por todas as graças com que enriqueceste a vida de vossa serva, Santa Terezinha do Menino Jesus e da Sagrada Face, nestes 24 anos que passou na terra. E pelos méritos de tão querida santinha, concedei-me a graça que ardentemente vos peço … <span class="italic text-primary font-medium">(faça aqui o pedido)</span>, se for conforme a Vossa Santíssima Vontade e para a salvação de minha alma (ou da pessoa por quem está rezando).</p><p class="text-sm leading-relaxed mt-2">Ajudai minha fé e minha esperança, Santa Terezinha, cumprindo mais uma vez vossa promessa de que ficareis no Céu a fazer o bem na terra, permitindo que eu ganhe um rosa em sinal de que alcançarei a graça pedida.</p></div><div class="p-3.5 bg-stone-100 dark:bg-stone-800/60 rounded-xl my-4 text-xs"><p class="font-semibold text-stone-700 dark:text-stone-300 mb-1">Em seguida rezar 24 vezes, por cada ano de Santa Terezinha na terra:</p><p class="italic text-primary font-medium">“Glória ao Pai, ao Filho e ao Espírito Santo como era no princípio, agora e sempre. Amém.”</p><p class="font-semibold mt-1">Santa Terezinha do Menino Jesus e da Sagrada Face, rogai por mim <span class="font-normal italic">(ou o nome da pessoa por quem está intercedendo)</span>.</p></div><div class="p-3 bg-primary/10 border border-primary/20 rounded-xl my-3 text-center text-xs font-semibold text-primary">Para finalizar rezar: 1 Ave-Maria e 1 Pai-Nosso.</div></div>`
      },
      {
        day: '9º Dia – Pelos incrédulos',
        title: 'Santa Terezinha solidária aos incrédulos',
        content: `<div class="day-specific-content"><div class="p-3.5 bg-rose-50/80 dark:bg-rose-950/30 border border-rose-200 dark:border-rose-800/40 rounded-xl text-sm mb-4"><p class="font-medium text-stone-800 dark:text-stone-200">Neste último dia da Novena de Santa Terezinha, rezemos pelos que não creem, não esperam e não confiam em Deus.</p></div><div class="prayer-block my-4"><h4 class="font-bold text-sm text-primary mb-2">Oração</h4><p class="text-sm leading-relaxed">Santíssima Trindade: Pai, Filho e Espírito Santo: eu vos agradeço por todas as graças com que enriqueceste a vida de vossa serva, Santa Terezinha do Menino Jesus e da Sagrada Face, nestes 24 anos que passou na terra. E pelos méritos de tão querida santinha, concedei-me a graça que ardentemente vos peço … <span class="italic text-primary font-medium">(faça aqui o pedido)</span>, se for conforme a Vossa Santíssima Vontade e para a salvação de minha alma (ou da pessoa por quem está rezando).</p><p class="text-sm leading-relaxed mt-2">Ajudai minha fé e minha esperança, Santa Terezinha, cumprindo mais uma vez vossa promessa de que ficareis no Céu a fazer o bem na terra, permitindo que eu ganhe um rosa em sinal de que alcançarei a graça pedida.</p></div><div class="p-3.5 bg-stone-100 dark:bg-stone-800/60 rounded-xl my-4 text-xs"><p class="font-semibold text-stone-700 dark:text-stone-300 mb-1">Em seguida rezar 24 vezes, por cada ano de Santa Terezinha na terra:</p><p class="italic text-primary font-medium">“Glória ao Pai, ao Filho e ao Espírito Santo como era no princípio, agora e sempre. Amém.”</p><p class="font-semibold mt-1">Santa Terezinha do Menino Jesus e da Sagrada Face, rogai por mim <span class="font-normal italic">(ou o nome da pessoa por quem está intercedendo)</span>.</p></div><div class="p-3 bg-primary/10 border border-primary/20 rounded-xl my-3 text-center text-xs font-semibold text-primary">Para finalizar rezar: 1 Ave-Maria e 1 Pai-Nosso.</div></div>`
      }
    ]
  },
  lucas: {
  ...
  rosario: {
    ...
    novenaTitle: 'Novena a N.S. do Rosário',
  ...
  aparecida: {
    ...
    novenaTitle: 'Novena a N.S. Aparecida',
    description: 'Padroeira do Brasil, a Novena de N.S. Aparecida é a preparação para a grande Festa do Dia 12 de Outubro.',
  ...
  gracas: {
    ...
    novenaTitle: 'Novena a N.S. das Graças',
  ...
  john_henry_newman: {
    saintName: 'São John Henry Newman',
    novenaTitle: 'Novena a São John Henry Newman',
    description: 'Cardeal, teólogo e grande mestre da fé, intercessor na busca sincera da verdade e na perseverança cristã.',
    initialPrayer: '',
    finalPrayer: '',
    days: Array.from({ length: 9 }, (_, i) => ({
      day: `${i + 1}º Dia`,
  ...
  joao_xxiii: {
    saintName: 'São João XXIII',
    novenaTitle: 'Novena a São João XXIII',
    description: 'O amado Papa Bom, que convocou o Concílio Vaticano II com espírito de paz, diálogo e bondade paternal.',
    initialPrayer: '',
    finalPrayer: '',
    days: Array.from({ length: 9 }, (_, i) => ({
      day: `${i + 1}º Dia`,
  ...
  guadalupe: {
    saintName: 'N.S. de Guadalupe',
    novenaTitle: 'Novena de N.S. de Guadalupe',
    description: 'Padroeira das Américas. Reze pedindo proteção e consolo maternal.',
    image: 'https://images.cdn-files-a.com/uploads/5860772/2000_63cdf81a70b88.jpg',
    ...
    finalPrayer: `<div class="final-prayer-text">
        <h4 class="section-title">Oração Final</h4>
        <div class="prayer-block">
            <p>Ó gloriosa Mãe de Deus, N.S. de Guadalupe, padroeira das Américas, Tu és nossa mãe compassiva, Curai nossas penas, Nossas misérias e dores, Acolhei-nos no aconchego do Teu manto, Escutai mãe as nossas preces.</p>
  ...
  joao_cruz: {
    ...
    finalPrayer: `<div class="final-prayer-text">
        ...
        <div class="prayer-block">
            ...
            N.S. do Monte Carmelo, rogai por nós!<br/>
  ...
  epifania: {
    ...
    finalPrayer: `<div class="final-prayer-text">
        <h4 class="section-title">Oração à N.S. da Epifania</h4>
        <div class="prayer-block">
  ...
  santo_tomas_aquino: {
    ...
    description: 'Doutor Angélico e padroeiro dos estudos superiores. Peça sua intercessão para crescer em sabedoria e conhecimento de Deus.',
    image: 'https://i.postimg.cc/qRy1ZJqy/image.png',
    initialPrayer: `<div class="initial-prayer-text"><h4 class="section-title">Oração inicial para todos os dias da Novena</h4><div class="prayer-block"><p>À vós, meu Deus, fonte de misericórdia, eu me aproximo, pecador imundo, para que Vós Vos digneis a lavar minhas manchas. Ó sol da justiça, ilumine esse cego! Ó Doutor Eterno, cure este miserável! Ó Rei dos reis, vista este nu! Ó mediador entre Deus e os homens, reconcilie esse preso! Ó, Bom Pastor, seja bem-vindo a esta ovelha rebelde! Concedei, meu Deus, perdão a esse criminoso, indulgência a esse ímpio e a unção de Sua graça a essa vontade endurecida. Ó misericordioso Senhor, chame Seu fugitivo, atraia este resistente, levante aquele que caiu e uma vez ressuscitado, segure-o e guie seus passos. Não se esqueça, Senhor, a quem Vos esqueceu, não abandone aqueles que O abandonaram, não descarte aqueles que O rejeitaram e perdoe no céu aqueles que O ofenderam na terra. Amém.</p></div><div class="w-16 h-px bg-white/20 my-6 mx-auto"></div><h4 class="section-title">Oração à Santíssima Virgem</h4><div class="prayer-block"><p>Ó abençoada e doce Virgem Maria, oceano de bondade, Filha do rei soberano, Rainha dos anjos e Mãe do Criador! Me jogo confiante no seio de sua misericórdia e ternura, confiando-lhe meu corpo, minha alma, meus pensamentos, meus desejos, meus afetos e minha vida inteira, para que, com sua ajuda, eu sempre ande em direção ao bem, de acordo com a vontade de seu amado Filho, Nosso Senhor Jesus Cristo. Amém</p></div></div>`,
    finalPrayer: `<div class="final-prayer-text"><div class="w-16 h-px bg-white/20 my-8 mx-auto"></div><h4 class="section-title">Oração final para todos os dias</h4><div class="prayer-block"><p>Graças, Vos dou, Senhor meu Deus, e Pai das misericórdias, porque Vos dignastes a admitir, ao Seu pobre pecador e Seu indigno servo, a livre participação de Sua graça no segredo da oração. Peço-Lhe que esta comunicação da minha alma convosco não seja um castigo pelos meus defeitos, mas um penhor seguro do perdão das minhas ofensas, da melhor armadura da fé e do invulnerável escudo do meu coração. Conceda-me a remissão dos meus defeitos, o extermínio da concupiscência e sensualidade, o aumento da caridade, humildade, paciência, obediência e todas as virtudes; me defenda das armadilhas visíveis e invisíveis dos inimigos; Dá-me a calma inefável de meus apetites e todos os meus afetos, para que eu possa me juntar a Vós; melhor do que vossa é minha felicidade e descanso. Eu também imploro meu Deus, que depois de minha morte, Vós Vos digneis de me admitir na Páscoa celestial e no convite divino, onde Vós, em união do Filho e do Espírito Santo, Sois luz verdadeira, abundância perfeita, alegria eterna, alegria consumada e felicidade sem medida. Amém.</p></div><div class="prayer-request"><p class="italic my-4">Peça a graça especial que deseja alcançar por intercessão de Santo Tomás</p></div><p class="mt-4 font-semibold">Pai-nosso, Ave-Maria, Glória.</p><div class="prayer-block"><p>Ó Santo Tomás, glória e honra da Ordem dos Pregadores! Transporte-nos para a contemplação das coisas celestes, vós que fostes soberano mestre dos mistérios sagrados. Rogai por nós, Santo Tomás, para que sejamos dignos das promessas de Jesus Cristo.</p></div></div>`,
    days: [
      {
        day: '1º Dia',
        title: 'A Humildade',
        content: `<div class="day-specific-content"><h4>Meditação</h4><p>A humildade é uma virtude que restringe o apetite e o contém para não armazenar excessivamente objetos altos e excessivos. O humilde que, de acordo com São Isidoro, é inclinado à terra, considerando suas imperfeições e defeitos, está sempre arruinado e pequeno, e como o patriarca Abraão exclama em sua oração: "falarei ao Senhor meu Deus, não sendo mais que poeira e cinzas".</p><div class="w-16 h-px bg-white/20 my-6 mx-auto"></div><h4>Exemplo do Santo</h4><p>São Tomás de Aquino sempre praticou a humildade como a mais bela e necessária das virtudes. Ainda criança, ele era o encantamento de todos pela modéstia e humildade de seu caráter; quando era estudante, seus colegas, tendo em vista o silêncio muito humilde com o qual tentava encobrir os talentos que Deus o havia preenchido, recebeu o apelido de Boi Mudo e, mais tarde, doutor nas universidades de Paris e Roma, nunca se notou nele algum sinal de arrogância e vaidade e recusava vigorosamente as mais altas dignidades da Igreja sem sequer exercer a posição de prelado em um convento de sua ordem.</p></div>`
      },
      {
        day: '2º Dia',
        title: 'Reconhecer os Méritos dos Outros',
        content: `<div class="day-specific-content"><h4>Meditação</h4><p>Todos temos razões suficientes para nos humilharmos e nos reconhecermos em outros méritos e reconhecermos nos outros os méritos e excelências, de acordo com o apóstolo; "Vamos humildemente julgar os outros como nossos superiores".</p><div class="w-16 h-px bg-white/20 my-6 mx-auto"></div><h4>Exemplo do Santo</h4><p>Estava o doutor angélico tão persuadido da necessidade de ser humilde, o que pode ser dito que era seu esforço máximo e o norte de todos os seus atos. Sendo tão grande, ele nunca acreditou em sua grandeza e sempre pareceu pequeno e inferior aos outros.</p></div>`
      },
      {
        day: '3º Dia',
        title: 'A Fundação das Virtudes',
        content: `<div class="day-specific-content"><h4>Meditação</h4><p>Após as virtudes teológicas que nos direcionam diretamente a Deus e a justiça que estabelece a ordem da razão, a virtude da humildade com que a alma se dispõe para todas as outras virtudes segue em dignidade e excelência. É por isso que a humildade deve ser comparada à fundação de um edifício, pois, removendo tudo o que a Deus desagrada, torna a alma apta a receber as graças divinas, because sabe-se que Deus resiste aos orgulhosos e dá sua graça aos humildes.</p><div class="w-16 h-px bg-white/20 my-6 mx-auto"></div><h4>Exemplo do Santo</h4><p>Todos os agradecimentos recebidos por São Tomás, eles tinham sua razão e começaram na humildade de sua alma. Seus olhos, no chão, indicavam o êxtase milagroso em que seu coração foi tomado; suas palavras sempre eram muito modestas e oportunas, preferindo o silêncio à tagarelice vã; ele nunca quis distinguir entre seus irmãos e sua vida era bela, a mais modesta na presença do Senhor.</p></div>`
      },
      {
        day: '4º Dia',
        title: 'A Sabedoria',
        content: `<div class="day-specific-content"><h4>Meditação</h4><p>A sabedoria é um dos dons do Espírito Santo, com o qual a inteligência banhada pelas luzes celestes, é correta ao contemplar as coisas mais altas e, uma vez vistos esses motivos supremos, desce para julgar e correr sobre os outros objetos subordinados à razão.</p><div class="w-16 h-px bg-white/20 my-6 mx-auto"></div><h4>Exemplo do Santo</h4><p>Santo Tomás foi o novo Salomão da Igreja por causa da sabedoria portentosa com que o céu o enriqueceu. E como o velho Salomão diz a Sagrada Escritura que sabia tudo, desde o cedro das montanhas ao musgo e o hissopo das paredes, pode-se dizer a Tomás de Aquino que nada escapou de sua inteligência soberana, da teologia às ciências físicas e da Sagrada Escritura à política e linguística.</p></div>`
      },
      {
        day: '5º Dia',
        title: 'Sabedoria Prática',
        content: `<div class="day-specific-content"><h4>Meditação</h4><p>A sabedoria não é uma mera virtude técnica que figura todos os seus encantos na contemplação das maravilhas de Deus e na simples especulação dos mais altos princípios das coisas, mas, como diz o apóstolo, estende sua influência aos atos da vida regularizando os movimentos e organizando os fins das causas secundárias.</p><div class="w-16 h-px bg-white/20 my-6 mx-auto"></div><h4>Exemplo do Santo</h4><p>Desde que Santo Tomas, quando garoto de cinco anos, discutiu com os monges do Monte Casino, perguntando-lhes sobre a existência e os atributos de Deus, até que ele foi condecorado pelas universidades mais famosas do mundo, ele explicou como professor soberano as questões mais abstrusas da razão e da natureza. A fé e a sabedoria em seu sentido mais belo eram os companheiros inseparáveis de sua vida e o norte luminoso de todas as suas operações.</p></div>`
      },
      {
        day: '6º Dia',
        title: 'Sabedoria e Graça',
        content: `<div class="day-specific-content"><h4>Meditação</h4><p>Visto que esse dom do Espírito Santo é uma virtude tão bela e excelente, não pode ser encontrado, como foi dito no dia anterior, com a mancha e a culpa da alma: mas onde a graça está assentada, vive a sabedoria, agora que Deus ama apenas aqueles que são adornados com sabedoria, e o amor de Deus implica a alma em graça e causa, ao contrário, a mesma graça e amizade divina.</p><div class="w-16 h-px bg-white/20 my-6 mx-auto"></div><h4>Exemplo do Santo</h4><p>Raramente a sabedoria brilhou tão pura e radiante quanto na testa de Santo Tomás. E não apenas ele parou na luz que encantou aqueles que o viram com seus raios, mas que em um incêndio de caridade ele atraiu a Deus aqueles que se ilustraram de perto com os esplendores daquele Sol. Ninguém falou com Santo Tomas que não era docemente amarrado com correntes de amor divino, ninguém o viu para não abençoar o céu, ninguém o ouviu em suas explicações luminosas do Mestre, que não acreditavam ter visto o dedo de Deus acendendo em sua inteligência a bela chama do gênio.</p></div>`
      },
      {
        day: '7º Dia',
        title: 'A Santa Virgindade',
        content: `<div class="day-specific-content"><h4>Meditação</h4><p>Entre as virtudes cristãs, não há nada mais belo e resplandecente que a santa virgindade, através da qual, como ensina Santo Agostinho, a integridade da carne é consagrada e oferecida ao Senhor. Assim como se diz que uma planta é verde e fresca, quando a abundância de calor não agita ou murcha sua seiva, uma pessoa chamada virgem é dedicada a tudo de seu Deus. Ela está livre do calor das paixões e fogo de concupiscência; Portanto, Santo Ambrósio diz que, na razão da virgindade, está envolvido o conceito de limpeza absoluta e que a alma está livre da corrupção dos sentidos, sendo a essência dessa virtude celestial acompanhada de um propósito firme e perpétuo: abster-se da imundície da sensualidade.</p><div class="w-16 h-px bg-white/20 my-6 mx-auto"></div><h4>Exemplo do Santo</h4><p>Santo Tomás foi um virgem muito puro a vida toda. Da luta titânica mantida em Roca-Seca, onde conquistou como soldado corajoso a bela palma da vitória e o cordão abençoado com o qual os anjos enrolavam seus lombos, a vida inteira do inacabado doutor dominicano era um contínuo idílio de inocência que eles mesmos os serafins adoraram.</p></div>`
      },
      {
        day: '8º Dia',
        title: 'Pureza de Coração',
        content: `<div class="day-specific-content"><h4>Meditação</h4><p>Basta saber que é virtude e ato meritório, portanto, entender não apenas a legalidade, mas pelo menos a conveniência da virgindade. Além disso, é sabido que, nos atos humanos, algo ilícito e cruel pode ser encontrado quando os poderes se opõem ou não seguem a opinião do motivo que é o regulador de todas as operações, ordenando-os para um fim pré-concebido como bom.</p><div class="w-16 h-px bg-white/20 my-6 mx-auto"></div><h4>Exemplo do Santo</h4><p>Santo Tomás vivia tão separado da carne e de seus instintos que, mais do que um homem, ele parecia um anjo ocupado apenas em Deus e no aumento de sua honra. Nem a próstata de sua linhagem era suficiente para ofuscar seu coração, nem a delicadeza de seu corpo inocente, fazia parte para atenuar o rigor com o qual ele sempre tentava mortificar e manter suas paixões afastadas e os apetites por toda sua carne.</p></div>`
      },
      {
        day: '9º Dia',
        title: 'Perfeição do Estado Religioso',
        content: `<div class="day-specific-content"><h4>Meditação</h4><p>Sem dúvida, é a virgindade mais bela e excelente do que o estado civil e uma das virtudes mais agradáveis aos olhos divinos. Dizer o contrário, afirmar que o casamento é em si mais perfeito que o estado celibatário, foi o erro de Jovinian tantas vezes repetido e vangloriado em tons às vezes satíricos e além de satiristas profanos e imorais.</p><div class="w-16 h-px bg-white/20 my-6 mx-auto"></div><h4>Exemplo do Santo</h4><p>O doutor angélico estava tão apaixonado pelo estado religioso e tão apaixonado pela virgindade que se observa que os ferozes ataques promovidos pelo mundo, demônios e carne não foram suficientes para fazê-lo desistir de sua companhia. Religioso vestidos com um hábito muito branco, símbolo de inocência e sinceridade, era São Tomás de Aquino e por ter abraçado a vida pobre, mortificada e oculta em Jesus, o perfume de sua pureza imaculada e o brilho de sua ciência celestial descobriram seus tesouros e deram nome e fama sem segundo santo.</p></div>`
      }
    ]
  },
  sao_francisco_sales: {
  ...
  ns_candeias: {
    ...
    initialPrayer: `<div class="initial-prayer-text">
        ...
        <p>Reza-se a Ladainha à N.S. das Candeias;</p>
    ...
    finalPrayer: `<div class="final-prayer-text">
        <h4 class="section-title">Ladainha a N.S.</h4>
        <p>Senhor, tende piedade de nós.<br>
        Jesus Cristo, tende piedade de nós.<br>
    ...
    days: [
      {
        day: '1º Dia',
        title: 'O Sim de Maria e a Obediência da Fé',
        content: `<div class="day-specific-content">
                <h4>A Obediência de Maria e José à Vontade Divina</h4>
                <p>No primeiro dia da nossa novena, contemplamos Maria Santíssima e São José preparando-se para subir a Jerusalém e apresentar o Menino Jesus no Templo. A lei exigia a purificação da mãe e a apresentação do primogênito. Maria, a Imaculada, livre de toda mancha, não precisava de purificação. Jesus, o próprio Deus encarnado, não precisava ser resgatado. No entanto, por humildade e perfeito amor à vontade do Pai, eles se submetem à Lei.</p>
                <p class="mt-4">A obediência de Maria é a luz que brilha no início de sua jornada materna. Aprendamos com a Mãe das Candeias a amar os mandamentos de Deus e a praticá-los com alegria, mesmo quando não compreendemos plenamente os desígnios divinos.</p>
                <h4 class="mt-4">Oração para o Dia:</h4>
                <p>Ó Virgem das Candeias, Mãe obediente e humilde, ensinai-nos a acolher com docilidade a Palavra de Deus e a submeter a nossa vontade à Sua santa vontade. Livrai-nos da soberba e do orgulho, para que nossa vida seja um reflexo do vosso "Fiat". Amém.</p>
                <p class="mt-4 italic"><b>Jaculatória:</b> Ó Virgem Mãe das Candeias, estrela resplandecente, guiai nossa obediência a Deus e iluminai nossa mente. <i>Ave Maria.</i></p>
            </div>`
      },
      {
        day: '2º Dia',
        title: 'A Purificação e a Busca pela Santidade',
        content: `<div class="day-specific-content">
                <h4>A Limpeza da Alma e o Exemplo de Maria</h4>
                <p>A Purificação de Maria nos convida a olhar para o nosso próprio interior. Se a Virgem Santíssima, a mais pura das criaturas, quis se submeter ao rito da purificação, quanto mais nós necessitamos purificar nossas almas do pecado e das imperfeições!</p>
                <p class="mt-4">A luz das Candeias deve iluminar os cantos escuros do nosso coração, revelando nossas fraquezas e nos movendo a buscar o sacramento da Reconciliação. Que a busca pela pureza de intenção, de pensamentos e de ações seja a nossa oferta a Deus neste dia.</p>
                <h4 class="mt-4">Oração para o Dia:</h4>
                <p>Doce Senhora da Candelária, purificai o nosso coração de todo apego ao pecado, de todo ressentimento e vaidade. Que o vosso olhar materno nos guie a uma sincera conversão, para que possamos nos apresentar dignamente diante de vosso Divino Filho. Amém.</p>
                <p class="mt-4 italic"><b>Jaculatória:</b> Das vossas divinas graças, nossas almas estão cheias, purificai o nosso coração, ó Mãe de Deus das Candeias. <i>Ave Maria.</i></p>
            </div>`
      },
      {
        day: '3º Dia',
        title: 'O Encontro no Templo e a Luz das Nações',
        content: `<div class="day-specific-content">
                <h4>Simeão Reconhece a Luz do Mundo</h4>
                <p>Ao entrarem no Templo, Maria e José levavam nos braços a Luz do Mundo. O ancião Simeão, homem justo e piedoso que esperava a consolação de Israel, foi movido pelo Espírito Santo a ir ao Templo. Ao ver o Menino Jesus, tomou-O em seus braços e bendisse a Deus, proclamando-O como a "Luz para iluminar as nações".</p>
                <p class="mt-4">A devoção a Nossa Senhora das Candeias nos recorda que Maria nos traz a verdadeira Luz, que dissipa as trevas da morte e do desespero. Deixemo-nos iluminar por Cristo e permitamos que Ele seja a única luz a guiar nossos passos.</p>
                <h4 class="mt-4">Oração para o Dia:</h4>
                <p>Ó Maria, que trouxestes em vossos braços a Luz do mundo, apresentai-nos também a Jesus. Que em meio às trevas das dificuldades do mundo, saibamos sempre fixar nossos olhos em Cristo, nossa Salvação e nossa Luz. Amém.</p>
                <p class="mt-4 italic"><b>Jaculatória:</b> Por vossos grandes milagres, rogamos Mãe de Jesus, que nos livreis do pecado e nos deis a vossa Luz. <i>Ave Maria.</i></p>
            </div>`
      },
      {
        day: '4º Dia',
        title: 'A Espada de Dor e a Força na Tribulação',
        content: `<div class="day-specific-content">
                <h4>A Profecia de Simeão a Maria</h4>
                <p>Logo após proclamar Jesus como a Luz do mundo, o profeta Simeão profetizou a Maria: "Uma espada transpassará a tua própria alma". Essa profecia revela que a missão de Maria está intimamente unida à Cruz de seu Filho. A luz que Maria carrega não apaga o sofrimento, mas dá sentido a ele.</p>
                <p class="mt-4">Nossa Senhora das Candeias é a mãe que permanece firme ao lado da Cruz, iluminando os nossos momentos de dor com a esperança da Ressurreição. Quando as cruzes da vida pesarem sobre nós, recorramos a ela para encontrar consolo e fortaleza.</p>
                <h4 class="mt-4">Oração para o Dia:</h4>
                <p>Mãe das Candeias, Senhora das Dores, que permanecestes firme ao pé da Cruz, dai-nos a força necessária para carregar as nossas cruzes diárias. Que a espada da dor não nos afaste da fé, mas nos aproxime do mistério do amor redentor de vosso Filho. Amém.</p>
                <p class="mt-4 italic"><b>Jaculatória:</b> Ó Virgem Mãe das Candeias, nas horas de provação, sede a luz que nos guia e nos dá consolação. <i>Ave Maria.</i></p>
            </div>`
      },
      {
        day: '5º Dia',
        title: 'O Testemunho e a Profecia de Ana',
        content: `<div class="day-specific-content">
                <h4>A Perseverança e o Louvor da Profetisa</h4>
                <p>No Templo estava também a profetisa Ana, uma viúva de oitenta e quatro anos que não se afastava do Templo, servindo a Deus dia e noite com jejuns e orações. Ao ver o Menino Jesus, ela começou a louvar a Deus e a falar d'Ele a todos os que esperavam a redenção de Jerusalém.</p>
                <p class="mt-4">O testemunho de Ana nos convida à perseverança na oração e ao anúncio corajoso do Evangelho. Nossa Senhora das Candeias nos ensina a sermos, como Ana, testemunhas fiéis da presença de Jesus em nosso meio, espalhando Sua luz através de nossas palavras e ações.</p>
                <h4 class="mt-4">Oração para o Dia:</h4>
                <p>Ó Senhora da Luz, ensinai-nos a perseverar na oração diária e na fidelidade à Igreja. Dai-nos um coração missionário para anunciar as maravilhas de vosso Filho àqueles que ainda caminham nas trevas da incredulidade e do abandono. Amém.</p>
                <p class="mt-4 italic"><b>Jaculatória:</b> Candeia acesa de amor, ó Mãe do bom Salvador, ajudai-nos a anunciar Jesus Cristo com fervor. <i>Ave Maria.</i></p>
            </div>`
      },
      {
        day: '6º Dia',
        title: 'A Aparição em Tenerife e as Velas da Fé',
        content: `<div class="day-specific-content">
                <h4>O Encontro da Virgem com os Povos</h4>
                <p>A história de Nossa Senhora das Candeias (Candelária) recorda sua aparição milagrosa a pastores guanches em Tenerife, nas Ilhas Canárias, no final do século XIV. Aqueles homens, que ainda não conheciam o Evangelho, encontraram a imagem esculpida na rocha e testemunharam velas sustentadas por anjos que iluminavam a gruta sagrada.</p>
                <p class="mt-4">Esse milagre nos ensina que a Virgem Maria vai ao encontro de todos os povos, mesmo os mais afastados, para levar-lhes a fé. As velas acesas em sua honra simbolizam a fé que nos foi transmitida e que devemos manter sempre acesa em nossas vidas, mesmo contra os ventos das provações.</p>
                <h4 class="mt-4">Oração para o Dia:</h4>
                <p>Ó Virgem da Candelária, que manifestastes vosso amor materno em terras distantes, abençoai a nossa pátria e as nossas famílias. Mantende sempre viva e brilhante em nossos corações a chama da fé católica, protegendo-nos do ceticismo e da frieza espiritual. Amém.</p>
                <p class="mt-4 italic"><b>Jaculatória:</b> Ó estrela das Canárias, que a todos povos atendeis, iluminai nossa vida com a luz que nos trazeis. <i>Ave Maria.</i></p>
            </div>`
      },
      {
        day: '7º Dia',
        title: 'A Procissão das Candeias e a Caminhada da Vida',
        content: `<div class="day-specific-content">
                <h4>Caminhar Sob a Luz de Cristo</h4>
                <p>Liturgicamente, a festa de 2 de fevereiro é celebrada com uma procissão solene de velas acesas. Caminhar com as velas acesas simboliza a nossa jornada terrestre guiada pela luz de Cristo. Somos peregrinos a caminho da Pátria Celeste e, nesta caminhada, enfrentamos a escuridão do mundo, os ventos das tentações e o cansaço do caminho.</p>
                <p class="mt-4">Nossa Senhora caminha conosco como a "Estrela do Mar" e a "Guia dos Navegantes", garantindo que a nossa luz não se apague e que cheguemos seguros ao porto da salvação.</p>
                <h4 class="mt-4">Oração para o Dia:</h4>
                <p>Estrela da Manhã, guia de nossa caminhada, não permitais que nos desviemos do caminho do Céu. Quando as tempestades da vida ameaçarem apagar a chama da nossa fé e da nossa caridade, protegei-nos sob o vosso manto e reacendei em nós o amor divino. Amém.</p>
                <p class="mt-4 italic"><b>Jaculatória:</b> Guia dos navegantes, estrela do mar profundo, iluminai nossa rota nas tempestades do mundo. <i>Ave Maria.</i></p>
            </div>`
      },
      {
        day: '8º Dia',
        title: 'A Proteção contra os Raios e Tempestades',
        content: `<div class="day-specific-content">
                <h4>O Amparo da Mãe nos Perigos e Tormentas</h4>
                <p>Tradicionalmente, os fiéis recorrem a Nossa Senhora das Candeias como protetora contra as tempestades, trovões, raios e flagelos da natureza. Em muitos lares cristãos, acende-se uma vela benta no dia da Candelária durante tempestades violentas, rezando com fé à Mãe de Deus.</p>
                <p class="mt-4">Essa devoção nos lembra que Maria também nos protege contra as tempestades espirituais: as tentações violentas, as crises de desespero, os conflitos familiares e as aflições do coração. Ela acalma o mar agitado de nossas almas e traz de volta a paz de Cristo.</p>
                <h4 class="mt-4">Oração para o Dia:</h4>
                <p>Protetora contra as tempestades, ó Mãe das Candeias, afastai de nossas casas e de nossas almas todos os perigos físicos e espirituais. Acalmai os ventos do ódio, da divisão e da discórdia, e reinai em nossos lares com a vossa doce paz. Amém.</p>
                <p class="mt-4 italic"><b>Jaculatória:</b> Das tormentas e dos raios, livrai-nos por vosso amor, ó Virgem das Candeias, doce Mãe do Redentor. <i>Ave Maria.</i></p>
            </div>`
      },
      {
        day: '9º Dia',
        title: 'Sede Luz no Mundo',
        content: `<div class="day-specific-content">
                <h4>O Chamado a Brilhar nas Trevas do Mundo</h4>
                <p>No último dia da nossa novena, contemplamos o nosso chamado como filhos de Nossa Senhora das Candeias. Jesus nos disse no Evangelho: "Vós sois a luz do mundo". Não podemos esconder essa luz sob a mesa, mas devemos colocá-la no candelabro para iluminar a todos.</p>
                <p class="mt-4">Ao final desta novena, consagremo-nos inteiramente a Nossa Senhora da Luz, pedindo que ela nos transforme em pequenas candeias vivas, levando a caridade aos necessitados, a esperança aos desanimados e a verdade aos que erram.</p>
                <h4 class="mt-4">Oração para o Dia:</h4>
                <p>Ó Maria Santíssima, Senhora das Candeias, ao encerrarmos esta novena, nós nos consagramos a vós. Que a nossa vida seja uma vela que se consome por amor a Deus e ao próximo. Ajudai-nos a brilhar nas trevas deste mundo até o dia em que nos alegraremos convosco na Luz Eterna do Céu. Amém.</p>
                <p class="mt-4 italic"><b>Jaculatória:</b> Ó Virgem das Candeias, nossa prece escutai, guiai-nos até a pátria que nos prometeu o Pai. <i>Ave Maria.</i></p>
            </div>`
      }
    ]
  },
  sao_bras: {
    ...
    image: 'https://i.postimg.cc/3wLskf4q/sao-bras.jpg',
    initialPrayer: `<div class="initial-prayer-text">
        <h4 class="section-title">Como rezar esta Novena</h4>
        <p>Inicia-se com o Sinal da Cruz: Em nome do Pai e do Filho e do Espírito Santo. Amém.</p>
  ...
  sao_luis_montfort: {
    ...
    initialPrayer: `<div class="prayer-block"><h4 class="section-title">Oração Inicial</h4><p><strong>Salve Maria!</strong></p><p>Pelo sinal da Santa Cruz, livrai-me Deus nosso Senhor, dos nossos inimigos. Em nome do Pai e do Filho e do Espírito Santo. Amém.</p><div class="mt-4 p-4 bg-primary/10 rounded-lg border-l-4 border-primary italic"><p><strong>Ato de Contrição</strong> (Refletir sobre seus pecados)</p><p>Senhor meu, Jesus Cristo, Deus e homem verdadeiro, Criador e Redentor meu, por serdes Vós quem sois, sumamente bom e digno de ser amado sobre todas as coisas, e porque Vos amo e estimo, pesa-me, Senhor, de todo o meu coração, de Vos ter ofendido; pesa-me, também, de ter perdido o Céu e merecido o Inferno; e proponho-me firmemente, ajudado com o auxílio da vossa divina graça, emendar-me e nunca mais Vos tornar a ofender. Espero alcançar o perdão de minhas culpas pela vossa infinita misericórdia. Amém.</p></div></div>`,
    finalPrayer: "",
    days: [
      {
        day: "Dia 1",
        title: "1º Dia - Um homem para nossos tempos",
        content: `<div class="day-specific-content"><h5 class="font-bold text-lg">Meditação:</h5><p>São Luís Maria foi um homem de convicção, homem de fé e compromisso. Fala sobre Deus porque antes tomou tempo para falar com Ele no recolhimento e no silêncio da vida interior. Um homem de profunda oração e um grande observador. Cheio de ousadia e entusiasmo, apaixonado por Jesus, por Maria e pela Cruz. Missionário fervoroso e zeloso, incansável na salvação das almas... Pobre e amante da santa pobreza de Cristo.</p><p class="mt-4">Que Ele nos conceda nesse primeiro dia de novena sua coragem e audácia. Hoje nos diz São Luís: <em>"Se não se arriscar algo por Deus, nada de grande se fará"</em>.</p><div class="mt-6 text-center font-semibold text-primary"><p>Pai Nosso, 3 Ave-Marias, Glória.</p></div><div class="mt-8 p-6 bg-stone-100/50 rounded-xl border border-stone-200"><h4 class="section-title text-center">Oração Final</h4><p>Ó meu Amado Jesus, olho nesse momento para Vós, e peço-Vos por intercessão de São Luís Maria Grignion de Montfort que foi digno ser exaltado como <strong>AMANTE DA SANTÍSSIMA VIRGEM MARIA</strong> a graça que necessito (peça aqui a graça). Desde já vos agradeço Senhor, pela vossa bondade em escutar a minha oração.</p><p class="mt-4 text-center font-bold">São Luís Maria Grignion de Montfort, rogai por nós!</p><p class="text-center text-sm opacity-70">Glória ao Pai e ao Filho e ao Espírito Santo. Como era no princípio, agora e sempre. Amém.</p></div></div>`
      },
      {
        day: "Dia 2",
        title: "2º Dia - Amante da Santíssima Virgem Maria",
        content: `<div class="day-specific-content"><h5 class="font-bold text-lg">Meditação:</h5><blockquote class="brand-border pl-4 italic my-4"><p>"Quando chegará, meu irmão, esse feliz tempo, esse século de Maria, em que muitas almas escolhidas e obtidas do Altíssimo por Maria, perdendo-se a si mesmas no abismo de seu interior, se transformem em cópias vivas da Santíssima Virgem para amar e glorificar a Jesus Cristo?! Esse tempo só chegará quando os corações conhecerem e viverem a devoção que eu ensino: 'Para que venha o Reino de Jesus, venha o Reino de Maria!!!' (T.V.D 217)"</p></blockquote><p>Peçamos à São Luís, nesse segundo dia de novena, a graça de um amor filial e verdadeiro à N.S.. <em>"Se queres ser um grande santo, seja um grande devoto da Santíssima Virgem Maria"</em>. (São Luís Maria)</p><div class="mt-6 text-center font-semibold text-primary"><p>Pai Nosso, 3 Ave-Marias, Glória.</p></div><div class="mt-8 p-6 bg-stone-100/50 rounded-xl border border-stone-200"><h4 class="section-title text-center">Oração Final</h4><p>Ó meu Amado Jesus, olho nesse momento para Vós, e peço-Vos por intercessão de São Luís Maria Grignion de Montfort que foi digno ser exaltado como <strong>AMANTE DA SANTÍSSIMA VIRGEM MARIA</strong> a graça que necessito (peça aqui a graça). Desde já vos agradeço Senhor, pela vossa bondade em escutar a minha oração.</p><p class="mt-4 text-center font-bold">São Luís Maria Grignion de Montfort, rogai por nós!</p><p class="text-center text-sm opacity-70">Glória ao Pai e ao Filho e ao Espírito Santo. Como era no princípio, agora e sempre. Amém.</p></div></div>`
      },
      {
        day: "Dia 3",
        title: "3º Dia - Perfeito escravo de amor",
        content: `<div class="day-specific-content"><h5 class="font-bold text-lg">Meditação:</h5><p>Nesses tempos modernos pode ser difícil falar de "escravidão de amor", porém, sabemos que existe "uma liberdade que escraviza e uma escravidão que liberta". Tal é a escravidão Mariana, que transforma nossas correntes não em um peso, mas em asas que nos fazem voar para Deus. Ela foi quem primeiramente se consagrou a Deus quando assim falou ao arcanjo Gabriel: "Eis aqui a serva do Senhor".</p><p class="mt-2">Escravo é aquele que está totalmente dedicado ao seu dono, de tal forma que ele não precisa dizer uma palavra, pois basta que o seu dono faça um sinal; e rapidamente executa a sua ordem. A vontade do escravo é a vontade do seu Senhor.</p><p class="mt-4 italic">Diz-nos São Luís: "Queres chegar a ser santo, muito santo? Não se preocupe demais com o que fazer ou o que não fazer, olha para Maria, torne-te seu escravo de Amor, abandonando-te como uma pequena criança em seu colo, que teus olhos não se afaste de Maria. Caminharás por um caminho seguro e logo chegarás à santidade!"</p><div class="mt-6 text-center font-semibold text-primary"><p>Pai Nosso, 3 Ave-Marias, Glória.</p></div><div class="mt-8 p-6 bg-stone-100/50 rounded-xl border border-stone-200"><h4 class="section-title text-center">Oração Final</h4><p>Ó meu Amado Jesus, olho nesse momento para Vós, e peço-Vos por intercessão de São Luís Maria Grignion de Montfort que foi digno ser exaltado como <strong>PERFEITO ESCRAVO DE AMOR</strong> a graça que necessito (peça aqui a graça). Desde já vos agradeço Senhor, pela vossa bondade em escutar a minha oração.</p><p class="mt-4 text-center font-bold">São Luís Maria Grignion de Montfort, rogai por nós!</p><p class="text-center text-sm opacity-70">Glória ao Pai e ao Filho e ao Espírito Santo. Como era no princípio, agora e sempre. Amém.</p></div></div>`
      },
      {
        day: "Dia 4",
        title: "4º Dia - Apaixonado da cruz",
        content: `<div class="day-specific-content"><h5 class="font-bold text-lg">Meditação:</h5><p>Apoiando-se naquela máxima de Jesus Cristo, de que para pertencer ao número de seus discípulos deve-se renunciar a si mesmo, carregar a sua cruz todos os dias e segui-Lo, São Luís procurava inspirar a todas as pessoas ao amor à cruz: enfermidades, injúrias, humilhações, desprezos.</p><blockquote class="brand-border pl-4 italic my-4"><p>"Um amigo da Cruz é um homem escolhido por Deus, entre dez mil, para ser unicamente um homem todo divino e elevado acima da razão, por uma vida e uma luz de pura fé e por um amor ardente pela Cruz. Pelo amor às humilhações, esmaga o orgulho de Satanás; pelo amor à pobreza, triunfa da avareza do mundo; pelo amor à dor, amortece a sensualidade da carne." (São Luís, carta aos amigos da Cruz)</p></blockquote><div class="mt-6 text-center font-semibold text-primary"><p>Pai Nosso, 3 Ave-Marias, Glória.</p></div><div class="mt-8 p-6 bg-stone-100/50 rounded-xl border border-stone-200"><h4 class="section-title text-center">Oração Final</h4><p>Ó meu Amado Jesus, olho nesse momento para Vós, e peço-Vos por intercessão de São Luís Maria Grignion de Montfort que foi digno ser exaltado como <strong>APAIXONADO DA CRUZ</strong> a graça que necessito (peça aqui a graça). Desde já vos agradeço Senhor, pela vossa bondade em escutar a minha oração.</p><p class="mt-4 text-center font-bold">São Luís Maria Grignion de Montfort, rogai por nós!</p><p class="text-center text-sm opacity-70">Glória ao Pai e ao Filho e ao Espírito Santo. Como era no princípio, agora e sempre. Amém.</p></div></div>`
      },
      {
        day: "Dia 5",
        title: "5º Dia - Modelo de sacerdote e amante da Eucaristia",
        content: `<div class="day-specific-content"><h5 class="font-bold text-lg">Meditação:</h5><p>No dia da sua ordenação sacerdotal, depois da cerimônia, passou o restante do dia diante do sacrário, um sacrário solitário e escondido. Desde a sua ordenação até a sua primeira Missa passou oito dias em retiro absoluto.</p><p class="mt-4 p-4 bg-stone-50 rounded italic text-center">"Assisti a sua primeira Missa, disse Blain, no altar parecia mais um anjo do que um homem".</p><div class="mt-6 text-center font-semibold text-primary"><p>Pai Nosso, 3 Ave-Marias, Glória.</p></div><div class="mt-8 p-6 bg-stone-100/50 rounded-xl border border-stone-200"><h4 class="section-title text-center">Oração Final</h4><p>Ó meu Amado Jesus, olho nesse momento para Vós, e peço-Vos por intercessão de São Luís Maria Grignion de Montfort que foi digno ser exaltado como <strong>MODELO DE SACERDOTE E AMANTE DA EUCARISTIA</strong> a graça que necessito (peça aqui a graça). Desde já vos agradeço Senhor, pela vossa bondade em escutar a minha oração.</p><p class="mt-4 text-center font-bold">São Luís Maria Grignion de Montfort, rogai por nós!</p><p class="text-center text-sm opacity-70">Glória ao Pai e ao Filho e ao Espírito Santo. Como era no princípio, agora e sempre. Amém.</p></div></div>`
      },
      {
        day: "Dia 6",
        title: "6º Dia - Incansável missionário",
        content: `<div class="day-specific-content"><h5 class="font-bold text-lg">Meditação:</h5><p>Era todo fogo na pregação!!! Onde Montfort chegava o pecado teria que sair correndo. Mas não era ele que conseguia as conversões, era a Virgem Maria a quem ele invocava constantemente. Ela rogava a Jesus e Jesus tocava os corações.</p><p class="mt-4">São Luís deixou escrito: <em>"Nasceu em mim uma grande confiança sem limites em Jesus e na sua Santíssima Mãe. Não tenho medo em ir nas fazendas, nos campos, nos jogos, nem nos lugares de perdições"</em>. Levava sempre consigo um crucifixo e uma imagem da Virgem Maria; Jesus e Maria se comportavam como os seus defensores!</p><div class="mt-6 text-center font-semibold text-primary"><p>Pai Nosso, 3 Ave-Marias, Glória.</p></div><div class="mt-8 p-6 bg-stone-100/50 rounded-xl border border-stone-200"><h4 class="section-title text-center">Oração Final</h4><p>Ó meu Amado Jesus, olho nesse momento para Vós, e peço-Vos por intercessão de São Luís Maria Grignion de Montfort que foi digno ser exaltado como <strong>INCANSÁVEL MISSIONÁRIO</strong> a graça que necessito (peça aqui a graça). Desde já vos agradeço Senhor, pela vossa bondade em escutar a minha oração.</p><p class="mt-4 text-center font-bold">São Luís Maria Grignion de Montfort, rogai por nós!</p><p class="text-center text-sm opacity-70">Glória ao Pai e ao Filho e ao Espírito Santo. Como era no princípio, agora e sempre. Amém.</p></div></div>`
      },
      {
        day: "Dia 7",
        title: "7º Dia - Homem de vida interior",
        content: `<div class="day-specific-content"><h5 class="font-bold text-lg">Meditação:</h5><p>São Luís passava horas e horas em oração, tinha uma fé viva. Em seu livro, "O Amor à Sabedoria Eterna", nos diz: <em>"devemos rezar com uma fé viva e perseverante, sem titubear, com uma Fé Pura, sem necessidade em consolações sensíveis, sem visões ou revelações privadas"</em>.</p><p class="mt-2">A oração é um diálogo com Deus, e o meio que São Luís nos dá é Maria Santíssima. Ela é o caminho fácil, curto, perfeito e seguro. É Nela que São Luís vivia uma contínua oração: <em>"Maria Santíssima é o Santuário onde encontramos o Divino Salvador"</em>.</p><p class="mt-4">Peçamos a São Luís, neste sétimo dia de novena, a graça de sermos almas de uma profunda vida interior.</p><div class="mt-6 text-center font-semibold text-primary"><p>Pai Nosso, 3 Ave-Marias, Glória.</p></div><div class="mt-8 p-6 bg-stone-100/50 rounded-xl border border-stone-200"><h4 class="section-title text-center">Oração Final</h4><p>Ó meu Amado Jesus, olho nesse momento para Vós, e peço-Vos por intercessão de São Luís Maria Grignion de Montfort que foi digno ser exaltado como <strong>HOMEM DE VIDA INTERIOR</strong> a graça que necessito (peça aqui a graça). Desde já vos agradeço Senhor, pela vossa bondade em escutar a minha oração.</p><p class="mt-4 text-center font-bold">São Luís Maria Grignion de Montfort, rogai por nós!</p><p class="text-center text-sm opacity-70">Glória ao Pai e ao Filho e ao Espírito Santo. Como era no princípio, agora e sempre. Amém.</p></div></div>`
      },
      {
        day: "Dia 8",
        title: "8º Dia - Devoto de Jesus e Maria",
        content: `<div class="day-specific-content"><h5 class="font-bold text-lg">Meditação:</h5><p>O maior mistério que se honra e se celebra na devoção da escravidão de amor é o Mistério da Encarnação. O mistério de Jesus Cristo presente no seio da Virgem Maria. Nele contemplamos a escravidão de Jesus em Maria, e pedimos a graça de viver como Jesus em Maria, segundo aquela bonita oração: <em>"Ó Jesus que viveis em Maria, vinde a viver em vossos servos"</em>.</p><p class="mt-2">Eles estão tão intimamente unidos, que um está totalmente unido ao outro. Jesus está todo em Maria, e Maria toda em Jesus; ou melhor, Ela não vive mais, é Jesus que vive nela. Antes separamos a luz do Sol do que Maria de Jesus.</p><div class="mt-6 text-center font-semibold text-primary"><p>Pai Nosso, 3 Ave-Marias, Glória.</p></div><div class="mt-8 p-6 bg-stone-100/50 rounded-xl border border-stone-200"><h4 class="section-title text-center">Oração Final</h4><p>Ó meu Amado Jesus, olho nesse momento para Vós, e peço-Vos por intercessão de São Luís Maria Grignion de Montfort que foi digno ser exaltado como <strong>DEVOTO DE JESUS E MARIA</strong> a graça que necessito (peça aqui a graça). Desde já vos agradeço Senhor, pela vossa bondade em escutar a minha oração.</p><p class="mt-4 text-center font-bold">São Luís Maria Grignion de Montfort, rogai por nós!</p><p class="text-center text-sm opacity-70">Glória ao Pai e ao Filho e ao Espírito Santo. Como era no princípio, agora e sempre. Amém.</p></div></div>`
      },
      {
        day: "Dia 9",
        title: "9º Dia - Homem de caridade ardente",
        content: `<div class="day-specific-content"><h5 class="font-bold text-lg">Meditação:</h5><p>Havia no coração do santo uma caridade ardente pelo próximo. Por isso Montfort amava ardentemente os pobres materialmente e espiritualmente. Dos primeiros estava sempre à disposição, fazia-se seu escravo e buscava ajudá-los como podia. Muitas vezes trocava suas roupas com os pobres, chegando um dia a ser confundido como mendigo.</p><p class="mt-4 text-center italic font-brand text-xl text-primary">O Reino de Jesus Cristo por Maria.</p><p class="mt-4">Fazê-la conhecida e amada, para fazer Jesus conhecido e amado. Conduzir as almas acorrentadas pelo amor aos pés de Maria, para que esta boa Mãe as conduza a seu Divino filho: é o belo programa que Montfort idealizou e ao qual consagrou sua existência.</p><div class="mt-6 text-center font-semibold text-primary"><p>Pai Nosso, 3 Ave-Marias, Glória.</p></div><div class="mt-8 p-6 bg-stone-100/50 rounded-xl border border-stone-200"><h4 class="section-title text-center">Oração Final</h4><p>Ó meu Amado Jesus, olho nesse momento para Vós, e peço-Vos por intercessão de São Luís Maria Grignion de Montfort que foi digno ser exaltado como <strong>HOMEM DE CARIDADE ARDENTE</strong> a graça que necessito (peça aqui a graça). Desde já vos agradeço Senhor, pela vossa bondade em escutar a minha oração.</p><p class="mt-4 text-center font-bold">São Luís Maria Grignion de Montfort, rogai por nós!</p><p class="text-center text-sm opacity-70">Glória ao Pai e ao Filho e ao Espírito Santo. Como era no princípio, agora e sempre. Amém.</p></div></div>`
      }
    ]
  },
};
...
novenaData.santa_teresinha = novenaData.teresinha;
novenaData.santos_anjos_guarda = novenaData.anjo_guarda;
...
export const saints: Saint[] = [
  ...
  { id: 'ns_candeias', name: 'N.S. das Candeias', imageUrl: 'https://i.postimg.cc/d1wh01Cn/ns-candeias.jpg', month: 'Janeiro/Fevereiro', startDate: '24/01', endDate: '01/02', feastDay: '02/Fev' },
  { id: 'sao_bras', name: 'São Brás', imageUrl: 'https://i.postimg.cc/3wLskf4q/sao-bras.jpg', month: 'Janeiro/Fevereiro', startDate: '25/01', endDate: '02/02', feastDay: '03/Fev', isMartyr: true },
  { id: 'santa_josefina_bakhita', name: 'Santa Josefina Bakhita', imageUrl: 'https://iili.io/f6UqHve.png', month: 'Janeiro/Fevereiro', startDate: '30/01', endDate: '07/02', feastDay: '08/Fev' },

  // Fevereiro
  { id: 'nossa_senhora_lourdes', name: 'N.S. de Lourdes', imageUrl: 'https://i.postimg.cc/RF4W0Ftw/ns-lourdes.jpg', month: 'Fevereiro', startDate: '02/02', endDate: '10/02', feastDay: '11/Fev' },
  ...
  { id: 'sao_casimiro', name: 'São Casimiro', imageUrl: 'https://i.postimg.cc/8zRMHqTg/sao-casimiro-alt.png', month: 'Fevereiro/Março', startDate: '24/02', endDate: '03/03', feastDay: '04/Mar' },
  { id: 'sao_gabriel_dores', name: 'São Gabriel das Dores', imageUrl: 'https://i.postimg.cc/qvV22kVL/sao-gabriel-dores.jpg', month: 'Fevereiro', startDate: '18/02', endDate: '26/02', feastDay: '27/Fev' },
  { id: 'sao_joao_de_deus', name: 'São João de Deus', imageUrl: 'https://i.postimg.cc/JzVjj1VN/sao-joao-de-deus.jpg', month: 'Fevereiro/Março', startDate: '27/02', endDate: '07/03', feastDay: '08/Mar' },

  // Março
  { id: 'sao_patricio', name: 'São Patrício', imageUrl: 'https://i.postimg.cc/jq1HdH8R/sao-patricio.png', month: 'Março', startDate: '08/03', endDate: '16/03', feastDay: '17/Mar' },
  ...
  { id: 'sao_bento_transito', name: 'São Bento (Trânsito)', imageUrl: 'https://i.postimg.cc/3JSmbgvb/sao-bento.png', month: 'Março', startDate: '12/03', endDate: '20/03', feastDay: '21/Mar' },
  { id: 'anunciacao', name: 'Anunciação', imageUrl: 'https://i.postimg.cc/KjsjQDHk/anunciacao.png', month: 'Março', startDate: '16/03', endDate: '24/03', feastDay: '25/Mar' },
  ...
  { id: 'santa_catarina_siena', name: 'Santa Catarina de Sena', imageUrl: 'https://i.pinimg.com/736x/fc/e8/7d/fce87d41f3daf1f431638303ccb0d14c.jpg', month: 'Abril', startDate: '20/04', endDate: '28/04', feastDay: '29/Abr' },
  ...
  // Maio
  { id: 'nossa_senhora_fatima', name: 'N.S. de Fátima', imageUrl: 'https://i.postimg.cc/cH0vJH31/ns-fatima.jpg', month: 'Maio', startDate: '04/05', endDate: '12/05', feastDay: '13/Mai', isImportant: true },
  ...
  // Junho
  { id: 'sagrado_coracao', name: 'Sagrado Coração', imageUrl: 'https://www.vaticannews.va/content/dam/vaticannews/multimedia/2024/ottobre/22/sacro-cuore2AEM.jpg/_jcr_content/renditions/cq5dam.thumbnail.cropped.750.422.jpeg', month: 'Junho', startDate: '03/06', endDate: '11/06', feastDay: '12/Jun' },
  { id: 'santo_onofre', name: 'Santo Onofre do Egito', imageUrl: 'https://ichef.bbci.co.uk/ace/ws/800/cpsprodpb/bd34/live/17a73f20-27e7-11ef-b0c1-85d9ceb9fef8.jpg.webp', month: 'Junho', startDate: '03/06', endDate: '11/06', feastDay: '12/Jun' },
  { id: 'imaculado_coracao', name: 'Imaculado Coração', imageUrl: 'https://img.cancaonova.com/cnimages/canais/uploads/sites/6/2023/06/formacao_imaculado-coracao-de-maria--768x432.jpg', month: 'Junho', startDate: '04/06', endDate: '12/06', feastDay: '13/Jun' },
  { id: 'sao_joao_batista', name: 'São João Batista', imageUrl: 'https://img.cancaonova.com/cnimages/canais/uploads/sites/2/2022/06/santododia-solenidade-do-nascimento-de-joao-batista-2-300x225.jpg', month: 'Junho', startDate: '14/06', endDate: '23/06', feastDay: '24/Jun', isImportant: true },
  { id: 'sao_josemaria_escriva', name: 'São Josemaria Escrivá', imageUrl: 'https://imgs.search.brave.com/pQJ3bX40nmh-Vf5ww0ZVAzn3JcfSlv2-qLrmV0Wq7uA/rs:fit:860:0:0:0/g:', month: 'Junho', startDate: '17/06', endDate: '25/06', feastDay: '26/Jun', isImportant: true },
  { id: 'nossa_senhora_perpetuo_socorro', name: 'N.S. Perpétuo Socorro', imageUrl: 'https://img.cancaonova.com/cnimages/canais/uploads/sites/6/2015/06/formacao_1600x1200-conheca-a-novena-a-nossa-senhora-do-perpetuo-socorro-768x576.jpg', month: 'Junho', startDate: '18/06', endDate: '26/06', feastDay: '27/Jun' },
  { id: 'sao_pedro_paulo', name: 'São Pedro e São Paulo', imageUrl: 'https://i.pinimg.com/736x/57/cc/70/57cc709acf0ab6b69ae01b230bb2c1e5.jpg', month: 'Junho', startDate: '20/06', endDate: '28/06', feastDay: '29/Jun', isImportant: true },
  ...
  { id: 'luis_zelia_martin', name: 'São Luís e Santa Zélia Martin', imageUrl: 'https://comshalom.org/wp-content/uploads/2020/07/louis-et-zlie-martin-dalenon-840x502.jpg', month: 'Julho', startDate: '03/07', endDate: '11/07', feastDay: '12/Jul' },
  ...
  { id: 'santa_ana_joaquim', name: 'Sant\'Ana e São Joaquim', imageUrl: 'https://i.pinimg.com/736x/1c/2d/3e/1c2d3e4f5a6b7c8d9e0f1a2b3c4d5e6f.jpg', month: 'Julho', startDate: '17/07', endDate: '25/07', feastDay: '26/Jul' },
  ...
  { id: 'santo_inacio_loyola', name: 'Santo Inácio de Loyola', imageUrl: 'https://i.pinimg.com/1200x/13/91/44/1391445cf63d436d020839707bfe6bbb.jpg', month: 'Julho', startDate: '22/07', endDate: '30/07', feastDay: '31/Jul' },
  { id: 'sao_joao_vianney', name: 'São João Vianney', imageUrl: 'https://img.cancaonova.com/cnimages/canais/uploads/sites/2/2022/08/S%C3%A3o-Jo%C3%A3o-Maria-Vianney-padroeiro-dos-sacerdotes-1-300x225.jpg', month: 'Julho/Agosto', startDate: '26/07', endDate: '03/08', feastDay: '04/Ago' },

  // Agosto
  { id: 'santo_afonso_ligorio', name: 'Santo Afonso Maria de Ligório', imageUrl: 'https://i.pinimg.com/736x/33/ed/95/33ed9547ad83c347108e5904154f27d5.jpg', imageObjectPosition: 'top', month: 'Julho/Agosto', startDate: '23/07', endDate: '31/07', feastDay: '01/Ago' },
  { id: 'santa_clara', name: 'Santa Clara de Assis', imageUrl: 'https://i.pinimg.com/1200x/d7/b0/23/d7b0236f1f90e81037fe208b1459b797.jpg', imageObjectPosition: 'top', month: 'Agosto', startDate: '02/08', endDate: '10/08', feastDay: '11/Ago' },
  { id: 'santa_filomena', name: 'Santa Filomena', imageUrl: 'https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjuLi6GT6v9yke7mPy5LxdsSRrK0d54SrfOve_Ij9Nk575fvhtkZUAZhLlJ2b490Amg-VXICRo6xkJGbAyHtHHa3jvKvbiJdMUQiNvdUYFotoaOIDKLlu-K3yKbdb-P41fAPGOmBW0tnXY/s1600/Santa+Filomena,+Virgem+e+M%C3%A1rtir+(1).jpg', month: 'Agosto', startDate: '01/08', endDate: '09/08', feastDay: '10/Ago', isMartyr: true },
  { id: 'santa_dulce_pobres', name: 'Santa Dulce dos Pobres', imageUrl: 'https://img.cancaonova.com/cnimages/canais/uploads/sites/6/2023/07/formacao_reze-a-novena-a-santa-dulce-dos-pobres-1-768x432.jpg', imageObjectPosition: 'top', month: 'Agosto', startDate: '04/08', endDate: '12/08', feastDay: '13/Ago' },
  { id: 'sao_maximiliano_kolbe', name: 'São Maximiliano Kolbe', imageUrl: 'https://bibliotecacatolica.com.br/wp-content/uploads/2024/08/Sao-Maximiliano-Maria-Kolbe-4-654x1024.jpg', imageObjectPosition: 'top', month: 'Agosto', startDate: '05/08', endDate: '13/08', feastDay: '14/Ago', isMartyr: true },
  { id: 'assuncao_nossa_senhora', name: 'Assunção de N.S.', imageUrl: 'https://i.pinimg.com/736x/68/ae/53/68ae533a2ee7848b55ad14301a45bb72.jpg', imageObjectPosition: 'top', month: 'Agosto', startDate: '07/08', endDate: '15/08', feastDay: '16/Ago' },
  { id: 'quaresma_sao_miguel', name: 'Quaresma S. Miguel Arcanjo', imageUrl: 'https://r2.padrepauloricardo.org/a5ymh72r8njhd15g6mxf18mjx5s7', month: 'Agosto/Setembro', startDate: '15/08', endDate: '29/09', feastDay: '29/Set' },
  { id: 'santa_monica', name: 'Santa Mônica', imageUrl: 'https://img.cancaonova.com/cnimages/canais/uploads/sites/2/2022/08/Santa-M%C3%B4nica-2-300x225.jpg', month: 'Agosto', startDate: '18/08', endDate: '26/08', feastDay: '27/Ago' },
  { id: 'santo_agostinho', name: 'Santo Agostinho Bispo', imageUrl: 'https://i.pinimg.com/736x/1a/32/7c/1a327cf0340885bef002e94d4b8c5704.jpg', month: 'Agosto', startDate: '19/08', endDate: '27/08', feastDay: '28/Ago' },

  // Setembro
  { id: 'natividade_nossa_senhora', name: 'Natividade N.S.', imageUrl: 'https://i.postimg.cc/xdrkWgTH/ns-natividade.jpg', month: 'Agosto/Setembro', startDate: '30/08', endDate: '07/09', feastDay: '08/Set' },
  { id: 'exaltacao_santa_cruz', name: 'Exaltação Santa Cruz', imageUrl: 'https://r2.padrepauloricardo.org/nof4tf5546glvqmyt87zehnvqere', month: 'Setembro', startDate: '05/09', endDate: '13/09', feastDay: '14/Set' },
  { id: 'nossa_senhora_dores', name: 'N.S. das Dores', imageUrl: 'https://i.postimg.cc/mkrhQ58s/ns-dores-setembro.jpg', month: 'Setembro', startDate: '06/09', endDate: '14/09', feastDay: '15/Set' },
  { id: 'sao_pio_pietrelcina', name: 'São Pio de Pietrelcina', imageUrl: 'https://img.cancaonova.com/cnimages/canais/uploads/sites/2/2022/09/23-S%C3%A3o-Pio-de-Pietrelcina-2.jpg', month: 'Setembro', startDate: '14/09', endDate: '22/09', feastDay: '23/Set' },
  { id: 'sao_cosme_damiao', name: 'São Cosme e Damião', imageUrl: 'https://cleofas.com.br/wp-content/uploads/2017/09/cosme-damiao.jpg', month: 'Setembro', startDate: '17/09', endDate: '25/09', feastDay: '26/Set' },
  { id: 'sao_miguel_arcanjo', name: 'São Miguel Arcanjo', imageUrl: 'https://r2.padrepauloricardo.org/a5ymh72r8njhd15g6mxf18mjx5s7', month: 'Setembro', startDate: '20/09', endDate: '28/09', feastDay: '29/Set' },
  ...
  { id: 'anjo_guarda', name: 'Anjo da Guarda', imageUrl: 'https://i.postimg.cc/251LGdkn/image.png', month: 'Setembro/Outubro', startDate: '23/09', endDate: '01/10', feastDay: '02/Out' },
  { id: 'sao_francisco_assis', name: 'São Francisco de Assis', imageUrl: 'https://i.postimg.cc/fVs0LZz6/sao-francisco-assis.jpg', month: 'Setembro/Outubro', startDate: '25/09', endDate: '03/10', feastDay: '04/Out' },
  { id: 'faustina', name: 'Santa Faustina Kowalska', imageUrl: 'https://i.postimg.cc/qBKkbHTj/39a80df1d720976f7e55e00f40eadc90-1.jpg', month: 'Setembro/Outubro', startDate: '26/09', endDate: '04/10', feastDay: '05/Out' },
  { id: 'rosario', name: 'N.S. do Rosário', imageUrl: 'https://i.postimg.cc/2669v1gr/nsr.jpg', month: 'Setembro/Outubro', startDate: '28/09', endDate: '06/10', feastDay: '07/Out' },
  { id: 'john_henry_newman', name: 'São John Henry Newman', imageUrl: 'https://i.postimg.cc/9fCw5mrL/Photo-of-John-Henry-Newman.jpg', month: 'Setembro/Outubro', startDate: '30/09', endDate: '08/10', feastDay: '09/Out' },

  // Outubro
  { id: 'joao_xxiii', name: 'São João XXIII', imageUrl: 'https://i.postimg.cc/d1zCLzsw/Ioannes-XXIII-by-De-Agostini-1958-1963.jpg', month: 'Outubro', startDate: '02/10', endDate: '10/10', feastDay: '11/Out' },
  ...
  { id: 'carlo_acutis', name: 'São Carlo Acutis', imageUrl: 'https://i.postimg.cc/CKrbWHjb/8a6ca2d967cbe5b8b65b068da82f495e.jpg', month: 'Outubro', startDate: '03/10', endDate: '11/10', feastDay: '12/Out' },
  { id: 'teresa_avila', name: 'Santa Teresa de Ávila', imageUrl: 'https://i.postimg.cc/ht19wsyQ/32654687eb30f846f1f2e9e3edb6f4af.jpg', month: 'Outubro', startDate: '06/10', endDate: '14/10', feastDay: '15/Out' },
  { id: 'edwiges', name: 'Santa Edwiges', imageUrl: 'https://i.postimg.cc/pTPYrzkQ/formacao-1600x1200-novena-sta-edwigens.jpg', month: 'Outubro', startDate: '07/10', endDate: '15/10', feastDay: '16/Out' },
  { id: 'margarida_alacoque', name: 'Santa Margarida Maria Alacoque', imageUrl: 'https://i.postimg.cc/J7QHR03S/66339fa28370276f90d041991767bebd.jpg', month: 'Outubro', startDate: '07/10', endDate: '15/10', feastDay: '16/Out' },
  { id: 'inacio_antioquia', name: 'São Inácio de Antioquia', imageUrl: 'https://i.postimg.cc/cvWXNVVK/image.png', month: 'Outubro', startDate: '08/10', endDate: '16/10', feastDay: '17/Out', isMartyr: true },
  { id: 'lucas', name: 'São Lucas Evangelista', imageUrl: 'https://i.postimg.cc/LXry2CGX/image.png', month: 'Outubro', startDate: '09/10', endDate: '17/10', feastDay: '18/Out', isMartyr: true },
  { id: 'pedro_alcantara', name: 'São Pedro de Alcântara', imageUrl: 'https://i.postimg.cc/LnDZnwJ2/image.png', month: 'Outubro', startDate: '10/10', endDate: '18/10', feastDay: '19/Out' },
  { id: 'jp2', name: 'São João Paulo II', imageUrl: 'https://i.postimg.cc/bsw1Hqcq/image.png', month: 'Outubro', startDate: '13/10', endDate: '21/10', feastDay: '22/Out' },
  { id: 'frei_galvao', name: 'São Frei Galvão', imageUrl: 'https://i.postimg.cc/sBYBCLdn/image.png', month: 'Outubro', startDate: '16/10', endDate: '24/10', feastDay: '25/Out' },
  { id: 'judas_tadeu', name: 'São Judas Tadeu', imageUrl: 'https://i.postimg.cc/9wrF08KF/image.png', month: 'Outubro', startDate: '19/10', endDate: '27/10', feastDay: '28/Out', isMartyr: true },
  ...
  { id: 'todos_santos', name: 'Todos os Santos', imageUrl: 'https://i.postimg.cc/j29jkK7b/download.jpg', month: 'Outubro/Novembro', startDate: '23/10', endDate: '31/10', feastDay: '01/Nov' },

  // Novembro
  { id: 'almas', name: 'Almas', imageUrl: 'https://i.postimg.cc/G2DDG2TC/dfed164f02d4d4d2bccaa939385df13b.jpg', month: 'Outubro/Novembro', startDate: '24/10', endDate: '01/11', feastDay: '02/Nov' },
  { id: 'isabel_hungria', name: 'Santa Isabel da Hungria', imageUrl: 'https://iili.io/KpAYfLl.jpg', month: 'Novembro', startDate: '08/11', endDate: '16/11', feastDay: '17/Nov' },
  ...
  { id: 'santa_cecilia', name: 'Santa Cecília', imageUrl: 'https://i.postimg.cc/4xDNjn2c/image.png', month: 'Novembro', startDate: '13/11', endDate: '21/11', feastDay: '22/Nov', isMartyr: true },
  ...
  { id: 'joao_cruz', name: 'São João da Cruz', imageUrl: 'https://iili.io/ffgFMWN.jpg', month: 'Dezembro', startDate: '05/12', endDate: '13/12', feastDay: '14/Dez' },
  ...
  { id: 'maria_mae_deus', name: 'Santa Maria Mãe de Deus', imageUrl: 'https://i.postimg.cc/5jcQ5mG4/santa-maria-mae-de-deus.jpg', month: 'Dezembro/Janeiro', startDate: '23/12', endDate: '31/12', feastDay: '01/Jan' },
...
export const saintsOfTheDay: SaintOfTheDayData[] = [
  {
    ...
    saints: [{
      ...
      imageUrl: 'https://i.postimg.cc/5jcQ5mG4/santa-maria-mae-de-deus.jpg',
...
<p class="mt-2 italic text-center">Que o Santíssimo Nome de Jesus seja sempre bendito, louvado e glorificado! ✝️</p>`
  ...
  },
  {
    ...
    saints: [{
      ...
      imageUrl: 'https://i.postimg.cc/9fx6DgRy/sao-goncalo-amarante.png',
  ...
  },
  {
    ...
    saints: [{
      ...
      imageUrl: 'https://i.postimg.cc/FKstsXRf/sao-vital-gaza.jpg',
  ...
  },
  {
    ...
    saints: [{
      ...
      imageUrl: 'https://i.postimg.cc/C1X9NZ45/santo-elredo-rievaulx.png',
  ...
  },
  {
    ...
    saints: [{
      ...
      imageUrl: 'https://i.postimg.cc/G2V6QBjR/santo-hilario-poitiers.jpg',
    ...
    saints: [
      {
        ...
        imageUrl: 'https://i.postimg.cc/k5j02Y6S/sao-felix-nola.png',
  ...
  },
  {
    ...
    saints: [{
      name: 'Santo Amaro',
      imageUrl: 'https://i.postimg.cc/G2V6QBjP/santo-amaro.png',
  ...
  },
  {
    ...
    saints: [{
      name: 'São Marcelo I',
      imageUrl: 'https://i.postimg.cc/k5XrXP48/sao-marcelo-i.png',
  ...
  },
  {
    ...
    saints: [{
      name: 'Santo Antão',
      imageUrl: 'https://i.postimg.cc/pT43Z9B2/santo-antao.png',
  ...
  },
  {
    ...
    saints: [{
      ...
      imageUrl: 'https://i.postimg.cc/prj4120q/santa-margarida-hungria.png',
  ...
  },
  {
    ...
    saints: [{
      name: 'São Vulstano',
      imageUrl: 'https://i.postimg.cc/J79W3FTP/sao-vulstano.png',
  ...
  },
  {
    ...
    saints: [{
      name: 'Santa Inês',
      imageUrl: 'https://i.postimg.cc/qqKSZkmm/santa-ines.png',
    ...
    saints: [
      {
        ...
        imageUrl: 'https://i.postimg.cc/8Cy27XJB/sao-vicente-saragoca.jpg',
      ...
      {
        name: 'Santa Blesila',
        imageUrl: 'https://i.postimg.cc/nV9yLkHc/santa-blesila.jpg',
  ...
  },
  {
    ...
    saints: [{
      ...
      imageUrl: 'https://i.postimg.cc/j2fmks8B/santa-emerenciana.png',
  ...
  },
  {
    ...
    saints: [{
      ...
      imageUrl: 'https://i.postimg.cc/J4w9HknF/conversao-sao-paulo.jpg',
    ...
    saints: [
      {
        ...
        imageUrl: 'https://i.postimg.cc/C58X6Fvf/santa-paula-roma.jpg',
      ...
      },
      {
        ...
        imageUrl: 'https://i.postimg.cc/bJW4TGRZ/santos-cister.jpg',
  ...
  },
  {
    ...
    saints: [{
      ...
      imageUrl: 'https://i.postimg.cc/tRnKg5Xz/santa-angela-merici.jpg',
  ...
  },
  {
    ...
    saints: [{
      ...
      imageUrl: 'https://i.postimg.cc/nzgNks14/santo-andrei-rublev.jpg',
  ...
  },
  {
    ...
    saints: [{
      name: 'Santa Martina',
      imageUrl: 'https://i.postimg.cc/NFXSPgNx/santa-martina.jpg',
  ...
  },
  {
    ...
    saints: [
      ...
      },
      {
        ...
        imageUrl: 'https://i.postimg.cc/bNssr4Zb/ns-soufanieh.jpg',
...
export const saintsOfTheDayDecember: SaintOfTheDayData[] = [
  { day: 1, month: 'Dezembro', saints: [{ name: 'Santo Elói (ou Elígio)', imageUrl: 'https://i.postimg.cc/pVkFpDq8/santo-eloi.jpg', story: '<p>Patrono dos ourives e ferreiros.</p>' }] },
  { day: 2, month: 'Dezembro', saints: [{ name: 'Santa Bibiana', imageUrl: 'https://i.postimg.cc/5twH1vXt/santa-bibiana.jpg', story: '<p>Mártir e virgem.</p>', isMartyr: true }] },
  {
    day: 3,
    month: 'Dezembro',
    saints: [{
      name: 'São Francisco Xavier',
      imageUrl: 'https://i.postimg.cc/ydsDNdRR/sao-francisco-xavier.jpg',
  ...
  },
  {
    ...
    saints: [{
      name: 'Santa Bárbara',
      imageUrl: 'https://i.postimg.cc/LXp1ZDc5/santa-barbara.jpg',
  ...
  },
  {
    ...
    saints: [{
      name: 'São Sabas',
      imageUrl: 'https://i.postimg.cc/x8F8g34T/sao-sabas.jpg',
  ...
  },
  {
    ...
    saints: [{
      ...
      imageUrl: 'https://i.postimg.cc/vBb4mBnv/sao-nicolau.jpg',
  ...
  },
  {
    ...
    saints: [{
      name: 'Santo Ambrósio',
      imageUrl: 'https://i.postimg.cc/vTmDWNXj/santo-ambrosio.jpg',
  ...
  },
  {
    ...
    },
    {
      ...
      story: `<h4>A Virgem de Caacupé</h4><p>N.S. dos Milagres de Caacupé é a padroeira incontestável e a mais amada devoção do Paraguai. A história da milagrosa imagem remonta ao final do século XVI, quando o índio guarani José, buscando fugir de guerreiros de uma tribo feroz, abrigou-se atrás de um grosso tronco de árvore. Ao ver-se salvo pela proteção intercessora da Virgem, prometeu esculpir uma imagem com aquela mesma madeira, dando início à veneração de "Caacupé" (que do guarani significa "atrás do mato").</p><p class="mt-4">Reconhecida pelos Papas e anualmente visitada por milhões de peregrinos em exaustivas caminhadas de gratidão e súplica que culminam todo dia 8 de dezembro, a Virgem Azul de Caacupé simboliza o amparo irrefutável, a cura de todas as dores e a proteção às famílias.</p><p class="mt-4"><b>Oração:</b> Senhora dos Milagres de Caacupé, que protegestes com o teu santo manto protetor o mais humilde de teus filhos, ajudai-nos também nas tempestades da vida. Guardai-nos do mal e dai-nos aquela graça tão desejada que hoje confiamos à vossa infinita compaixão. Amém.</p>`
    }]
  },
  {
    day: 9,
  ...
  },
  {
    ...
    saints: [{
      name: 'N.S. de Loreto',
      imageUrl: 'https://i.postimg.cc/J7Ts1Rzr/ns-loreto-1.png',
      story: `<h4>A Casa que Voou - O Mistério de Loreto</h4><p>A devoção a N.S. de Loreto é uma das mais fascinantes e antigas da cristandade, centrada no milagre da "Santa Casa" de Nazaré. Loreto, na Itália, é o local onde, segundo a tradição, encontra-se a autêntica casa de pedra onde a Virgem Maria nasceu, recebeu a Anunciação do Arcanjo Gabriel e onde a Sagrada Família viveu em Nazaré.</p><h4>O Transporte pelos Anjos</h4><p>A tradição conta que, em 1291, quando os cristãos estavam sendo expulsos da Terra Santa pelos sarracenos, a Santa Casa correu o risco de ser destruída. Milagrosamente, ela foi elevada da terra por anjos e transportada pelos ares, primeiro para a Dalmácia (atual Croácia) e, finalmente, em 1294, para um bosque de loureiros (lauretum, daí "Loreto") na costa adriática da Itália. Estudos arqueológicos e científicos modernos feitos nas pedras e na argamassa da casa confirmaram que elas são típicas da região de Nazaré e totalmente estranhas à geologia da Itália.</p><h4>Padroeira dos Aviadores</h4><p>Devido a este "voo" milagroso através dos mares, o Papa Bento XV declarou N.S. de Loreto a padroeira oficial de todos os aviadores e viajantes aéreos em 1920. É comum ver sua imagem ou medalhas em cabines de comando de aviões e em aeroportos por todo o mundo, pedindo proteção para os que cruzam os céus.</p><h4>A Basílica e o Ângelus de Loreto</h4><p>Em volta da pequena e humilde casa de tijolos, foi construída uma imponente basílica renascentista que é hoje um dos maiores santuários da Europa. Dentro da Santa Casa, a oração do Ângelus é feita de forma única: em vez de dizer "O Verbo se fez carne e habitou entre nós", os fiéis dizem "O Verbo se fez carne e habitou AQUI" (Hic Verbum Caro Factum Est), recordando que foi exatamente entre aquelas paredes que o mistério da Encarnação aconteceu.</p><h4>Mensagem Espiritual</h4><p>Loreto nos recorda a santidade da vida familiar e a humildade da casa de Maria. É o lugar onde o divino e o humano se encontraram de forma definitiva. Maria, em Loreto, convida-nos a fazer de nossos próprios corações uma "santa casa" onde Deus possa habitar. Ela é a protetora das viagens, sejam elas físicas nos céus ou a jornada espiritual da nossa vida rumo ao porto seguro do Céu.</p><p class="mt-4"><b>Oração:</b> Ó Deus, que confiastes à proteção dos anjos a Santa Casa da Mãe do vosso Filho, concedei-nos, por intercessão de N.S. de Loreto, que sejamos protegidos em nossos caminhos e voos, e cheguemos seguros à morada eterna. Amém.</p><p class="mt-2 italic">N.S. de Loreto, rogai por nós.</p>`
    }]
  },
  {
    day: 11,
    ...
    saints: [{
      name: 'São Dâmaso I',
      imageUrl: 'https://i.postimg.cc/7hLbgWm6/sao-damaso.jpg',
  ...
  },
  {
    ...
    saints: [{
      ...
      <p class="mt-4"><b>Oração:</b> Ó Deus, Pai de misericórdia, que colocastes o vosso povo sob a especial proteção da Sempre Virgem Maria de Guadalupe, concedei a todos os vossos filhos a graça de se unirem na fé e na caridade, e de serem protegidos por seu manto maternal.</p><p class="mt-2 italic">N.S. de Guadalupe, rogai por nós.</p>`
    }]
  },
  {
    day: 13,
  ...
  },
  {
    ...
    saints: [{
      ...
      imageUrl: 'https://i.postimg.cc/qq7g85jg/sao-valeriano.jpg',
  ...
  },
  {
    ...
    month: 'Dezembro',
    saints: [{
      name: 'N.S. do Bom Parto',
      imageUrl: 'https://i.pinimg.com/1200x/cc/80/b9/cc80b9f6815e1ec29ad8815d63103fbb.jpg',
      story: `<h4>A Esperança das Mães</h4><p>A devoção a N.S. do Bom Parto é muito antiga e querida pelas gestantes. Invoca-se a Virgem Maria, que deu à luz o Salvador, para que proteja as mães e seus filhos no momento do nascimento, concedendo um parto feliz e seguro. É um título que celebra a maternidade divina e a proteção de Maria sobre toda vida nascente.</p><p class="mt-4"><b>Oração:</b> Ó Maria, Virgem Mãe, que no parto de Jesus sentistes as alegrias da maternidade divina, olhai com bondade para todas as gestantes e concedei-lhes um bom parto e filhos saudáveis para a glória de Deus.</p><p class="mt-2 italic">N.S. do Bom Parto, rogai por nós.</p>`
    }]
  },
  {
    day: 19,
...
// Complete February with all days (6-28) - Days 1-5 are in santosMarcoSetembro
const saintsOfTheDayFevereiroExtra: SaintOfTheDayData[] = [
  { day: 6, month: 'Fevereiro', saints: [{ name: 'São Paulo Miki e Companheiros', imageUrl: 'https://i.postimg.cc/DwG0dsdS/sao-paulo-miki.png', story: '<h4>Mártires do Japão - 26 Crucificados de Nagasaki</h4><p>São Paulo Miki nasceu em 1564 no Japão, filho de uma família samurai convertida ao cristianismo. Aos cinco anos, foi confiado aos jesuítas e educado em seus colégios. Tornou-se catequista e depois ingressou na Companhia de Jesus. Era um pregador eloquente que converteu muitos japoneses ao cristianismo.</p><p class="mt-4">Em 1587, o xogum Toyotomi Hideyoshi, temendo a influência europeia, proibiu o cristianismo. Em 1596, intensificou a perseguição. Paulo Miki foi preso junto com outros 25 cristãos: 6 missionários franciscanos (incluindo São Pedro Batista), 3 jesuítas japoneses e 17 leigos japoneses, entre eles três jovens coriças de 12, 13 e 14 anos.</p><p class="mt-4">Foram obrigados a caminhar 800 km de Kyoto a Nagasaki no inverno rigoroso, com parte das orelhas cortadas, sendo exibidos em várias cidades como exemplo. Em 5 de fevereiro de 1597, chegaram a Nagasaki. No dia 6, foram crucificados em uma colina (hoje chamada "Colina dos Mártires"). Diferentemente da crucificação romana, foram amarrados e pregados às cruzes que depois foram erguidas, e lanças atravessaram seus corpos.</p><p class="mt-4">Paulo Miki, pregado à cruz, pregou seu último sermão à multidão: "Declaro-vos que não há outro caminho de salvação senão o que seguem os cristãos. Perdoo de coração ao rei e a todos os responsáveis por minha morte, e peço-lhes que aceitem o batismo cristão." Foram os primeiros mártires do Japão canonizados (1862). São padroeiros do Japão.</p><p class="mt-4"><b>Oração:</b> São Paulo Miki e companheiros mártires, que derramastes vosso sangue pela fé em Cristo na terra do sol nascente, intercedei pela evangelização do Japão e de toda a Ásia. Dai-nos coragem para testemunhar Cristo mesmo diante da perseguição. Amém.</p><p class="mt-2 italic">São Paulo Miki e companheiros, rogai por nós.</p>', isMartyr: true }] },
  { day: 7, month: 'Fevereiro', saints: [{ name: 'Beato Pio IX', imageUrl: 'https://i.postimg.cc/Yqw1WrwV/beato-pio-ix.png', story: '<h4>Papa do Mais Longo Pontificado</h4><p>Giovanni Maria Mastai-Ferretti nasceu em 1792 em Senigallia, Itália. Ordenado sacerdote em 1819, foi nomeado bispo em 1827 e cardeal em 1840. Foi eleito Papa em 1846, adotando o nome Pio IX. Seu pontificado durou 31 anos e 8 meses (1846-1878), o mais longo da história depois de São Pedro.</p><p class="mt-4">Inicialmente visto como liberal, enfrentou a unificação italiana que resultou na perda dos Estados Pontifícios em 1870, tornando-se "prisioneiro do Vaticano". Em 8 de dezembro de 1854, proclamou solenemente o dogma da Imaculada Conceição de Maria, definindo que a Virgem Maria foi concebida sem pecado original. Quatro anos depois, N.S. confirmou este dogma em Lourdes, dizendo a Bernadette: "Eu sou a Imaculada Conceição".</p><p class="mt-4">Em 1864, publicou o "Syllabus" condenando os erros modernos. Convocou o Concílio Vaticano I (1869-1870), que definiu o dogma da infalibilidade papal. Promoveu a devoção ao Sagrado Coração de Jesus, proclamou São José padroeiro da Igreja Universal (1870) e expandiu as missões católicas pelo mundo.</p><p class="mt-4">Apesar das dificuldades políticas, foi um papa profundamente espiritual e mariano. Faleceu em 7 de fevereiro de 1878. Foi beatificado por São João Paulo II em 2000, junto com João XXIII.</p><p class="mt-4"><b>Oração:</b> Beato Pio IX, que defendestes a fé católica em tempos difíceis e proclamastes a Imaculada Conceição de Maria, intercedei pela Igreja e pelos Papas. Ensinai-nos a permanecer fiéis à doutrina de Cristo mesmo diante das pressões do mundo. Amém.</p><p class="mt-2 italic">Beato Pio IX, rogai por nós.</p>' }] },
  { day: 8, month: 'Fevereiro', saints: [{ name: 'Santa Josefina Bakhita', imageUrl: 'https://iili.io/f6UqHve.png', story: '<h4>Da Escravidão à Santidade - Padroeira do Sudão</h4><p>Josefina Bakhita nasceu em 1869 em Darfur, Sudão. Aos 7 anos, foi raptada por traficantes de escravos que a separaram de sua família. Foi vendida e revendida várias vezes, sofrendo torturas terríveis. Um de seus "donos" mandou marcar seu corpo com 114 cicatrizes usando lâminas e sal. Ela nem lembrava seu nome verdadeiro; "Bakhita" (sortuda) foi o apelido dado pelos escravizadores.</p><p class="mt-4">Em 1883, foi comprada por um cônsul italiano, Callisto Legnani, que a tratou com bondade. Quando ele retornou à Itália em 1885, levou Bakhita consigo. Lá, ela foi confiada a uma família amiga e conheceu as Irmãs Canossianas. Pela primeira vez, ouviu falar de Deus que a amava. Exclamou: "Vendo o sol, a lua e as estrelas, eu dizia: quem será o dono de todas estas coisas belas? E sentia uma grande vontade de vê-Lo, conhecê-Lo e prestá-Lo homenagem."</p><p class="mt-4">Foi batizada em 9 de janeiro de 1890, recebendo o nome de Josefina Margarida Fortunata. Quando sua "dona" quis levá-la de volta ao Sudão, Bakhita recusou-se. Um tribunal italiano declarou que, como a escravidão era ilegal na Itália, ela era livre. Em 1896, tornou-se religiosa canossiana. Viveu 50 anos como religiosa, servindo como porteira e cozinheira, sempre com um sorriso radiante.</p><p class="mt-4">Dizia: "Se eu encontrasse os escravizadores que me raptaram e torturaram, ajoelhar-me-ia para beijar suas mãos, porque, se não tivesse acontecido isso, não seria cristã e religiosa." Faleceu em 8 de fevereiro de 1947. Foi canonizada por São João Paulo II em 2000. É padroeira do Sudão e das vítimas do tráfico humano.</p><p class="mt-4"><b>Oração:</b> Santa Josefina Bakhita, que do sofrimento da escravidão chegastes à liberdade dos filhos de Deus, intercedei por todas as vítimas do tráfico humano e da escravidão moderna. Ensinai-nos o perdão e a gratidão. Protegei o povo do Sudão e de toda a África. Amém.</p><p class="mt-2 italic">Santa Josefina Bakhita, rogai por nós.</p>' }] },
  { day: 9, month: 'Fevereiro', saints: [{ name: 'Santa Apolônia', imageUrl: 'https://i.postimg.cc/Vv0bbh7w/santa-apolonia.png', story: '<h4>Virgem e Mártir - Padroeira dos Dentistas</h4><p>Santa Apolônia foi uma diáconisa cristã que viveu em Alexandria, Egito, no século III. Durante uma revolta anticristã instigada por um poeta pagão, foi capturada por uma multidão furiosa junto com outros cristãos. Já idosa, foi brutalmente torturada.</p><p class="mt-4">Os perseguidores arrancaram todos os seus dentes com tenazes e quebraram sua mandíbula. Ameaçaram queimar-lhe viva se não renunciasse à fé cristã. Apolônia pediu um momento para "considerar" a proposta. Quando a soltaram, surpreendeu a todos lançando-se voluntariamente nas chamas, preferindo morrer a negar Cristo. Seu martírio ocorreu por volta do ano 249, durante a perseguição do imperador Décio.</p><p class="mt-4">Tornou-se padroeira dos dentistas, higienistas dentais e de todos que sofrem de dores de dente. É invocada contra doenças dentais e bucais. Sua coragem extraordinária inspirou gerações de cristãos a permanecerem firmes na fé mesmo sob as mais terríveis torturas.</p><p class="mt-4"><b>Oração:</b> Santa Apolônia, virgem e mártir corajosa, que suportastes terríveis tormentos sem renunciar a Cristo, intercedei por nós. Protegei-nos das dores de dente e de todas as enfermidades da boca. Dai-nos força para suportar nossas dores com paciência e fé. Amém.</p><p class="mt-2 italic">Santa Apolônia, rogai por nós.</p>', isMartyr: true }] },
  { day: 10, month: 'Fevereiro', saints: [{ name: 'Santa Escolástica', imageUrl: 'https://i.postimg.cc/SsvMR4fv/santa-escolastica.png', story: '<h4>Irmã de São Bento - Fundadora das Beneditinas</h4><p>Santa Escolástica nasceu em Núrsia, Itália, por volta do ano 480, irmã gêmea de São Bento de Núrsia. Desde jovem consagrou-se a Deus, tornando-se uma das primeiras mulheres a viver a vida religiosa segundo a Regra Beneditina. É considerada a fundadora da rama feminina da Ordem Beneditina.</p><p class="mt-4">Estabeleceu seu mosteiro em Plômbara, próximo a Monte Cassino, onde seu irmão havia fundado o famoso mosteiro beneditino. Escolástica e Bento encontravam-se uma vez por ano em uma casa a meio caminho entre os dois mostérios, onde passavam o dia em oração e conversas espirituais sobre Deus.</p><p class="mt-4">O episódio mais famoso de sua vida ocorreu em seu último encontro com Bento. Pressentindo que seria a última vez que se veriam nesta vida, pediu ao irmão que ficasse a noite toda conversando sobre as coisas do céu. Bento recusou, pois sua regra não permitia passar a noite fora do mosteiro. Escolástica então inclinou a cabeça e orou. Imediatamente desabou uma tempestade tão violenta que Bento não pôde partir. Ele exclamou: "Que Deus te perdoe, irmã! O que fizeste?" Ela respondeu: "Pedi-te um favor e não me atendeste. Pedi a Deus e Ele me atendeu."</p><p class="mt-4">Três dias depois, Bento teve uma visão de sua alma subindo ao céu em forma de pomba. Escolástica faleceu em 10 de fevereiro de 547. São Gregório Magno, ao narrar este episódio, comentou: "Não é de admirar que ela, que amava mais, pudesse mais." É padroeira contra tempestades e invocada para obter a chuva.</p><p class="mt-4"><b>Oração:</b> Santa Escolástica, que amastes a Deus acima de tudo e encontrastes nÉle vossa maior alegria, ensinai-nos a buscar as coisas do céu. Intercedei por todas as religiosas beneditinas e por todos que buscam viver em oração e contemplação. Amém.</p><p class="mt-2 italic">Santa Escolástica, rogai por nós.</p>' }] },
  { day: 11, month: 'Fevereiro', saints: [{ name: 'N.S. de Lourdes', imageUrl: 'https://iili.io/f6UfbG2.jpg', story: '<h4>Aparições em Lourdes - Eu Sou a Imaculada Conceição</h4><p>Em 11 de fevereiro de 1858, N.S. apareceu pela primeira vez a Bernadette Soubirous, uma menina pobre de 14 anos, na gruta de Massabielle, em Lourdes, França. Ao todo, foram 18 aparições entre fevereiro e julho daquele ano.</p><p class="mt-4">Na terceira aparição, a "Bela Senhora" pediu a Bernadette que voltasse à gruta durante quinze dias. Pediu oração pelos pecadores e penitência. Na nona aparição (25 de fevereiro), mandou Bernadette cavar o chão com as mãos. Brotou uma fonte que hoje produz 120 mil litros de água por dia, conhecida por inúmeras curas milagrosas.</p><p class="mt-4">Na décima sexta aparição (25 de março), quando Bernadette insistiu em saber seu nome, a Senhora respondeu em dialeto local: "Que soy era Immaculada Councepciou" (Eu sou a Imaculada Conceição). Isto ocorreu apenas quatro anos após o Papa Pio IX ter proclamado o dogma da Imaculada Conceição (1854), que Bernadette, pobre e sem instrução, desconhecia.</p><p class="mt-4">As aparições foram reconhecidas pela Igreja em 1862. Lourdes tornou-se um dos maiores santuários marianos do mundo, visitado por milhões de peregrinos anualmente. Até hoje, 70 curas milagrosas foram oficialmente reconhecidas pela Igreja, entre milhares de curas físicas e espirituais relatadas. Bernadette tornou-se religiosa e foi canonizada em 1933.</p><p class="mt-4">N.S. de Lourdes é padroeira dos doentes e invocada para obter curas. O dia 11 de fevereiro foi instituído por São João Paulo II como Dia Mundial do Enfermo.</p><p class="mt-4"><b>Oração:</b> Ó Maria Imaculada, que vos dignastes aparecer em Lourdes à humilde Bernadette, trazendo uma mensagem de oração e penitência, olhai com bondade para nós, vossos filhos. Alcançai-nos a cura de nossas enfermidades físicas e espirituais. Ensinai-nos a aceitar com amor a vontade de Deus. Amém.</p><p class="mt-2 italic">N.S. de Lourdes, rogai por nós.</p>' }] },
  { day: 12, month: 'Fevereiro', saints: [{ name: 'Santa Eulália', imageUrl: 'https://i.postimg.cc/02FrwZmk/santa-eulalia.png', story: '<h4>Virgem e Mártir de Barcelona</h4><p>Santa Eulália nasceu em Barcelona, Espanha, por volta do ano 290, em uma família cristã. Desde muito jovem, destacou-se por sua fé ardente e pureza de vida. Quando o imperador Diocleciano desencadeou a mais violenta perseguição contra os cristãos (303-305), Eulália tinha apenas 13 anos.</p><p class="mt-4">Ao saber que o governador Daciano estava em Barcelona exigindo que os cristãos renunciassem à fé, Eulália, contra a vontade de seus pais que a haviam escondido no campo, fugiu de casa e apresentou-se corajosamente diante do tribunal. Repreendeu o governador por sua crueldade e declarou abertamente sua fé em Cristo, recusando-se a oferecer sacrifícios aos deuses pagãos.</p><p class="mt-4">Daciano, impressionado com sua beleza e juventude, tentou persuadi-la com promessas e ameaças. Diante de sua firme recusa, ordenou que fosse submetida a treze torturas diferentes, uma para cada ano de sua idade. Entre os tormentos, foi açoitada, queimada com tochas, teve seus seios arrancados e foi colocada em um barril cheio de cacos de vidro e rolada pela rua.</p><p class="mt-4">Conta a tradição que, durante as torturas, uma pomba branca saiu de sua boca no momento de sua morte, simbolizando sua alma pura subindo ao céu. Uma neve milagrosa caiu sobre Barcelona, cobrindo seu corpo martirizado. Seu martírio ocorreu em 12 de fevereiro de 304. É co-padroeira de Barcelona junto com N.S. da Mercê, e padroeira dos marinheiros.</p><p class="mt-4"><b>Oração:</b> Santa Eulália, virgem corajosa e mártir invencível, que aos treze anos preferistes a morte à negação de Cristo, ensinai-nos a ter coragem para confessar nossa fé. Intercedei pelos jovens para que permaneçam fiéis a Deus mesmo diante das pressões do mundo. Protegei a cidade de Barcelona e todos os navegantes. Amém.</p><p class="mt-2 italic">Santa Eulália, rogai por nós.</p>', isMartyr: true }] },
  { day: 13, month: 'Fevereiro', saints: [{ name: 'Santa Catarina Ricci', imageUrl: 'https://i.postimg.cc/XN2rVnYw/santa-catarina-ricci.png', story: '<h4>Mística Dominicana - Estigmatizada</h4><p>Santa Catarina de Ricci nasceu em Florença, Itália, em 1522, com o nome de Alexandrina de Ricci. Aos seis anos perdeu a mãe e foi educada por uma tia religiosa. Aos treze anos, contra a vontade do pai que desejava casá-la, ingressou no convento dominicano de Prato, adotando o nome de Catarina em honra a Santa Catarina de Siena.</p><p class="mt-4">Desde jovem, demonstrou extraordinária devoção à Paixão de Cristo. A partir de 1542, aos 20 anos, começou a experimentar êxtases místicos que duravam 28 horas, todas as quintas-feiras ao meio-dia até as sextas-feiras às 16h, revivendo em espírito toda a Paixão de Jesus, desde a agonia no Getsêmani até a morte na cruz. Estes êxtases se repetiram semanalmente durante doze anos consecutivos.</p><p class="mt-4">Em 1542, recebeu os estigmas - as cinco chagas de Cristo - que permaneceram visíveis pelo resto de sua vida. Também recebeu a coroa de espinhos invisível, que lhe causava intensas dores de cabeça. Durante seus êxtases, era vista conversando com Jesus, Maria e os santos. Muitos vinham de longe para testemunhar estes fenômenos místicos, incluindo três futuros papas: Marcelo II, Clemente VIII e Leão XI.</p><p class="mt-4">Apesar destes dons extraordinários, Catarina permaneceu humilde e dedicada ao serviço de sua comunidade. Foi eleita prioresa aos 30 anos e governou o convento com sabedoria por muitos anos. Mantinha correspondência com São Filipe Neri e São Carlos Borromeu. Faleceu em 2 de fevereiro de 1590, aos 68 anos. Foi canonizada em 1746 pelo Papa Bento XIV.</p><p class="mt-4"><b>Oração:</b> Santa Catarina de Ricci, que vivestes em profunda união com Cristo crucificado, ensinai-nos a meditar com amor na Paixão do Senhor. Alcançai-nos a graça de suportar nossas dores unindo-as aos sofrimentos de Jesus. Intercedei por todos que buscam uma vida de oração contemplativa. Amém.</p><p class="mt-2 italic">Santa Catarina de Ricci, rogai por nós.</p>' }] },
  { day: 14, month: 'Fevereiro', saints: [{ name: 'Santos Cirilo e Metódio', imageUrl: 'https://i.postimg.cc/7Z30VpwW/sao-cirilo-metodio.png', story: '<h4>Apóstolos dos Eslavos - Co-Padroeiros da Europa</h4><p>Cirilo (826-869) e Metódio (815-885) eram irmãos gregos nascidos em Tess alônica, então parte do Império Bizantino. Metódio, o mais velho, era governador de uma província antes de tornar-se monge. Cirilo, batizado como Constantino (adotou o nome Cirilo apenas antes de morrer), era um brilhante intelectual, filósofo e linguista, conhecido como "o Filósofo".</p><p class="mt-4">Em 863, o príncipe Rastislau da Grande Morávia (atual República Tcheca e Eslováquia) pediu ao imperador bizantino missionários que pudessem ensinar o cristianismo na língua eslava. Cirilo e Metódio foram escolhidos para esta missão. Cirilo criou um alfabeto especial - o glagolítico, precursor do cirílico - para transcrever a língua eslava, que até então não tinha forma escrita.</p><p class="mt-4">Os irmãos traduziram a Bíblia e a liturgia para o eslavo antigo, permitindo que os povos eslavos celebrassem a missa em sua própria língua. Esta foi uma inovação revolucionária, pois na época a liturgia era celebrada apenas em latim, grego ou hebraico. Enfrentaram forte oposição de missionários germânicos que defendiam o uso exclusivo do latim.</p><p class="mt-4">Viajaram a Roma para defender seu trabalho. O Papa Adriano II aprovou o uso da língua eslava na liturgia e ordenou Metódio bispo. Cirilo faleceu em Roma em 14 de fevereiro de 869, aos 42 anos. Metódio continuou a missão por mais 16 anos, enfrentando prisão e perseguições, até sua morte em 885. Foram declarados co-padroeiros da Europa por São João Paulo II em 1980, junto com São Bento.</p><p class="mt-4"><b>Oração:</b> Santos Cirilo e Metódio, apóstolos dos eslavos, que levastes a luz do Evangelho a muitos povos e respeitastes suas culturas e línguas, intercedei pela unidade da Europa e pela evangelização de todas as nações. Ensinai-nos a valorizar a diversidade cultural na Igreja. Amém.</p><p class="mt-2 italic">Santos Cirilo e Metódio, rogai por nós.</p>' }] },
  { day: 15, month: 'Fevereiro', saints: [{ name: 'Santos Faustino e Jovita', imageUrl: 'https://i.postimg.cc/7LX7v0CF/santos-faustino-jovita.png', story: '<h4>Irmãos Mártires de Bréscia</h4><p>Santos Faustino e Jovita eram irmãos nobres da cidade de Bréscia, no norte da Itália, que viveram no século II durante o reinado do imperador Adriano (117-138). Pertenciam a uma família aristocrática romana e, apesar de sua posição privilegiada, converteram-se ao cristianismo e dedicaram suas vidas à evangelização.</p><p class="mt-4">Foram ordenados sacerdotes pelo bispo São Apolônio de Bréscia e tornaram-se pregadores fervorosos, convertendo muitos pagãos ao cristianismo. Sua eloquência e os milagres que realizavam atraíam multidões. Quando o imperador Adriano visitou Bréscia, o prefeito Itálico denunciou os irmãos como perturbadores da ordem pública por pregarem contra os deuses romanos.</p><p class="mt-4">Foram presos e levados diante do imperador, que tentou persuadi-los a renunciar à fé cristã, oferecendo-lhes honras e riquezas. Diante da recusa, foram submetidos a uma série de torturas espetaculares. Segundo a tradição, foram lançados às feras no anfiteatro, mas os animais se recusaram a atacá-los. Foram então jogados em uma fornalha ardente, da qual saíram ilesos. Tentaram afogá-los no rio, mas as águas os sustentaram milagrosamente.</p><p class="mt-4">Vendo que nenhum tormento conseguia vencê-los e que cada milagre convertia mais pessoas ao cristianismo, o imperador ordenou que fossem decapitados. O martírio ocorreu em 15 de fevereiro de 120. Seus corpos foram sepultados em Bréscia, onde uma basílica foi construída em sua honra no século VIII. São padroeiros de Bréscia e invocados contra dores de cabeça.</p><p class="mt-4"><b>Oração:</b> Santos Faustino e Jovita, irmãos unidos na fé e no martírio, que preferistes perder a vida a renunciar a Cristo, intercedei por nós. Fortalecei os laços fraternos em nossas famílias e dai-nos coragem para testemunhar nossa fé. Protegei a cidade de Bréscia e todos que vos invocam. Amém.</p><p class="mt-2 italic">Santos Faustino e Jovita, rogai por nós.</p>', isMartyr: true }] },
  { day: 16, month: 'Fevereiro', saints: [{ name: 'Santa Juliana', imageUrl: 'https://i.postimg.cc/7Yffhj5g/santa-juliana.png', story: '<h4>Virgem e Mártir de Nicomédia</h4><p>Santa Juliana viveu em Nicomédia (atual Turquia) no início do século IV, durante a grande perseguição do imperador Maximiano (286-305). Nascida em família pagã, converteu-se secretamente ao cristianismo na adolescência e consagrou sua virgindade a Cristo, fazendo voto de castidade perpétua.</p><p class="mt-4">Seu pai, Africano, um senador romano, havia prometido sua mão em casamento a Elêusio, um jovem nobre e oficial do imperador. Quando Juliana revelou sua fé cristã e recusou-se a casar, alegando seu compromisso com Cristo, seu pai ficou furioso. Tentou persuadi-la com promessas e depois com ameaças, mas ela permaneceu firme. Elêusio, apaixonado, propôs converter-se ao cristianismo se ela aceitasse casar-se com ele, mas Juliana respondeu que só se casaria se ele se tornasse cristão de verdade, não por interesse.</p><p class="mt-4">Diante da persistente recusa, seu próprio pai a denunciou às autoridades como cristã. Elêusio, que havia sido nomeado prefeito, foi obrigado a julgá-la. Ainda apaixonado, ofereceu-lhe a liberdade se renunciasse à fé, mas Juliana recusou. Foi então submetida a terríveis torturas: açoitada, queimada com tochas, mergulhada em chumbo derretido e lançada em uma fornalha. Segundo a tradição, saiu ilesa de todos estes tormentos.</p><p class="mt-4">Durante sua prisão, o demônio apareceu-lhe disfarçado de anjo, tentando convencê-la a sacrificar aos ídolos para salvar sua vida. Juliana, discernindo o engano, agarrou o demônio e o espancou com as correntes de sua prisão, obrigando-o a confessar suas artimanhas. Finalmente, foi decapitada em 16 de fevereiro de 304. É invocada contra tentações e como protetora das mulheres em trabalho de parto.</p><p class="mt-4"><b>Oração:</b> Santa Juliana, virgem fiel e mártir corajosa, que resististes às tentações do demônio e às pressões do mundo, ensinai-nos a permanecer firmes em nossa consagração a Cristo. Intercedei pelas jovens que buscam viver a castidade e por todos que enfrentam tentações. Protegei as mulheres grávidas e dai-nos força para vencer o mal. Amém.</p><p class="mt-2 italic">Santa Juliana, rogai por nós.</p>', isMartyr: true }] },
  { day: 17, month: 'Fevereiro', saints: [{ name: 'Sagrada Face', imageUrl: 'https://iili.io/f6UfDCl.jpg', story: '<h4>Devoção à Face de Cristo</h4><p>A devoção à Sagrada Face de Jesus contempla o rosto de Cristo desfigurado pelos sofrimentos da Paixão. Tem origem nas revelações de Santa Veronica Giuliani (século XVII) e foi especialmente difundida por Santa Teresinha do Menino Jesus, que adotou o título "da Sagrada Face" em sua profissão religiosa.</p><p class="mt-4">A Irmã Maria de São Pedro, carmelita de Tours (1806-1848), recebeu revelações de Jesus pedindo reparação pelas blasfêmias e profanações do santo Nome de Deus. Jesus mostrou-lhe Sua Face coberta de sangue e lágrimas, pedindo almas que O consolassem. O Papa Leão XIII aprovou esta devoção em 1885, instituindo a festa da Sagrada Face.</p><p class="mt-4">Esta devoção nos convida a meditar nas humilhações que Jesus sofreu: as bofetadas, os cuspes, a coroa de espinhos, o sangue que cobriu Seu rosto. Isaias profetizou: "Não tinha aparência nem beleza... era desprezado e abandonado pelos homens" (Is 53,2-3). Ao contemplar a Face de Jesus desfigurada pelo pecado, somos chamados à conversão e à reparação.</p><p class="mt-4">A Sagrada Face é também associada ao Santo Sudario de Turim e ao Véu de Verônica. É invocada para obter conversão dos pecadores, reparação das blasfêmias e força para suportar humilhações.</p><p class="mt-4"><b>Oração:</b> Ó Jesus, que por amor a nós aceitastes ter Vossa Face adoravel desfigurada pelos sofrimentos da Paixão, dai-nos a graça de reconhecer Vossa presença nos que sofrem. Perdoai as blasfêmias e ofensas contra Vosso santo Nome. Concedei-nos a graça de contemplar Vossa Face gloriosa no céu. Amém.</p><p class="mt-2 italic">Sagrada Face de Jesus, tende piedade de nós.</p>' }] },
  { day: 18, month: 'Fevereiro', saints: [{ name: 'B. João de Fiesole (Fra Angélico)', imageUrl: 'https://i.postimg.cc/Y0Sj1sbt/fra-angelico.png', story: '<h4>Frade Dominicano e Pintor - Patrono dos Artistas</h4><p>Guido di Pietro nasceu por volta de 1395 em Vicchio, perto de Florença, Itália. Ainda jovem, demonstrou extraordinário talento para a pintura e foi aprendiz de um mestre florentino. Por volta de 1420, aos 25 anos, ingressou no Convento Dominicano de Fiesole, adotando o nome religioso de Fra Giovanni (Frei João). Seus contemporâneos o chamavam de "Fra Giovanni Angélico" (Frei João Angélico) devido à beleza celestial de suas pinturas e à sua santidade de vida.</p><p class="mt-4">Fra Angélico revolucionou a arte sacra ao combinar a técnica renascentista (perspectiva, luz, anatomia) com profunda espiritualidade medieval. Suas obras não eram meras representações artísticas, mas verdadeiras "teologias pintadas". Antes de pintar, sempre orava e jejuava. Dizia: "Quem pinta Cristo deve viver com Cristo." Nunca retocava suas obras, acreditando que a primeira inspiração vinha de Deus. Pintava sempre com lágrimas nos olhos quando representava a Crucificação.</p><p class="mt-4">Entre 1438 e 1445, pintou os afrescos do Convento de San Marco em Florença, sua obra-prima. Decorou 50 celas monásticas, cada uma com uma cena da vida de Cristo para meditação dos frades. Sua "Anunciação" no topo da escadaria é considerada uma das mais belas da história da arte. No Vaticano, pintou a Capela Niccolina (1447-1449) a pedido do Papa Nicolau V. Outras obras célebres incluem "O Juízo Final", "A Coroação da Virgem" e "A Deposição da Cruz".</p><p class="mt-4">Apesar da fama, permaneceu humilde. Recusou o arcebispado de Florença, dizendo que não era digno. Foi prior de San Marco e de Fiesole, sempre combinando vida contemplativa, artística e pastoral. Usava cores luminosas (especialmente azul ultramarino e ouro) que simbolizavam a luz divina. Seus anjos parecem realmente celestiais, daí seu apelido "Angélico".</p><p class="mt-4">Faleceu em Roma em 18 de fevereiro de 1455, aos 60 anos. Foi sepultado na Basílica de Santa Maria sopra Minerva. O Papa João Paulo II o beatificou em 1982 e o proclamou patrono universal dos artistas em 1984. Sua festa litúrgica é celebrada em 18 de fevereiro. Fra Angélico nos ensina que a arte verdadeira é oração, e que a beleza é um caminho para Deus.</p><p class="mt-4"><b>Oração:</b> Beato Fra Angélico, que transformastes vossa arte em oração e vossa vida em obra de arte espiritual, intercedei por todos os artistas para que usem seus talentos para a glória de Deus. Ensinai-nos a ver a beleza divina em todas as coisas e a buscar a santidade em nosso trabalho. Inspirai os pintores, escultores e artistas sacros a criarem obras que elevem as almas a Deus. Amém.</p><p class="mt-2 italic">Beato Fra Angélico, rogai por nós.</p>' }] },
  { day: 19, month: 'Fevereiro', saints: [{ name: 'São Conrado de Parzham', imageUrl: 'https://i.postimg.cc/JzVjj1VS/sao-conrado.jpg', story: '<h4>São Conrado de Parzham - O Porteiro dos Pobres</h4><p>João Birndorfer, que tomaria o nome religioso de Conrado, nasceu em 22 de dezembro de 1818 em Parzham, na Baviera (Alemanha), filho caçula de uma família de camponeses profundamente cristãos. Desde criança, destacou-se por sua piedade extraordinária: acordava de madrugada para rezar, passava horas em oração diante do Santíssimo Sacramento e tinha especial devoção à Virgem Maria e a São Francisco de Assis.</p><p class="mt-4">Após a morte dos pais, distribuiu sua herança aos pobres e, aos 31 anos, ingressou como irmão leigo na Ordem dos Frades Menores Capuchinhos no convento de Altötting, famoso santuário mariano da Baviera. Recebeu o nome de Conrado e foi designado para o cargo mais humilde do convento: porteiro.</p><p class="mt-4">Por 41 anos consecutivos, Conrado exerceu esta função com heroíca santidade. A porta do convento era o ponto de encontro de centenas de pobres, mendigos, peregrinos e doentes que vinham ao santuário de Altötting. Conrado recebia a todos com paciência infinita, bondade e alegria, distribuindo pão, roupas e palavras de conforto. Era chamado de "o porteiro dos pobres" e "o anjo da porta".</p><p class="mt-4">Sua vida era de oração contínua. Dormia apenas algumas horas, passando o resto da noite em adoração. Tinha o dom da leitura dos corações e muitos vinham de longe para pedir seu conselho. Apesar de sua humildade extrema, era reconhecido como homem de Deus. Nunca buscou honras ou reconhecimento, preferindo sempre o último lugar.</p><p class="mt-4">Faleceu em 21 de abril de 1894, aos 75 anos, com a coroa do rosário nas mãos. Seu funeral reuniu uma multidão imensa. Foi beatificado em 1930 e canonizado em 1934 pelo Papa Pio XI. É padroeiro dos porteiros e dos pobres, e um dos santos mais populares da Baviera.</p><p class="mt-4"><b>Oração:</b> São Conrado de Parzham, humilde porteiro que abristes a porta do convento a todos os que sofriam, ensinai-nos a servir os pobres com alegria e paciência. Intercedei por todos os que exercem serviços humildes e por todos os que batem à porta pedindo ajuda. Amém.</p><p class="mt-2 italic">São Conrado de Parzham, rogai por nós.</p>' }] },

  { day: 20, month: 'Fevereiro', saints: [{ name: 'Santos Francisco e Jacinta Marto', imageUrl: 'https://i.postimg.cc/HL35GXJ4/santos-francisco-jacinta.jpg', story: '<h4>Santos Francisco e Jacinta Marto - Os Pastorinhos de Fátima</h4><p>Francisco e Jacinta Marto eram irmãos, filhos de Manuel Pedro Marto e Olímpia de Jesus, nascidos em Aljustrel, aldeia próxima a Fátima, Portugal. Francisco nasceu em 11 de junho de 1908 e Jacinta em 11 de março de 1910. Eram primos de Lúcia dos Santos, com quem pastoreavam ovelhas nos campos de Cova da Iria.</p><p class="mt-4">Em 13 de maio de 1917, junto com Lúcia, os três pastorinhos viram pela primeira vez N.S., que se apresentou como "a Senhora do Rosário". As aparições se repetiram nos dias 13 de cada mês até outubro de 1917, quando ocorreu o famoso Milagre do Sol, testemunhado por cerca de 70.000 pessoas. N.S. revelou três segredos e pediu oração, penitência e consagração ao Imaculado Coração de Maria.</p><p class="mt-4">Francisco era um menino contemplativo e silencioso. Após as aparições, passou horas em oração diante do Santíssimo Sacramento, querendo "consolar a Jesus" que via tão triste. Aceitou com alegria os sofrimentos que N.S. lhe havia anunciado. Contraiu gripe espanhola e faleceu em 4 de abril de 1919, aos 10 anos, com expressão de paz no rosto.</p><p class="mt-4">Jacinta era a mais jovem e a mais sensível das três videntes. Após as aparições, tornou-se apóstola fervorosa da penitência pelos pecadores. Tinha visões dos sofrimentos dos pecadores no inferno e chorava por eles. Também contraiu gripe espanhola e depois tuberculose óssea. Sofreu operações sem anestesia com heroíca paciência. Faleceu em Lisboa em 20 de fevereiro de 1920, aos 9 anos, sozinha no hospital, como N.S. havia predito.</p><p class="mt-4">João Paulo II beatificou Francisco e Jacinta em 13 de maio de 2000, em Fátima. Francisco e Jacinta foram canonizados pelo Papa Francisco em 13 de maio de 2017, durante as comemorações do centenário das aparições de Fátima. São os santos canonizados mais jovens da história da Igreja que não foram mártires.</p><p class="mt-4"><b>Oração:</b> Santos Francisco e Jacinta, pastorinhos que vistes N.S. e dedicastes vossas curtas vidas à oração e penitência pelos pecadores, intercedei por nós. Ensinai-nos a amar o Imaculado Coração de Maria e a rezar o Rosário com fervor. Amém.</p><p class="mt-2 italic">Santos Francisco e Jacinta, rogai por nós.</p>' }] },

  { day: 21, month: 'Fevereiro', saints: [{ name: 'São Pedro Damião', imageUrl: 'https://i.postimg.cc/5yX8SytJ/sao-pedro-damiao.jpg', story: '<h4>São Pedro Damião - Doutor da Igreja e Reformador</h4><p>Pedro Damião nasceu em Ravena, Itália, por volta do ano 1007, o mais jovem de uma família numerosa. Ficou órfão cedo e foi criado por um irmão mais velho que o tratava como servo. Outro irmão, Damião, arcediago de Ravena, teve compaixão dele e o mandou estudar. Em gratidão, Pedro adotou o sobrenome do irmão bienfeitor, chamando-se Pedro Damião.</p><p class="mt-4">Tornou-se professor renomado em Ravena, mas a vida intelectual não o satisfazia espiritualmente. Aos 28 anos, abandonou a carreira acadêmica e ingressou no mosteiro beneditino de Fonte Avellana, famoso por sua austeridade. Ali viveu como eremita, entregando-se a mortificações severas, jejuns prolongados e oração contínua.</p><p class="mt-4">Eleito prior do mosteiro, transformou-o em centro de reforma monástica e espiritual. Fundou vários eremitérios na Itália central, formando uma congregação de vida eremítica. Sua fama de santidade e sabedoria atraiu muitos discípulos e chegou aos ouvidos dos papas reformadores do século XI.</p><p class="mt-4">Tornou-se o grande apoio dos papas reformadores — Leão IX, Estêvão IX, Nicolau II e Alexandre II — na luta contra a simonia (compra e venda de cargos eclesiásticos) e o nicolaísmo (casamento do clero). Escreveu obras vigorosas denunciando a corrupção na Igreja e defendendo a reforma gregoriana. Em 1057, foi nomeado cardeal-bispo de Óstia pelo Papa Estêvão IX, cargo que aceitou relutantemente.</p><p class="mt-4">Foi enviado como legado papal em missões delicadas: reconciliar o imperador Henrique IV com o papa, resolver disputas entre bispos e reformar mosteiros. Escreveu mais de 170 cartas, 53 sermões e numerosos tratados teológicos. Faleceu em 22 de fevereiro de 1072, em Faenza, durante uma missão papal. Foi declarado Doutor da Igreja pelo Papa Leão XII em 1828.</p><p class="mt-4"><b>Oração:</b> São Pedro Damião, doutor ardente e reformador corajoso, que combatestes a corrupção na Igreja com a força da oração e da penitência, intercedei pela pureza e santidade da Igreja. Ensinai-nos a unir a vida contemplativa ao serviço ativo de Deus. Amém.</p><p class="mt-2 italic">São Pedro Damião, rogai por nós.</p>' }] },
  ...
  { day: 23, month: 'Fevereiro', saints: [{ name: 'São Policarpo', imageUrl: 'https://www.a12.com/source/files/originals/23_de_fevereiro_-_Sao_Policarpo-358400.jpg', story: '<h4>Bispo e Mártir - Discípulo dos Apóstolos</h4><p>São Policarpo nasceu por volta do ano 69 d.C. e foi um dos últimos elos vivos com a era apostólica. Discípulo direto do Apóstolo João, foi por ele ordenado bispo de Esmirna (atual Turquia), cidade da Ásia Menor. Sua formação direta ao lado de um apóstolo conferia a suas palavras uma autoridade particular na Igreja primitiva.</p><p class="mt-4">Foi um dos grandes defensores da ortodoxia da fé nos séculos II, combatendo com vigor as heresias gnósticas que ameaçavam a unidade cristã. O historiador Eusébio registra que, ao encontrar o herege Marción que lhe perguntou "não me reconheces?", Policarpo respondeu: "Reconheço-te como o primogênito de Satanás." Sua firmeza na fé era inabalável.</p><p class="mt-4">Por volta do ano 155, viajou a Roma para discutir com o papa Aniceto a questão da data da Páscoa — os cristãos do Oriente seguiam tradição diferente da do Ocidente. Apesar da divergência, os dois bispos mantiveram a comunhão fraterna, demonstrando que a unidade na caridade prevalecia sobre divergências disciplinares.</p><p class="mt-4">Aos 86 anos de idade, durante a perseguição de Marco Aurélio, foi preso e levado ao anfiteatro. O procônsul lhe pediu que abjurasse a Cristo para salvar sua vida. Policarpo respondeu com sua famosa declaração: <em>"Oitenta e seis anos sirvo a Cristo, e Ele nunca me fez mal algum. Como poderia eu blasfemar contra meu Rei que me salvou?"</em> Recusou-se a renegar a fé e foi condenado à fogueira. Conta a tradição que as chamas não o consumiam, formando um arco ao redor de seu corpo, e que foi finalmente morto com uma faca. Era o dia 23 de fevereiro de 156.</p><p class="mt-4">A <em>Carta da Igreja de Esmirna</em>, que narra seu martírio em detalhes, é o mais antigo relato de martírio cristão fora do Novo Testamento e estabeleceu o modelo de como a Igreja passaria a venerar seus mártires.</p><p class="mt-4"><b>Oração:</b> Ó Deus, que sustentastes o vosso servo São Policarpo na confissão da fé até o martírio, concedei-nos, por sua intercessão, participar do cálice de Cristo para ressuscitar na glória. Amém.</p><p class="mt-2 italic">São Policarpo, rogai por nós.</p>', isMartyr: true }] },
  { day: 24, month: 'Fevereiro', saints: [{ name: 'São Sérgio', imageUrl: 'https://www.radiostellamaris.cl/wp-content/uploads/2024/02/San-Sergio.jpg', story: '<h4>Mártir Romano - Soldado de Cristo</h4><p>São Sérgio foi um oficial do exército romano que viveu no século III, durante o reinado do imperador Maximiano. Era de nobre família e exercia cargo elevado nas tropas imperiais. Juntamente com seu companheiro de armas São Baco, professava secretamente a fé cristã enquanto servia com distinção no exército.</p><p class="mt-4">A descoberta de sua fé ocorreu quando se recusaram a participar de um sacrifício pagão em homenagem a Júpiter. Denunciados ao imperador, foram enviados ao general Antíoco para punição e tentativa de apostasia. Baco morreu primeiro sob as torturas. Sérgio, fortalecido pela visão de seu amigo martirizado, resistiu a todos os tormentos, sendo obrigado a calçar sapatos cravejados de pregos e caminhar longas distâncias.</p><p class="mt-4">Finalmente, em 7 de outubro de 303 (também venerado em 24 de fevereiro), foi decapitado em Resafa (atual Síria), cidade que posteriormente passou a ser chamada de Sergiopólis em sua honra. Seu martírio tornou-se rapidamente popular em todo o Oriente Médio.</p><p class="mt-4">São Sérgio tornou-se um dos santos mais populares do Oriente cristão. Constantino I construiu uma basílica em sua honra em Resafa, e Justiniano I restaurou e ampliou o santuário. Era venerado por cristãos, muçulmanos e judeus como intercessor poderoso. Seu culto se espalhou por toda a Síria, Mesopotâmia e além.</p><p class="mt-4"><b>Oração:</b> São Sérgio, soldado corajoso que preferiste a morte à apostasia, intercedei por nós para que sejamos fiéis a Cristo em todas as circunstâncias da vida. Protegei todos os militares e agentes de segurança. Amém.</p><p class="mt-2 italic">São Sérgio, rogai por nós.</p>', isMartyr: true }] },
  { day: 25, month: 'Fevereiro', saints: [{ name: 'São Cesário de Nazianzo', imageUrl: 'https://www.a12.com/source/files/originals/Sao_Cesario_de_Nazianzo-928991.jpg', story: '<h4>Médico e Homem de Deus - Irmão de São Gregório</h4><p>São Cesário nasceu por volta do ano 330 em Arianzo, na Capadócia (atual Turquia), filho do bispo Gregório de Nazianzo (o Velho) e de Santa Nona. Era irmão de São Gregório de Nazianzo, um dos maiores teólogos da história da Igreja (Doutor da Igreja), e de Gorgônia, também venerada como santa.</p><p class="mt-4">Cesário demonstrou desde jovem aptidão extraordinária para as ciências. Estudou em Alexandria e mais tarde em Constantinopla, onde se tornou médico renomado. Sua fama na medicina chegou ao imperador Constâncio II, que o convidou para ser seu médico pessoal. Posteriormente, serviu também ao imperador Juliano, o Apóstata, que tentou sem sucesso persuadi-lo a abandonar o Cristianismo.</p><p class="mt-4">Mesmo servindo na corte imperial, Cesário manteve inabalável sua fé cristã. Quando Juliano pressionou os funcionários do palácio a apostatarem, Cesário não cedeu e manteve pública sua condição de cristão. Regressou a sua terra natal após a morte de Juliano, recusando novos cargos imperiais. Seu irmão São Gregório o instou a abandonar definitivamente a vida mundana da corte.</p><p class="mt-4">Após sobreviver milagrosamente ao grande terremoto de Niceia em 368, que destruiu a cidade matando muitos, Cesário interpretou o evento como um chamado divino. Decidiu então distribuir todos os seus bens aos pobres em preparação para receber o batismo — que naquela época muitas vezes era adiado por temor de pecar após recebê-lo.</p><p class="mt-4">Pouco depois do terremoto, foi batizado e faleceu em 369, ainda jovem. Seu irmão São Gregório proferiu um belo discurso fúnebre em sua memória, que é uma das fontes históricas mais ricas sobre sua vida. Seu exemplo mostra como é possível ser santo vivendo no meio do mundo, em meio a honras e pressões, mantendo intacta a integridade cristã.</p><p class="mt-4"><b>Oração:</b> São Cesário de Nazianzo, médico e servidor fiel que soubeste ser luz de Cristo no meio da corte imperial, intercedei por todos os profissionais de saúde e por aqueles que vivem no mundo cumprindo sua missão cristã com integridade. Amém.</p><p class="mt-2 italic">São Cesário de Nazianzo, rogai por nós.</p>' }] },
  { day: 26, month: 'Fevereiro', saints: [{ name: 'Santo Alexandre', imageUrl: 'https://diocesedeamparo.org.br/wp-content/uploads/2018/02/st-alexandre-egito.jpg', story: '<h4>Patriarca de Alexandria - Defensor da Divindade de Cristo</h4><p>Santo Alexandre nasceu por volta do ano 250 e tornou-se bispo de Alexandria — a mais importante sede cristã no Oriente depois de Roma — por volta do ano 312. Seu episcopado seria marcado por uma das maiores crises da história da Igreja: a heresia ariana.</p><p class="mt-4">Por volta de 318, um de seus próprios sacerdotes, Ário, começou a ensinar que o Filho de Deus era uma criatura, embora superior às demais — "houve um tempo em que Ele não existia." Esta negação da plena divindade de Cristo ameaçava destruir o fundamento da fé cristã. Alexandre reconheceu imediatamente o perigo e convocou um sínodo de cerca de cem bispos que condenou as doutrinas de Ário e o exonerou, por volta de 320.</p><p class="mt-4">Ário, porém, não se rendeu e buscou apoio em outros bispos, especialmente Eusébio de Nicomédia. A controvérsia alastrou-se por todo o Império, ameaçando a unidade política e religiosa. O imperador Constantino convocou então o Primeiro Concílio Ecumênico, realizado em Niceia em 325 — o primeiro grande concílio de toda a Igreja.</p><p class="mt-4">Alexandre participou do Concílio de Niceia acompanhado de seu diácono Atanásio, que seria seu sucessor e o grande campeão da fé nicena. O Concílio definiu solenemente que o Filho é <em>"consubstancial ao Pai"</em> (homoousios), usando o termo que expressava com precisão a plena divindade de Cristo. Ário foi condenado e enviado ao exílio.</p><p class="mt-4">Alexandre faleceu em 17 de abril de 328, antes de ver a implementação plena das decisões de Niceia. Em seu leito de morte, chamou por Atanásio, provando que reconhecia nele o herdeiro de sua missão. Seu legado foi imenso: preservou e transmitiu a fé na divindade de Cristo em momento crucial.</p><p class="mt-4"><b>Oração:</b> Santo Alexandre, pastor corajoso que defendestes a divindade de Cristo em momento de grave crise para a Igreja, intercedei por nós. Fortifica nossa crença na plena divindade e humanidade de Jesus Cristo, nosso Senhor e Salvador. Amém.</p><p class="mt-2 italic">Santo Alexandre, rogai por nós.</p>' }] },
  { day: 27, month: 'Fevereiro', saints: [{ name: 'São Gabriel das Dores', imageUrl: 'https://i.postimg.cc/qvV22kVL/sao-gabriel-dores.jpg', story: '<h4>São Gabriel das Dores - Jovem Passionista</h4><p>Francisco Possenti nasceu em Assis, Itália, em 1838, filho de um governador pontifício. Desde jovem, era alegre, sociável e amado por todos. Apesar de duas promessas de entrar para a vida religiosa, adiava a decisão. Mas Deus o chamava com insistência. Numa procissão, ao ver a imagem de N.S., ouviu claramente no coração: "Francisco, o mundo não é para ti." Desta vez, respondeu com generosidade total.</p><p class="mt-4">Ao entrar na Congregação da Paixão (Passionistas), tomou o nome de Gabriel das Dores. Mergulhou com todo o coração na contemplação da Paixão de Jesus, encontrando nela não tristeza, mas uma alegria profunda e sobrenatural. Era conhecido por sua humildade, pureza e alegria contagiante — provou que a vida de penitência e oração não é triste, mas fonte de uma felicidade que o mundo não pode dar.</p><p class="mt-4">Tinha devoção filial e ardente a N.S. das Dores, vendo em Maria a Mãe que compartilhou plenamente a Paixão do Filho. Adoeceu de tuberculose e enfrentou a doença com serenidade admirável, oferecendo seus sofrimentos unidos aos de Cristo. Morreu com um sorriso nos lábios, contemplando a imagem de N.S. das Dores, em 27 de fevereiro de 1862, com apenas 24 anos.</p><p class="mt-4">Foi beatificado em 1908 e canonizado em 1920 pelo Papa Bento XV. É padroeiro e intercessor especial da juventude. Seu corpo, encontrado incorrupto, repousa em Isola del Gran Sasso, na Itália.</p><p class="mt-4"><b>Oração:</b> Ó São Gabriel das Dores, jovem que encontrastes na Paixão de Cristo a fonte de toda alegria, intercede por nós, especialmente pelos jovens. Que o teu exemplo nos inspire a viver com alegria e generosidade a nossa fé. Amém.</p><p class="mt-2 italic">São Gabriel das Dores, rogai por nós.</p>' }] },

  { day: 28, month: 'Fevereiro', saints: [{ name: 'Santos Romão e Lupicino', imageUrl: 'https://img.cancaonova.com/cnimages/canais/uploads/sites/2/2013/02/santododia-Santos-Rom%C3%A3o-e-Lupicino.jpg', story: '<h4>Abades e Fundadores - Pais do Monaquismo na Gália</h4><p>Santos Romão e Lupicino eram irmãos que viveram no século V e são considerados os pais do monaquismo no Jura, região hoje entre a França e a Suíça. Sua vida é conhecida sobretudo através da <em>Vida dos Padres do Jura</em>, escrita por um de seus discípulos anônimos por volta do ano 515.</p><p class="mt-4">Romão, o mais velho, nasceu por volta de 390. Tocado pela leitura da Vida de São Martinho de Tours e pelas obras de São Cassiano, sentiu o chamado à vida contemplativa em plena solidão. Por volta de 435, partiu sozinho para as florestas selvagens e impenetráveis do Jura, levando apenas um machado e algumas ferramentas. Ali, nas margens do rio Bienne, construiu com suas mãos uma cela e um pequeno oratório.</p><p class="mt-4">Pouco depois, seu irmão Lupicino juntou-se a ele, e aos poucos outros discípulos foram chegando atraídos pelo exemplo dos dois irmãos. Fundaram dois mosteiros: Condat (hoje Saint-Claude) e Leucone. A regras que seguiam era rígida e austera, baseada nas tradições dos Padres do Deserto e na regra de São Cassiano.</p><p class="mt-4">Os dois irmãos exerciam a liderança de forma complementar: Romão era más misericordioso e acolhedor, enquanto Lupicino era mais rigoroso na disciplina. Juntos formavam uma comunidade equilibrada. Lupicino, inclusive, é lembrado por ter vendido os utensílios do mosteiro para pagar dívidas de escravos e libertá-los, demonstrando que a vida monástica não era indiferente ao sofrimento humano.</p><p class="mt-4">São Romão faleceu por volta de 463 e São Lupicino por volta de 480. Seus mosteiros floresceram por séculos e foram centros de irradiação do Evangelho por toda a região do Jura. A cidade de Saint-Claude na França e várias igrejas na Suíça perpetuam sua memória.</p><p class="mt-4"><b>Oração:</b> Santos Romão e Lupicino, abades que fuistes à solidão do Jura em busca de Deus e criastes comunidades onde Ele era amado, intercedei por todos os monges e religiosos. Ensinai-nos a buscar Deus acima de tudo. Amém.</p><p class="mt-2 italic">Santos Romão e Lupicino, rogai por nós.</p>' }] },
];
...
// IMPORTANT: Add santosMarcoSetembro first (contains Feb 1-5) then saintsOfTheDayFevereiroExtra (Feb 6-28)
saintsOfTheDay.push(...saintsOfTheDayMarcoSetembro);
saintsOfTheDay.push(...saintsOfTheDayFevereiroExtra);

// Adiciona dias 29, 30 e 31 de março (não cobertos em santosMarcoSetembro)
const marcoFinal = saintsOfTheDayMarcoComplete.filter(s => s.month === 'Março' && s.day >= 29);
saintsOfTheDay.push(...marcoFinal);
