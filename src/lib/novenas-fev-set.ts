        ...
        days: [
            {
                ...
                content: `<div class="day-specific-content">
                <div class="mb-6 p-4 rounded-xl flex items-start gap-3" style="background-color:#ffffff;border:2px solid #166534;">
