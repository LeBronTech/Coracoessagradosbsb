...
export const worldMarianDevotions: Continent[] = [
    {
        name: "Europa",
        emoji: "🇪🇺",
        iconUrl: "https://i.postimg.cc/wxW169jQ/europa-icon-white.jpg",
        devotions: [
            // PRIORIDADE ALTA / FASE 1 & 2
            {
                ...
                countryFlag: "🇮🇪",
                date: "21 de Agosto",
                imageUrl: "https://i.postimg.cc/4xPbGrq7/ns-knock.png",
            ...
            },
            {
                ...
                countryFlag: "🇧🇪",
                date: "29 de Novembro",
                imageUrl: "https://i.postimg.cc/gJXvvrJ4/ns-beauraing.png",
            ...
            },
            {
                ...
                countryFlag: "🇳🇱",
                date: "31 de Maio",
                imageUrl: "https://i.postimg.cc/gr9LyK5y/ns-todas-nacoes.png",
            ...
            },
            {
                ...
                countryFlag: "🇱🇹",
                date: "8 de Setembro",
                imageUrl: "https://i.postimg.cc/y6DfPY55/ns-siluva.png",
            ...
            },
            {
                ...
                countryFlag: "🇷🇺",
                date: "4 de Novembro",
                imageUrl: "https://i.postimg.cc/Mp5bwhNV/ns-kazan.jpg",
            ...
            },
            {
                ...
                countryFlag: "🇧🇪",
                date: "15 de Janeiro",
                imageUrl: "https://i.postimg.cc/QCnCSJyV/ns-banneux.png",
            ...
            },
            {
                ...
                imageUrl: "https://i.postimg.cc/FznzGVB0/ns-pellevoisin.png",
            ...
            },
            {
                ...
                countryFlag: "🇮🇹",
                date: "29 de Agosto",
                imageUrl: "https://i.postimg.cc/jdmC7vNY/ns-lagrimas.jpg",
            ...
            },
            {
                ...
                fullDescription: "A ESTRELA DO MAR E O PORTO SEGURO\n\nN.S. da Guia é um dos títulos mais antigos e amados da Virgem Maria, profundamente ligado à história das navegações e à confiança cristã em Maria como a 'Estrela do Mar' (Stella Maris). Sua devoção nasceu da necessidade dos navegantes de encontrar um guia seguro em meio às tempestades e incertezas dos oceanos, transpondo essa necessidade para a jornada espiritual de cada cristão rumo ao Céu.\n\nORIGENS EM PORTUGAL E AS NAVEGAÇÕES\n\nA devoção consolidou-se em Portugal durante a Era das Descobertas. Antes de partirem para mares desconhecidos, marinheiros e exploradores recorriam a N.S. da Guia, pedindo proteção contra naufrágios e um retorno seguro. Em Cascais, o Santuário de N.S. da Guia tornou-se um farol de fé para os que cruzavam o Atlântico. Diz a tradição que, em momentos de perigo extremo, uma luz misteriosa vinda do local da capela guiava os navios perdidos para a segurança do porto.\n\nA DEVOÇÃO NO BRASIL\n\nCom os colonizadores portugueses, a devoção chegou ao Brasil, estabelecendo-se com força em diversas regiões. Em Várzea Grande e Cuiabá (Mato Grosso), ela é venerada como a padroeira que guiou os primeiros exploradores e hoje guia o povo nas dificuldades da vida. Sua festa é marcada por barqueatas e procissões que celebram a proteção divina sobre os que viajam e trabalham.\n\nSIMBOLISMO E MENSAGEM ESPIRITUAL\n\nA iconografia de N.S. da Guia geralmente a representa segurando o Menino Jesus no colo esquerdo, enquanto sua mão direita aponta para Ele ou segura um cetro/guia. O Menino Jesus, por sua vez, muitas vezes segura um globo ou faz um gesto de benção. A mensagem é clara: Maria nos guia até Jesus, que é o Caminho, a Verdade e a Vida. Ela é a Estrela que não se apaga, brilhando na noite escura da dúvida e do pecado, conduzindo-nos ao porto seguro da salvação.\n\nORAÇÃO\n\nÓ Maria, N.S. da Guia, Estrela que brilha no mar da vida, protegei-nos em todas as nossas viagens e guiai nossos corações nos caminhos da paz e da justiça. Quando as tempestades do mundo nos cercarem, sede vós o nosso farol, conduzindo-nos com segurança até o encontro definitivo com vosso Filho Jesus. Amém.",
                status: "approved",
                statusNote: "Devoção Tradicional"
            },
            {
                ...
                countryFlag: "🇵🇹",
                date: "12 de Junho",
                imageUrl: "https://i.postimg.cc/J7SpdCCK/ns-sameiro.jpg",
                description: "O Altar de Portugal - Segundo maior santuário mariano do país",
                fullDescription: "O SANTUÁRIO DO IMACULADO CORAÇÃO\n\nN.S. do Sameiro é uma das maiores e mais profundas devoções de Portugal, possuindo o segundo maior santuário mariano do país, localizado no topo do Monte do Sameiro, em Braga. Esta devoção é um marco histórico, pois nasceu antes mesmo da proclamação oficial do Dogma da Imaculada Conceição.\n\nORIGEM E O PAI DA DEVOÇÃO\n\nA história do Sameiro está ligada ao Padre Martinho da Silva, que em 1863 decidiu erguer um monumento à Imaculada Conceição. O fervor cresceu tão rapidamente que o Papa Pio IX enviou uma coroa de ouro para a imagem em 1876. O imponente santuário, de arquitetura neoclássica, domina a paisagem de Braga e é visível a muitos quilômetros de distância.\n\nA COROAÇÃO E O RECONHECIMENTO\n\nA imagem de N.S. do Sameiro foi solenemente coroada em 1904, durante o cinquentenário do dogma. O santuário tornou-se um centro de peregrinação tão vital que recebeu a visita de São João Paulo II em 1982 e de Bento XVI em 2010. A Rosa de Ouro, alta distinção pontifícia, foi-lhe atribuída por João Paulo II, testemunhando a importância espiritual deste 'Altar de Portugal'.\n\nMENSAGEM ESPIRITUAL\n\nSituado no alto do monte, o Sameiro simboliza a elevação do espírito. Maria, sob este título, convida os fiéis à pureza de coração e à firmeza na fé. É o local onde o povo português renova anualmente sua consagração à Virgem Maria, pedindo sua proteção sobre a nação e as famílias. N.S. do Sameiro é a Mãe que acolhe, protege e guia o povo português com seu coração imaculado.\n\nORAÇÃO\n\nN.S. do Sameiro, Mãe de bondade e de misericórdia, volvei para nós os vossos olhos de compaixão. Do alto deste monte sagrado, abençoai as nossas famílias, protegei a juventude e intercedei por todos os que sofrem. Que sob vossa guia, possamos sempre caminhar na luz de vosso Filho Jesus. Amém.",
                status: "approved",
                statusNote: "Devoção Tradicional"
            },
            {
                ...
                countryFlag: "🇵🇹",
                date: "02 de Fevereiro",
                imageUrl: "https://i.postimg.cc/jq8DsRS7/ns-luz.png",
            ...
            },
            {
                ...
                countryFlag: "🇧🇦",
                date: "25 de Junho",
                imageUrl: "https://i.postimg.cc/J7Ts1Rz8/ns-medjugorje.png",
    ...
    },
    {
        name: "Ásia",
        emoji: "🌏",
        iconUrl: "https://i.postimg.cc/XN2rVnY6/asia-icon.jpg",
        devotions: [
            {
                id: "la_vang",
                name: "N.S. de La Vang",
                ...
                countryFlag: "🇻🇳",
                date: "15 de Agosto",
                imageUrl: "https://i.postimg.cc/ZRSdyHGJ/ns-la-vang.png",
            ...
            },
            {
                ...
                fullDescription: "A LOURDES DO ORIENTE E OS MILAGRES PROTETORES\n\nN.S. da Boa Saúde de Vailankanni (ou Velankanni) é uma das devoções marianas mais impressionantes da Ásia, localizada em uma pequena cidade costeira em Tamil Nadu, no sul da Índia. O local é frequentemente chamado de 'Lourdes do Oriente' devido às incontáveis graças e curas milagrosas lá alcançadas.\n\nAS APARIÇÕES DO SÉCULO XVI\n\nA devoção teve início com três grandes milagres no século XVI. O primeiro ocorreu quando Maria apareceu a um jovem pastor hindu que adormeceu junto a um lago enquanto levava leite para seu mestre. Maria, com o Menino Jesus, pediu um pouco do leite. Quando o mestre do jovem olhou o recipiente depois, ele milagrosamente transbordava de leite.\n\nO segundo milagre aconteceu anos depois, quando N.S. apareceu a um menino com deficiência física que vendia soro de leite. Ao pedir-lhe um pouco para o Menino Jesus, o menino foi curado imediatamente e passou a caminhar, emocionando toda a região.\n\nO SALVAMENTO DOS MARINHEIROS\n\nO terceiro grande milagre que consolidou a devoção foi o salvamento de uma embarcação mercantil portuguesa. Durante uma terrível tempestade na Baía de Bengala, os marinheiros portugueses enfrentaram morte certa. Suplicando com fervor a N.S., prometeram construir-lhe uma capela onde quer que o mar os levasse a salvo. Eles desembarcaram intactos nas areias de Vailankanni exatamente no dia 8 de setembro. Fiéis à promessa, ergueram a primeira pequena igreja no local.\n\nDEVOÇÃO E ECUMENISMO\n\nHoje, a Basílica de N.S. da Boa Saúde é um majestoso complexo que recebe milhões de peregrinos anualmente. O mais extraordinário é que a devoção atrai não apenas católicos, mas um número gigantesco de fiéis hindus e muçulmanos, que respeitam profundamente 'Matha' (Mãe) e peregrinam em busca de cura e proteção.\n\nMENSAGEM ESPIRITUAL\n\nN.S. de Vailankanni nos ensina que a misericórdia de Maria é universal e atravessa fronteiras culturais e religiosas. Como a Padroeira da Boa Saúde, Ela está atenta a todas as nossas doenças físicas e espirituais, recordando-nos o valor do milagre e do amor intercessor de Deus.",
                status: "approved",
    ...
    },
    {
        ...
        emoji: "🌍",
        iconUrl: "https://i.postimg.cc/T1H1QJ47/africa-icon.jpg",
        devotions: [
            {
                id: "kibeho",
                name: "N.S. de Kibeho",
                ...
                countryFlag: "🇷🇼",
                date: "28 de Novembro",
                imageUrl: "https://i.postimg.cc/RZthQfQc/ns-kibeho.png",
            ...
            },
            {
                ...
                countryFlag: "🇪🇬",
                date: "2 de Abril",
                imageUrl: "https://i.postimg.cc/WtRqm7K3/ns-zeitoun.png",
    ...
    },
    {
        name: "Américas",
        emoji: "🌎",
        iconUrl: "https://i.postimg.cc/dQWhqJVJ/americas-icon.jpg",
        devotions: [
            // BRASIL - REGIONAIS
            {
                id: "mel",
                ...
                countryFlag: "🇧🇷",
                date: "13 de Maio",
                imageUrl: "https://i.postimg.cc/mkrhQ58t/ns-mel.png",
            ...
            },
            {
                ...
                countryFlag: "🇧🇴",
                date: "5 de Agosto",
                imageUrl: "https://i.postimg.cc/MKNXQtRp/ns-copacabana.png",
            ...
            },
            {
                ...
                countryFlag: "🇪🇨",
                date: "21 de Novembro",
                imageUrl: "https://i.postimg.cc/RVyqHGfh/ns-quinche.jpg",
            ...
            },
            {
                ...
                countryFlag: "🇺🇸",
                date: "9 de Outubro",
                imageUrl: "https://i.postimg.cc/fbgctYwv/ns-bom-socorro.png",
            ...
            },
            {
                ...
                countryFlag: "🇧🇷",
                date: "12 de Outubro",
                imageUrl: "https://i.postimg.cc/SQHgtbbs/ns-seringueira.png",
                description: "Padroeira dos Seringueiros da Amazônia",
                fullDescription: "A MÃE DOS SERINGUEIROS\n\nN.S. da Seringueira é uma devoção mariana profundamente enraizada na cultura e na história dos seringueiros da Amazônia brasileira, especialmente nos estados do Acre e Amazonas. Esta devoção nasceu no coração da floresta, entre os trabalhadores que extraíam o látex das seringueiras (Hevea brasiliensis) durante os ciclos da borracha, enfrentando condições extremamente difíceis e perigosas.\n\nCONTEXTO HISTÓRICO - OS CICLOS DA BORRACHA\n\nDurante o primeiro ciclo da borracha (1879-1912) e o segundo ciclo (1942-1945, durante a Segunda Guerra Mundial), milhares de nordestinos migraram para a Amazônia em busca de trabalho nos seringais. Estes homens, chamados 'soldados da borracha', deixaram suas famílias e enfrentaram a selva hostil, doenças tropicais (malária, febre amarela), animais perigosos (onças, cobras, jacarés), e um sistema de trabalho muitas vezes explorador. Isolados na imensidão da floresta, longe de igrejas e padres, estes seringueiros levavam consigo apenas sua fé e pequenas imagens de santos, especialmente de N.S..\n\nA DEVOÇÃO NA FLORESTA\n\nNos barracões dos seringais, em meio à floresta, os seringueiros erguiam pequenos altares com imagens de N.S., geralmente N.S. Aparecida ou N.S. da Conceição. Com o tempo, desenvolveu-se uma devoção específica: N.S. da Seringueira. A imagem era venerada antes das perigosas jornadas de extração do látex, que começavam de madrugada. Os seringueiros rezavam o terço, pedindo proteção contra os perigos da mata e sucesso na colheita do látex. Muitos relatavam que, em momentos de perigo extremo - perdidos na floresta, atacados por animais, ou doentes - sentiam a presença maternal de Maria guiando-os e protegendo-os.\n\nICONOGRAFIA E SIMBOLISMO\n\nA iconografia de N.S. da Seringueira é única e tocante: Maria é representada muitas vezes em pé ou sentada junto a uma seringueira, por vezes com o Menino Jesus no colo, cercada pela exuberante vegetação amazônica. Em algumas imagens, ela segura uma tigela de látex ou está sob a copa de uma seringueira. A cor verde da floresta predomina, simbolizando a vida e a esperança em meio às dificuldades. A imagem transmite a mensagem de que Maria está presente até nos lugares mais remotos e difíceis, acompanhando e protegendo seus filhos trabalhadores.\n\nCHICO MENDES E A DEVOÇÃO\n\nO famoso líder seringueiro e ambientalista Chico Mendes (1944-1988), assassinado por defender a floresta e os direitos dos seringueiros, era devoto de N.S.. Sua luta pela justiça social e pela preservação da Amazônia estava profundamente enraizada em sua fé católica e em sua devoção mariana. Chico Mendes via em Maria a defensora dos pobres e da criação de Deus.\n\nMENSAGEM ATUAL - ECOLOGIA E JUSTIÇA\n\nHoje, a devoção a N.S. da Seringueira ganha novo significado no contexto da crise ecológica e da destruição da Amazônia. Maria, venerada como protetora dos seringueiros, é também invocada como protetora da floresta amazônica, 'pulmão do mundo'. A devoção nos chama a cuidar da criação de Deus, a defender os povos da floresta (indígenas, ribeirinhos, seringueiros) e a lutar por justiça socioambiental. N.S. da Seringueira nos ensina que a fé cristã não pode ser separada do cuidado com a Casa Comum e da defesa dos mais vulneráveis.",
                status: "approved",
            ...
            },
            {
                ...
                countryFlag: "🇧🇷",
                date: "2 de Fevereiro",
                imageUrl: "https://i.postimg.cc/qvxQRthg/ns-rainha-sertao.png",
                description: "Padroeira do Sertão Nordestino",
                fullDescription: "A RAINHA DO SERTÃO BRASILEIRO\n\nN.S. Rainha do Sertão é uma devoção mariana profundamente enraizada na alma do povo sertanejo do Nordeste brasileiro, especialmente nos estados da Bahia, Ceará, Pernambuco, Paraíba e Rio Grande do Norte. Esta devoção expressa a fé resiliente e esperançosa de um povo que enfrenta as adversidades do clima semiárido - secas prolongadas, fome, pobreza - mas nunca perde a confiança na proteção maternal de Maria.\n\nO SERTÃO E SUA FÉ\n\nO sertão nordestino é uma região de contrastes: beleza árida, sol escaldante, vegetação de caatinga, e um povo de fé profunda e inquebrantável. Historicamente marcado por secas devastadoras que causaram grandes sofrimentos e migrações, o sertão é também terra de santos, beatos, romeiros e devoções populares intensas. Neste contexto, Maria é venerada como a Rainha e Mãe do sertão, aquela que acompanha seu povo nas provações e intercede por chuva, alimento e esperança.\n\nORIGEM DA DEVOÇÃO\n\nA devoção a N.S. Rainha do Sertão não tem uma origem histórica precisa documentada, mas nasceu espontaneamente do coração do povo sertanejo ao longo dos séculos. Em muitas capelas rurais, fazendas e pequenas cidades do sertão, imagens de N.S. - geralmente sob os títulos de N.S. da Conceição, N.S. das Dores, N.S. do Perpétuo Socorro ou N.S. Aparecida - eram veneradas com o título adicional de 'Rainha do Sertão'. O povo reconhecia em Maria a única Rainha verdadeira de sua terra sofrida, mais poderosa que qualquer autoridade terrena, capaz de interceder junto a Deus pelos necessitados.\n\nROGATIVAS E PROCISSÕES DA CHUVA\n\nUma das manifestações mais tocantes da devoção são as 'rogativas' ou 'procissões da chuva', realizadas durante períodos de seca prolongada. O povo se reúne, muitas vezes caminhando descalço sob o sol causticante, carregando a imagem de N.S. Rainha do Sertão, rezando o terço, cantando benditos e ladainhas, implorando por chuva. Estas procissões são verdadeiras expressões de fé coletiva, onde ricos e pobres, jovens e velhos, caminham juntos em súplica. Muitos testemunhos relatam que, após as rogativas, as chuvas vieram, salvando plantações e vidas.\n\nSIMBOLISMO E ICONOGRAFIA\n\nA iconografia de N.S. Rainha do Sertão frequentemente apresenta Maria coroada, vestida com mantos em tons de azul e branco, por vezes cercada por elementos do sertão: mandacarus (cactos típicos), sol radiante, nuvens de chuva, estrelas. Em algumas representações, ela segura espigas de milho ou ramos de algodão, simbolizando a fertilidade da terra abençoada por Deus. A imagem transmite simultaneamente a realeza de Maria e sua proximidade maternal com o povo sofrido.\n\nPADROEIRO CELESTINO E A DEVOÇÃO\n\nO Beato Padre Cícero Romão Batista (Padim Ciço), grande devoto de N.S. e pai espiritual do povo sertanejo, promovia intensamente a devoção mariana. Em Juazeiro do Norte (CE), um dos maiores centros de romaria do Brasil, a devoção a N.S. das Dores (padroeira da cidade) se funde com a devoção a N.S. Rainha do Sertão. Padre Cícero ensinava: 'Reze sempre o terço de Maria, que Ela nunca abandona seus filhos'.\n\nMENSAGEM DE ESPERANÇA E RESISTÊNCIA\n\nA devoção a N.S. Rainha do Sertão nos ensina a esperança que não desanima, mesmo nas circunstâncias mais adversas. O sertanejo, diante da seca, da fome, da migração forçada, não perde a fé. Maria é a Rainha que reina não com poder mundano, mas com amor maternal, compartilhando o sofrimento de seu povo e intercedendo incansavelmente. A devoção também nos chama à solidariedade com o povo do sertão, a lutar por políticas públicas justas de convivência com o semiárido, e a valorizar a cultura e a fé sertaneja. N.S. Rainha do Sertão é a Mãe dos retirantes, dos flagelados, dos esquecidos, e sua coroa é tecida com as orações e lágrimas de seu povo fiel.",
                status: "approved",
    ...
    },
    {
        name: "Oceania",
        emoji: "🌏",
        iconUrl: "https://i.postimg.cc/d3S3njxj/oceania-icon.jpg",
        devotions: [
            {
