...
export const santosMarcoSetembro: SaintOfTheDayData[] = [
    ...
    { day: 15, month: 'Agosto', saints: [{ name: 'Assunção de Nossa Senhora', imageUrl: '/images/ns_assuncao.png', story: '<h4>Assunção ao Céu</h4><p>Maria é elevada ao Céu em corpo e alma. Dogma proclamado pelo Papa Pio XII em 1950.</p><p class="mt-4"><b>Oração:</b> Nossa Senhora, rogai por nós.</p>' }] },

    // SETEMBRO
    { day: 8, month: 'Setembro', saints: [{ name: 'Natividade de Nossa Senhora', imageUrl: '/images/ns_natividade.png', story: '<h4>Nascimento de Maria</h4><p>Celebramos o nascimento da Virgem Maria, Mãe de Deus e nossa Mãe.</p><p class="mt-4"><b>Oração:</b> Nossa Senhora, rogai por nós.</p>' }] },
    ...
    { day: 15, month: 'Setembro', saints: [{ name: 'Nossa Senhora das Dores', imageUrl: '/images/ns_dores_setembro.png', story: '<h4>Mãe Dolorosa</h4><p>Veneramos as sete dores de Maria, especialmente ao pé da Cruz de seu Filho.</p><p class="mt-4"><b>Oração:</b> Nossa Senhora das Dores, rogai por nós.</p>' }] },
